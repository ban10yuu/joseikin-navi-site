...
- `hokkaido-batch-001` 反映状況:
  ...
  - 公式確認・データ反映済み: 士別市2件、名寄市2件、三笠市4件、根室市1件、千歳市6件、滝川市3件、砂川市1件、歌志内市5件、深川市7件、富良野市3件、登別市2件、恵庭市8件、伊達市6件、北広島市3件、石狩市3件、北斗市5件、当別町4件、新篠津村5件、松前町4件、福島町3件（合計77件）。
  ...
  - 軽量検証: `npx eslint src/data/grants/verified-local-misc-2026.ts` pass、追加77URL GET 200 pass、`git diff --check` pass、`npm run audit:coverage` failures 0。audit後の北海道 `localOfficial` は548。
  - 期限切れ明記で反映: 北広島市福祉施設等臨時支援金（2026年3月31日締切）、北斗市医療・介護・福祉施設等物価高騰対策支援給付金（2026年3月31日締切・事業終了）、新篠津村はばたけ高校生応援支援金（2026年6月26日締切）、松前町空家等除却支援事業補助金（令和8年度受付終了）、恵庭市低所得世帯（生活）支援給付金（2025年3月31日締切・受付終了）は公式ページで期限・終了状態を確認できるため、期限付き制度として収録。
