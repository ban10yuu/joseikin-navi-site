...
- 反映/棚卸し進行済み自治体: 45（札幌市、函館市、小樽市、旭川市、室蘭市、釧路市、帯広市、北見市、夕張市、岩見沢市、網走市、留萌市、苫小牧市、稚内市、美唄市、芦別市、江別市、赤平市、紋別市、士別市、名寄市、三笠市、根室市、千歳市、滝川市、砂川市、歌志内市、深川市、富良野市、登別市、恵庭市、伊達市、北広島市、石狩市、北斗市、当別町、新篠津村、松前町、福島町、知内町、木古内町、七飯町、鹿部町、森町、八雲町）
- 残自治体数: 134
...
- `hokkaido-batch-002` 着手:
  ...
  - 公式確認・データ反映済み: 知内町9件、木古内町17件、七飯町18件、鹿部町15件、森町17件、八雲町17件。うち知内町奨学資金貸付制度、鹿部町奨学資金貸付制度、八雲町空家改修費補助金は申請期限到来済みまたは受付終了のため期限切れ扱い。
  ...
  - 軽量検証: 知内町追加9URL GET 200・本文一致 pass、木古内町追加17URL GET 200・本文一致 pass、七飯町追加18URL GET 200・本文一致 pass、鹿部町追加15URL GET 200・本文一致 pass、森町追加17件の公式URL GET 200・本文一致 pass、八雲町追加17件の公式URL GET 200・本文一致 pass、`npx eslint src/data/grants/verified-local-misc-2026.ts` pass、`git diff --check` pass、`npm run audit:coverage` failures 0。audit後の北海道 `localOfficial` は645。
