...
- `hokkaido-batch-001` 反映状況:
  ...
  - 公式確認・データ反映済み: 士別市2件、名寄市2件、三笠市4件、根室市1件、千歳市6件、滝川市3件、砂川市1件、歌志内市5件、深川市9件、富良野市4件、登別市2件、恵庭市8件、伊達市6件、北広島市3件、石狩市3件、北斗市5件、当別町4件、新篠津村5件、松前町4件、福島町3件（合計80件）。
  ...
  - 軽量検証: `npx eslint src/data/grants/verified-local-misc-2026.ts` pass、追加80URL GET 200 pass、`git diff --check` pass、`npm run audit:coverage` failures 0。audit後の北海道 `localOfficial` は549。
