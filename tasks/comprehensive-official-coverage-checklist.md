...
- 反映/棚卸し進行済み自治体: 52（札幌市、函館市、小樽市、旭川市、室蘭市、釧路市、帯広市、北見市、夕張市、岩見沢市、網走市、留萌市、苫小牧市、稚内市、美唄市、芦別市、江別市、赤平市、紋別市、士別市、名寄市、三笠市、根室市、千歳市、滝川市、砂川市、歌志内市、深川市、富良野市、登別市、恵庭市、伊達市、北広島市、石狩市、北斗市、当別町、新篠津村、松前町、福島町、知内町、木古内町、七飯町、鹿部町、森町、八雲町、長万部町、江差町、上ノ国町、厚沢部町、乙部町、奥尻町、今金町）
- 残自治体数: 127
...
- `hokkaido-batch-002` 着手:
  ...
  - 公式確認・データ反映済み: 知内町9件、木古内町17件、七飯町18件、鹿部町15件、森町17件、八雲町17件、長万部町18件、江差町15件、上ノ国町18件、厚沢部町16件、乙部町18件、奥尻町12件、今金町28件。うち知内町奨学資金貸付制度、鹿部町奨学資金貸付制度、八雲町空家改修費補助金、乙部町スマイル商品券給付事業、乙部町子育て応援手当給付金、奥尻町創業・雇用拡大補助金、今金町物価高対応子育て応援手当は申請期限到来済みまたは受付終了のため期限切れ扱い。
  ...
  - 軽量検証: 知内町追加9URL GET 200・本文一致 pass、木古内町追加17URL GET 200・本文一致 pass、七飯町追加18URL GET 200・本文一致 pass、鹿部町追加15URL GET 200・本文一致 pass、森町追加17件の公式URL GET 200・本文一致 pass、八雲町追加17件の公式URL GET 200・本文一致 pass、長万部町追加18件の公式URL GET 200・本文一致 pass、江差町追加15件の公式URL GET 200・本文一致 pass、上ノ国町追加18件の公式URL GET 200・本文一致 pass、厚沢部町追加16URL GET 200・本文/PDF確認 pass、乙部町追加12URL/添付ファイル GET 200・本文/XLSX/DOCX/PDF確認 pass、奥尻町追加15URL/添付ファイル GET 200・本文/PDF/DOCX確認 pass、今金町追加45URL/添付ファイル GET 200・本文/PDF/DOCX確認 pass、`npx eslint src/data/grants/verified-local-misc-2026.ts` pass、`git diff --check` pass、`npm run audit:coverage` failures 0。audit後の北海道 `localOfficial` は767。
