...
- 候補・掲載見送り:
  ...
  - 第2巡021補完（2026-07-19）: 足寄町の住環境・店舗等整備補助金、老朽危険空家等除却、まちづくり活動支援補助金、妊産婦通院交通費等の助成、不妊治療費助成は、公式本文・PDF・詳細ページで対象、金額/上限、条件、期限/受付状況を確認し、6件中5件をデータ反映。足寄町新規就農支援は公式パンフレットPDFが画像主体で金額・上限を本文抽出できず、追加OCR又は別公式資料確認へ保留継続。
  - 第2巡021補完（2026-07-19）: 陸別町 子どもの予防接種は公式本文で全額公費負担・窓口負担なしを確認しデータ反映。陸別町 産婦健康診査受診票、産後ケア事業、インフルエンザ、高齢者肺炎球菌、新型コロナ、重度心身障害者医療費助成は、公式本文で対象・実施時期は確認できるが助成額・自己負担・上限を固定できないため保留継続。
  - 第2巡021補完（2026-07-19）: 浦幌町の保留5件は第1巡台帳上の未判定を確認。浦幌町UIJターン新規就業支援事業移住支援金は公式本文で受付停止・以後取扱未定を確認済みのため現行掲載しない。こども医療費、がん検診、妊産婦健康診査費用等、児童手当は次回以降に個別本文/PDF又は国制度重複整理で継続確認する。
...
- 候補・掲載見送り:
  ...
  - 第2巡022補完（2026-07-19）: 釧路町デコ活推進補助金は公式PDF本文で対象、設備別上限、受付期間、完了報告期限を確認し、受付終了の期限付き制度として反映。釧路町重度障がい者等福祉券は同じ公式障がい福祉ページで2万円分を確認し反映。スポーツ振興助成金は金額本文不足、福祉灯油は令和7年度受付終了で次期未確認、障害者就労等通所支援助成・障害者等援護旅費助成は補助率・上限未固定のため保留継続。
  ...
  - 第2巡022補完（2026-07-19）: 厚岸町の医療費助成等は候補URLが個別本文として不足し、ハッピーブライダルは過年度終了、無料簡易耐震診断は無料診断サービスで金銭給付ではないため、今回はデータ反映なし。医療費助成は個別公式本文の取得後に継続確認する。
  ...
  - 第2巡022補完（2026-07-19）: 浜中町安心住まいる促進事業、人づくり基金事業補助、ファミリー・サポート・センター利用料助成は、公式HTMLとPDF本文で対象、金額/上限、条件、申請表現を確認し反映。商工機器等購入資金貸付は貸付限度額が公式本文で固定できないため掲載しない。
  - 浜中町 日常生活用具給付・T字型ステッキ給付: 現物給付として確認できるが、個別金額・掲載方針整理が必要なため第2巡保留。
  - 第2巡024補完（2026-07-19）: 浜中町日常生活用具の給付は公式個別ページで対象、給付・貸与用具、原則1割負担、月額上限0円又は3万7,200円を確認し反映。T字型ステッキ給付は障がい者福祉カテゴリ内で個別公式ページと金額本文を確認できず保留継続。釧路町スポーツ振興助成金、障害者就労等通所支援助成・障害者等援護旅費助成、厚岸町医療費助成等は金額/個別本文不足で保留継続。
...
- 保留・除外:
  ...
  - 第2巡024補完（2026-07-19）: 標茶町画像PDF 5件は `pdftoppm` でPNG化し `tesseract 5.5.2`（jpn+eng）で各7ページをOCR。本文は観光・キャンプ・宿泊案内で、補助金・助成金・給付金・一時金の個別制度本文ではないため掲載対象外として保留解消。
...
- 保留・除外:
  ...
  - 第2巡025補完（2026-07-19）: 育英資金貸付金・定住促進貸付金は2026年7月12日の後半サンプルで公式HTML/Word根拠付き反映済みのため重複追加しない。腎臓機能障害者通院交通費補助は公式HTMLで対象・人工透析通院交通費補助を確認したが補助単価・上限が本文にないため保留継続。
...
- 保留・除外:
  ...
  - 第2巡025補完（2026-07-19）: 令和7年度物価高騰対応重点支援地方創生臨時交付金ページと公式PDFを確認し、生活支援商品券配布事業（1人1万円分）と事業持続のための水道料減免事業（水道基本料9カ月分）を反映。子ども食堂運営事業者緊急支援事業と福祉施設サービス提供体制維持支援事業臨時給付金は、対象は確認できるが金額/上限が本文で固定できないため保留継続。
...
- 保留・除外:
  ...
  - 第2巡025補完（2026-07-19）: 羅臼町地域総合整備資金貸付（ふるさと融資）は公式ページと町例規で対象、対象費用、100万円以上25億円以内、条件付き38億円、無利子、償還期間を確認し反映。羅臼町融資制度は2026年7月12日の後半サンプルで中小企業振興資金融資制度として既に反映済みのため重複追加しない。
...
- 2026-07-19 第2巡023補完（北海道第20バッチ保留: 鶴居村・別海町）:
  - 状態: 進捗JSONの最終checkpoint 022から復旧し、第20バッチ保留を公式個別ページ単位で再確認。鶴居村のPDF依存2件（つるい未来へつなぐ商工観光経済活性化支援、クラウドファンディング活用支援）はHEAD上で既に公式PDF根拠付き反映済みのため重複追加しない。
  - 採用:
    - 別海町: 8件（妊婦のための支援給付金、産婦健康診査費、新生児聴覚検査費、1カ月児健康診査費、家族介護用品支給、高齢者憩いの場活動事業補助金、介護従事者就業支援補助金、介護職員処遇改善補助金）
  - 保留継続:
    - 別海町 別海高等学校支援事業: 公式HTMLと令和6年度実績PDFで支援メニューと予算額は確認したが、2026年度の個別上限・対象者別交付条件として固定できない。
    - 別海町 老人クラブ運営費補助、敬老会開催経費助成、高齢者バス・ハイヤー共通利用券、介護職員確保対策支援事業: 個別金額又は受付条件不足のため今回の追加対象外。
    - 標茶町 画像PDF 5件: OCR/目視での制度名・対象・金額・期限確認が未了のため保留継続。
...
### 2026-07-15 福井県公式棚卸し004（18483おおい町・18501若狭町）

- 作業範囲:
  - 18483 おおい町、18501 若狭町の公式サイトを対象に、補助金・助成金・給付金・支援金等の個別公式ページを確認した。
  - 自治体別クロールで候補232件を取得した。shortlistが150件超かつcrawl候補の40%超だったため、候補232件から短い本文スニペット2723件を抽出し、ページ内リンク912件を制度リードとして再取得した。
  - 採用対象の89公式ページは全件HTTP 200を確認した。
- 採用:
  - 合計89件を `src/data/grants/verified-local-misc-2026.ts` に追加。
  - おおい町57件: おおい町ひとり親家庭等習い事支援事業について、JR小浜線団体乗車券購入に対する助成について、おおい町ひとり親家庭等の大学等受験料・模擬試験受験料支援事業補助金について、おおい町結婚新生活支援事業補助金について、おおい町若者夫婦支援金を給付します。、令和8年度 就学援助制度について、福井県外からおおい町に移住し就職した方を応援します!【移住支援金】、JR小浜線シニア利用助成金について、JR小浜線利用促進親子列車旅行の助成について、Ｖ2Ｈ充放電設備の整備費用の助成について、企業立地優遇制度のご案内、住宅への太陽光発電・蓄電池設備の導入を補助します、子育て応援手当について、電気自動車、プラグインハイブリッド車の購入及び充電設備整備の助成について、おおい町中小企業振興資金融資制度について、不妊治療費助成事業を実施しています、在宅育児応援手当制度について、大学等通学定期助成金について、子育て支援医療費の助成について、東京圏からおおい町に移住し、就職する大学生の交通費・移転費を支援します、母子家庭医療費の助成について、父子家庭医療費の助成について、障害者等医療費の助成について、おおいの県産材住まい支援事業（新築・リフォーム）のご案内、おおい町空き家適正管理事業について、オフィス誘致補助金のご紹介、サル被害緊急対策事業補助金について、令和8年度おおい町学生合宿誘致推進事業補助金、企業立地助成金のご紹介、児童扶養手当制度について、分譲地購入者住まい支援事業について、多世帯同居リフォーム支援事業、多世帯同居住宅取得支援事業、多世帯近居住宅取得支援事業、戦没者等の遺族に対する特別弔慰金、東京圏からの移住を応援します!【移住支援金】、民間分譲地購入者住まい支援事業について、特産品開発・販売促進等支援事業補助金、県外から移住をお考えの方への旅費の一部を助成します、空家等状態調査事業のご案内、空家等除却支援事業のご案内、総合周産期母子医療センター利用に係る交通費助成事業について、農業で使用する大型特殊自動車・農耕車限定けん引免許の取得に係る費用の一部を助成します、おおいの移住者・新婚・子育て世帯への住まい支援事業のご案内、おおい町福祉人材確保支援金について、おおい町若者出会い・交流応援事業補助金について、おとなの風しん予防接種の助成について（妊娠を希望する女性や配偶者等のみなさま）、まちづくり団体先進地視察等支援事業の募集について、令和8年度まちづくりチャレンジ事業・まちづくり支援事業の募集について、児童手当制度について、合併処理浄化槽設置の補助について、特別の理由（骨髄移植手術等）による接種済みワクチン再接種費用の助成について、空き家活用支援事業、空き家等家賃支援事業、耐震改修工事を行った住宅に対する固定資産税の減額制度、妊婦・産婦医療費の助成について、漏水時の上下水道料金の減免について。
  - 若狭町32件: 結婚新生活支援事業について、ひとり親家庭等の大学等受験料・模擬試験受験料支援事業、ひとり親家庭等習い事支援事業補助金、わかさで輝く奨学金返還支援、令和8年度若狭町スタートアップ支援補助金、若狭町成年後見制度利用支援事業、若狭町移住支援金（全国型）、キッチンカーを導入する事業者を募集します、わかさへ帰ろう学生帰省支援補助金、任意予防接種の一部について助成を行います、個人住宅の太陽光・蓄電池設備の導入を補助します、在宅育児応援手当、妊婦のための支援給付金について、若狭町オフィス誘致促進事業補助金、若狭町ふるさと納税返礼品魅力発信支援補助金、若狭町木造住宅耐震改修促進事業、野良猫不妊手術費補助金交付事業について、産前産後の国民健康保険税を減免します、若狭町移住サポート事業、児童手当、児童扶養手当、国民年金保険料の免除・納付猶予制度、若狭町木造住宅耐震診断等促進事業、過疎地域における固定資産税の課税免除について、障害児福祉手当・特別障害者手当・特別児童扶養手当、不妊治療費助成金交付事業、福祉医療費助成制度、子宮頸がん（ヒトパピローマウイルス感染症）予防接種について(R8.4〜)、高齢者用肺炎球菌ワクチン予防接種について、特定不妊治療に係る通院交通費の助成について、重度心身障害者医療費支給制度、定期予防接種償還払いの申請について。
- 生成ファイル:
  - `tasks/discovery/fukui-official-coverage-004-18483-municipality.json`
  - `tasks/discovery/fukui-official-coverage-004-18501-municipality.json`
  - `tasks/discovery/fukui-official-coverage-004-adopted-urls.json`
  - `tasks/discovery/fukui-official-coverage-004-adoption-ranked.json`
  - `tasks/discovery/fukui-official-coverage-004-candidates.json`
  - `tasks/discovery/fukui-official-coverage-004-municipalities.json`
  - `tasks/discovery/fukui-official-coverage-004-rescored-snippets.json`
  - `tasks/discovery/fukui-official-coverage-004-snippets.json`
  - `tasks/discovery/fukui-official-coverage-004-url-leads.json`
  - `tasks/discovery/fukui-official-coverage-004.json`
- 検証:
  - `node --check src/data/grants/verified-local-misc-2026.ts`: pass。
  - JSON parse: pass（004関連JSON、checkpoint）。
  - 追加slug重複: pass（89件、`verified-local-misc-2026.ts` 全体 duplicateCount 0）。
  - 公式URL到達: pass（89 primary official URLsすべてHTTP 200）。
  - `npx eslint src/data/grants/verified-local-misc-2026.ts`: pass。
  - `git diff --check`: pass。
  - `npm run audit:coverage`: pass（failures 0、activePublished 12752、officialLinkedActive 12632、manuallyVerifiedActive 12632、福井県 localOfficial 393）。
- 注意:
  - 福井県は全市町の第1巡に到達したが、全国公式棚卸しは未完了。既存rawのgap 0、HTTP 200、又は福井県18501若狭町到達のみで全国完了扱いしない。
  - トップ、カテゴリ、様式、申請書単体、Q&A、周知のみ、制度要件不足候補は第2巡候補に残す。
- 次:
  - 山梨県公式棚卸し001として、19201甲府市から自治体コード順に確認する。


### 2026-07-15 山梨県公式棚卸し001（19201甲府市・19202富士吉田市・19204都留市・19205山梨市・19206大月市）

- 作業範囲:
  - 19201 甲府市、19202 富士吉田市、19204 都留市、19205 山梨市、19206 大月市の公式サイトを対象に、補助金・助成金・給付金・支援金等の個別公式ページを確認した。
  - 自治体別クロールで候補607件を取得した。shortlistが150件超かつcrawl候補の40%超だったため、候補607件から短い本文スニペット6543件を抽出し、ページ内リンク3748件を制度リードとして再取得した。
  - 採用対象の100公式ページは全件HTTP 200を確認した。
- 採用:
  - 合計100件を `src/data/grants/verified-local-misc-2026.ts` に追加。
  - 甲府市20件: ひとり親家庭への資格取得支援（いきいき自立応援給付金）、結婚新生活支援事業について、ひとり親家庭等医療費助成制度、児童扶養手当、ひとり親家庭等に対する日常生活支援事業、母子父子寡婦福祉資金貸付金、子育て世帯住宅取得支援事業について、重度心身障がい者(児)の医療費助成、遠距離通勤・通学定期券購入補助制度のご活用を、高齢者補聴器購入費助成事業、市・県民税の減免、租税条約に基づく市・県民税の免除申請について、インターンシップ支援助成金事業について、生活困窮者住居確保給付金事業、誘客促進事業補助金、すこやか子育て医療費助成、やまなしKAITEKI住宅普及促進事業費補助金について、ユニバーサルデザインタクシー導入促進事業費補助金制度のご活用を、移住支援金交付事業について、地域クラブ活動指導者資格取得助成金。
  - 富士吉田市20件: ひとり親家庭等医療費助成制度、不妊治療費助成金支給事業、下水道補助制度拡充、中古物件改修支援奨励金、児童扶養手当、妊産婦等に対する遠方の分娩取扱施設等への交通費等支援事業、母子・父子・寡婦のための支援、遠距離通勤支援奨励金、新婚世帯すまい支援奨励金、新婚世帯への補助金について、中古物件利用者すまい支援奨励金、富士吉田への移住を応援！定住促進奨励金、テレワーク支援奨励金、浄化槽・下水道の補助制度拡充、産前産後ケア事業、児童手当、妊婦のための支援給付事業、妊婦歯科検診費用の助成、重度心身障害者医療費助成金制度、令和7年度奨学金返還支援制度。
  - 都留市20件: 都留市企業立地のご案内、すこやか子育て医療費助成金支給制度、ひとり親家庭医療費助成、重度心身障害児者医療助成制度、市営住宅等新婚・子育て世帯の家賃助成について、創業・起業支援制度【融資・信用保証・補助金】、都留市産業集積促進助成金、都留市地域総合整備資金貸付（ふるさと融資）、不妊・不育症治療支援事業、幼児教育・保育の無償化について、都留市環境アンテナショップ家賃補助金、都留市空き店舗・空き工場活用促進事業補助金、都留市奨学金返還支援事業補助金、都留市小規模商工業者事業資金利子補給制度、都留市創業者支援利子補給制度、都留市地域経済循環創造事業補助金をご活用ください、「物価高対応子育て応援手当」及び「山梨物価高対応子育て応援特別給付金」の支給について、新生児聴覚検査費用助成のお知らせ、都留市子育て支援活動促進事業費補助金、妊婦対象のRSウイルスワクチンが定期接種になりました。
  - 山梨市20件: 合併処理浄化槽設置費補助金制度、0歳～2歳のお子様の保育料が無料になります！、企業立地のための助成制度、保育園などの主食費・副食費の補助をおこないます、保育園などの副食費の補助をおこないます、令和8年度山梨市結婚新生活支援事業補助金、造血幹細胞移植後予防接種支援事業を実施します、利用者負担額（保育料）のお知らせ、令和7年度山梨市物価高騰対策支援金について、軽・中等度難聴者補聴器購入費助成事業、山梨市涼み処開放助成事業、幼児教育・保育の無償化について、令和8年度「山梨市協働まちづくり支援事業」活動団体を募集します、高齢者の肺炎球菌ワクチン予防接種、成人を対象とした予防接種について、定期予防接種の接種費用の償還払いについて、家具などの転倒防止対策に補助金を支給します、県外の医療機関で1か月健康診査を受けた方へ費用助成のご案内、県外の医療機関で産婦健康診査を受けた方へ費用助成のご案内、県外の医療機関で新生児聴覚検査を受けた方へ費用助成のご案内。
  - 大月市20件: 障害者医療制度、子育て支援医療費助成制度、大月市新婚世帯家賃助成金、大月市転入子育て世帯家賃助成金、大月市子育て世帯住宅取得支援事業費補助金、こうのとり支援事業（不妊治療費助成事業）、ひとり親家庭医療費助成、大月市定住促進住宅取得助成金、大月市定住促進中古住宅取得助成金、公共下水道への接続者に対する支援制度の拡充について、企業立地支援制度のご案内、飼い主のいない猫の不妊去勢手術に関する補助金、浄化槽設置奨励補助事業、浄化槽設置補助事業、大月市ふるさと納税特産品開発事業費補助金、大月市初回産科受診料支援事業、大月市奨学金返還支援補助金、大月市中小企業等生産性向上設備整備等支援事業費補助金、伴走型相談支援・出産子育て応援給付金支給事業、大月市移住支援金。
- 生成ファイル:
  - `tasks/discovery/yamanashi-official-coverage-001-19201-municipality.json`
  - `tasks/discovery/yamanashi-official-coverage-001-19202-municipality.json`
  - `tasks/discovery/yamanashi-official-coverage-001-19204-municipality.json`
  - `tasks/discovery/yamanashi-official-coverage-001-19205-municipality.json`
  - `tasks/discovery/yamanashi-official-coverage-001-19206-municipality.json`
  - `tasks/discovery/yamanashi-official-coverage-001-adopted-urls.json`
  - `tasks/discovery/yamanashi-official-coverage-001-adoption-ranked.json`
  - `tasks/discovery/yamanashi-official-coverage-001-candidates.json`
  - `tasks/discovery/yamanashi-official-coverage-001-municipalities.json`
  - `tasks/discovery/yamanashi-official-coverage-001-rescored-snippets.json`
  - `tasks/discovery/yamanashi-official-coverage-001-snippets.json`
  - `tasks/discovery/yamanashi-official-coverage-001-url-leads.json`
  - `tasks/discovery/yamanashi-official-coverage-001.json`
- 検証:
  - `node --check src/data/grants/verified-local-misc-2026.ts`: pass。
  - JSON parse: pass（001関連JSON、checkpoint）。
  - 追加slug重複: pass（100件、`verified-local-misc-2026.ts` 全体 duplicateCount 0）。
  - 公式URL到達: pass（100 primary official URLsすべてHTTP 200）。
  - `npx eslint src/data/grants/verified-local-misc-2026.ts`: pass。
  - `git diff --check`: pass。
  - `npm run audit:coverage`: pass（failures 0、activePublished 12852、officialLinkedActive 12732、manuallyVerifiedActive 12732、山梨県 localOfficial 176）。
- 注意:
  - 山梨県は19201甲府市から19206大月市まで第1巡に到達したが、全国公式棚卸しは未完了。既存rawのgap 0、HTTP 200、又は山梨県19206大月市到達のみで全国完了扱いしない。
  - トップ、カテゴリ、様式、申請書単体、Q&A、周知のみ、制度要件不足候補は第2巡候補に残す。
- 次:
...
### 2026-07-15 長野県公式棚卸し003（20214茅野市・20215塩尻市・20217佐久市・20218千曲市・20219東御市）

- 作業範囲:
  - 20214 茅野市、20215 塩尻市、20217 佐久市、20218 千曲市、20219 東御市の公式サイトを対象に、補助金・助成金・給付金・支援金等の個別公式ページを確認した。
  - 5自治体の公式トップはすべてHTTP 200を確認した。
  - 自治体別クロールで候補650件を取得した。shortlistが150件超かつcrawl候補の40%超だったため、候補本文スニペット650件を抽出し、アンカーテキスト起点の制度リード156件を再取得し、再スコア対象806件を保存した。
  - 採用対象の60公式ページは、間隔付きcurlで全件HTTP 200を確認した。
- 採用:
  - 合計60件を `src/data/grants/verified-local-misc-2026.ts` に追加。
  - 塩尻市60件: ひとり親家庭の親と子の高卒認定試験の受講料を補助します、猫の繁殖制限助成について（助成は終了しました）、ひとり親家庭等高等学校等就学支援金（教材費・通学費の補助）、一時的保育（デイ保育）助成事業のご案内、ふれあいのまちづくり事業補助金、集会所新築・改修等事業補助金、塩尻市移住・定住促進居住環境整備事業補助金(空き家補助金)について、生活資金等でお悩みの方へ（住居確保給付金の案内）、塩尻市妊婦支援給付金、塩尻市私立高等学校運営費等補助金制度、フリースクール利用児童生徒支援補助金、LED防犯灯に関する補助金、住宅の耐震化を進めましょう（塩尻市住宅・建築物耐震改修促進事業補助金）、手話通訳者や要約筆記者の資格取得に必要な費用を補助します（塩尻市意思疎通支援者養成事業補助金）、飼い主のいない猫の不妊・去勢手術費補助金交付事業について、あなたのまちづくりチャレンジを応援します！（まちづくりチャレンジ事業補助制度）、環境ISO等認証取得事業補助金、塩尻市介護人材確保促進事業補助金、児童手当、地域介護予防活動支援事業補助金申請について、姉妹都市交流事業補助金のお知らせ、塩尻市里山保全整備事業補助金、児童手当 令和6年10月から児童手当制度が改正（拡充）されました、福祉医療費給付金制度（自動給付用）、塩尻市新規ビジネスモデルチャレンジ支援事業補助金について、福祉医療費給付金制度（現物給付用）、児童扶養手当、省エネ診断を受診する中小企業者等に補助金を交付します、塩尻市エアコン設置促進事業補助金について、【令和8年度分は終了しました】芸術文化団体の節目などに行う事業を支援します（塩尻市芸術文化振興事業補助金）、塩尻市物価高対応子育て応援手当の支給について、後期高齢者医療制度人間ドック補助金、公民館（分館）建設・改修等事業補助金、産前産後期間における国民健康保険税の免除について、軽自動車税の減免について、産前産後期間の国民年金保険料免除制度、漏水による水道料金等の減免について、あなたのブロック塀等は安全ですか（塩尻市ブロック塀等防災対策促進事業補助金）、緊急輸送道路沿道建築物の耐震化に努めましょう（塩尻市住宅・建築物耐震改修促進事業補助金）、令和8年度塩尻市福祉サービス事業所物価高騰対策支援金、地域活性化プラットフォーム事業補助金、塩尻市男女共同参画推進事業補助金、国民健康保険一部負担金の減免について、地域のこどもの居場所づくりを支援します（塩尻市こどもの居場所づくり事業補助金）、障害年金を受給しているひとり親家庭等が、児童扶養手当を受給できるよう見直されます、国民健康保険税の減免について、特別児童扶養手当、県外で受診した場合の公費助成について、塩尻市子育て世帯生活支援特別給付金（ひとり親世帯分）について、児童手当 申請書類等、指定難病に対する手当について、定額減税補足給付金（不足額給付）について、国民年金保険料の免除・納付猶予申請をしましたが、納付書が届きました。なぜですか？、国民年金保険料の納付が困難です。保険料の免除申請等はできますか？、障害児福祉手当・特別障害者手当について、高等職業訓練促進給付金の対象となる資格には、どのようなものがありますか、自立支援教育訓練給付金の対象講座には、どのようなものがありますか、児童扶養手当の対象とならない場合とは、どのような場合ですか、児童扶養手当はどんな制度ですか、一般廃棄物収集場所（ごみステーション）設置費補助金様式について。
  - 茅野市は共通ナビ・カテゴリ中心で個別制度本文の必須項目確認が弱いため第2巡候補として保持した。
  - 佐久市は公式検索で制度ページを補足したが、短時間連続確認で403へ振れるURLがあるため第2巡候補として保持した。
  - 千曲市は一部制度ページが短時間連続確認で403へ振れるため第2巡候補として保持した。
  - 東御市はカテゴリ・助成事業一覧中心で個別制度本文の確認が不足したため第2巡候補として保持した。
- 生成ファイル:
  - `tasks/discovery/nagano-official-coverage-003-20214-municipality.json`
  - `tasks/discovery/nagano-official-coverage-003-20215-municipality.json`
  - `tasks/discovery/nagano-official-coverage-003-20217-municipality.json`
  - `tasks/discovery/nagano-official-coverage-003-20218-municipality.json`
  - `tasks/discovery/nagano-official-coverage-003-20219-municipality.json`
  - `tasks/discovery/nagano-official-coverage-003-adopted-urls.json`
  - `tasks/discovery/nagano-official-coverage-003-adoption-ranked.json`
  - `tasks/discovery/nagano-official-coverage-003-candidates.json`
  - `tasks/discovery/nagano-official-coverage-003-municipalities.json`
  - `tasks/discovery/nagano-official-coverage-003-rescored-snippets.json`
  - `tasks/discovery/nagano-official-coverage-003-snippets.json`
  - `tasks/discovery/nagano-official-coverage-003-url-leads.json`
  - `tasks/discovery/nagano-official-coverage-003-url-status.txt`
  - `tasks/discovery/nagano-official-coverage-003.json`
- 検証:
  - `node --check src/data/grants/verified-local-misc-2026.ts`: pass。
  - JSON parse: pass（003関連JSON、checkpoint）。
  - 追加slug重複: pass（60件、`verified-local-misc-2026.ts` 全体 duplicateCount 0）。
  ...
  - `npx eslint src/data/grants/verified-local-misc-2026.ts`: pass。
  - `git diff --check`: pass。
  - `npm run audit:coverage`: pass（failures 0、activePublished 13375、officialLinkedActive 13255、manuallyVerifiedActive 13255、長野県 localOfficial 289）。
- 注意:
  - 長野県は20201長野市から20219東御市まで第1巡に到達した。ただし全国公式棚卸しは未完了。既存rawのgap 0、HTTP 200、又は長野県20219東御市到達のみで全国完了扱いしない。
  - トップ、カテゴリ、ポータル、様式、申請書単体、Q&A、周知のみ、制度要件不足候補は第2巡候補に残す。
- 次:
...
### 2026-07-15 長野県公式棚卸し009（20409平谷村・20410根羽村・20411下條村・20412売木村・20413天龍村）
- 対象: 平谷村、根羽村、下條村、売木村、天龍村。
- 実施: 公式候補410件を取得し、本文スニペット410件を保存。制度語、金額・上限、対象条件、申請・受付表現が確認できる公式ページを優先採用。
- 採用: 51件（平谷村19件、売木村18件、天龍村14件）。根羽村・下條村は第2巡候補保持。
...
### 長野県公式棚卸し015（20583信濃町・20588小川村・20590飯綱町・20602栄村）
- 実施日: 2026-07-15
- 候補: 280件（スニペット280件、追加カテゴリスニペット10件、栄村個別ページ25件）
- 採用: 31件（信濃町2件、小川村5件、飯綱町8件、栄村16件）
- 公式URL: 採用URL到達確認は tasks/discovery/nagano-official-coverage-015-url-status.txt に記録（30本すべてHTTP 200）
- 保留: カテゴリ導線、サイトマップ、期限切れ給付、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass
- 到達点: 長野県は20201長野市から20602栄村まで第1巡完了。全国公式棚卸しは未完了
- 次回: 岐阜県公式棚卸し001として、21201岐阜市から再開

### 岐阜県公式棚卸し001（21201岐阜市・21202大垣市・21203高山市・21204多治見市・21205関市）
- 実施日: 2026-07-15
- 候補: 457件（スニペット457件、再スコア77件、公式一覧14件）
- 採用: 48件（岐阜市9件、大垣市8件、高山市12件、多治見市5件、関市14件）
- 公式URL: 採用URL到達確認は tasks/discovery/gifu-official-coverage-001-url-status.txt に記録（48本すべてHTTP 200）
- 保留: トップ、カテゴリ導線、共通ナビ、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass
- 到達点: 岐阜県は21201岐阜市から21205関市まで第1巡到達。全国公式棚卸しは未完了
- 次回: 岐阜県公式棚卸し002として、21206中津川市から再開

### 岐阜県公式棚卸し002（21206中津川市・21207美濃市・21208瑞浪市・21209羽島市・21210恵那市）
- 実施日: 2026-07-15
- 候補: 373件（スニペット373件、カテゴリ深掘り145件、選定検証67件）
- 採用: 54件（中津川市11件、美濃市11件、瑞浪市13件、羽島市6件、恵那市13件）
- 公式URL: 採用URL到達確認は tasks/discovery/gifu-official-coverage-002-url-status.txt に記録（54本すべてHTTP 200）
- 保留: トップ、カテゴリ導線、共通ナビ、国制度紹介のみ、受付終了給付、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass
- 到達点: 岐阜県は21201岐阜市から21210恵那市まで第1巡到達。全国公式棚卸しは未完了
- 次回: 岐阜県公式棚卸し003として、21211美濃加茂市から再開

### 岐阜県公式棚卸し003（21211美濃加茂市・21212土岐市・21213各務原市・21214可児市・21215山県市）
- 実施日: 2026-07-15
- 候補: 607件（スニペット607件、カテゴリ深掘り575件、選定検証81件）
- 採用: 81件（美濃加茂市18件、土岐市14件、各務原市17件、可児市8件、山県市24件）
- 公式URL: 採用URL到達確認は tasks/discovery/gifu-official-coverage-003-url-status.txt に記録（81本すべてHTTP 200）
- 保留: トップ、カテゴリ導線、共通ナビ、申請書単体、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass
- 到達点: 岐阜県は21201岐阜市から21215山県市まで第1巡到達。全国公式棚卸しは未完了
- 次回: 岐阜県公式棚卸し004として、21216瑞穂市から再開

### 岐阜県公式棚卸し004（21216瑞穂市・21217飛騨市・21218本巣市・21219郡上市・21220下呂市）
- 実施日: 2026-07-15
- 候補: 947件（スニペット947件、カテゴリ深掘り389件、選定検証95件）
- 採用: 95件（瑞穂市5件、飛騨市18件、本巣市24件、郡上市25件、下呂市23件）
- 公式URL: 採用URL到達確認は tasks/discovery/gifu-official-coverage-004-url-status.txt に記録（95本すべてHTTP 200）
- 保留: トップ、カテゴリ導線、共通ナビ、申請書単体、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass
- 到達点: 岐阜県は21201岐阜市から21220下呂市まで第1巡到達。全国公式棚卸しは未完了
- 次回: 岐阜県公式棚卸し005として、21221海津市から再開

### 岐阜県公式棚卸し005（21221海津市・21302岐南町・21303笠松町・21341養老町・21361垂井町）
- 実施日: 2026-07-15
- 候補: 766件（スニペット766件、公式カテゴリリンクリード146件、選定検証74件）
- 採用: 51件（海津市26件、岐南町11件、笠松町5件、養老町5件、垂井町4件）
- 公式URL: 採用URL到達確認は tasks/discovery/gifu-official-coverage-005-url-status.txt に記録（51本すべてHTTP 200）
- 保留: 外部サイト、トップ、カテゴリ導線、共通ナビ、申請書単体、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass
- 到達点: 岐阜県は21201岐阜市から21361垂井町まで第1巡到達。全国公式棚卸しは未完了
- 次回: 岐阜県公式棚卸し006として、21362関ケ原町から再開

### 岐阜県公式棚卸し006（21362関ケ原町・21381神戸町・21382輪之内町・21383安八町・21401揖斐川町）
- 実施日: 2026-07-15
- 候補: 645件（スニペット645件、公式カテゴリリンクリード461件、選定検証197件）
- 採用: 93件（関ケ原町16件、神戸町24件、輪之内町20件、安八町18件、揖斐川町15件）
- 公式URL: 採用URL到達確認は tasks/discovery/gifu-official-coverage-006-url-status.txt に記録（93本すべてHTTP 200）
- 保留: 外部サイト、トップ、カテゴリ導線、共通ナビ、申請書単体、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass
- 到達点: 岐阜県は21201岐阜市から21401揖斐川町まで第1巡到達。全国公式棚卸しは未完了
- 次回: 岐阜県公式棚卸し007として、21403大野町から再開
### 岐阜県公式棚卸し007（21403大野町・21404池田町・21421北方町・21501坂祝町・21502富加町）
- 実施日: 2026-07-15
- 候補: 463件（スニペット463件、公式カテゴリリンクリード454件、選定検証257件）
- 採用: 110件（大野町31件、池田町38件、北方町6件、坂祝町10件、富加町25件）
- 公式URL: 採用URL到達確認は tasks/discovery/gifu-official-coverage-007-url-status.txt に記録（107本すべてHTTP 200）
- 保留: 外部サイト、トップ、カテゴリ導線、共通ナビ、申請書単体、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass
- 到達点: 岐阜県は21201岐阜市から21502富加町まで第1巡到達。全国公式棚卸しは未完了
- 次回: 岐阜県公式棚卸し008として、21503川辺町から再開


### 岐阜県公式棚卸し008（21503川辺町・21504七宗町・21505八百津町・21506白川町・21507東白川村）
- 実施日: 2026-07-15
- 候補: 879件（スニペット879件、公式カテゴリリンクリード680件、選定検証320件）
- 採用: 99件（川辺町23件、七宗町27件、八百津町12件、白川町27件、東白川村10件）
- 公式URL: 採用URL到達確認は tasks/discovery/gifu-official-coverage-008-url-status.txt に記録（99本すべてHTTP 200）
- 保留: 外部サイト、トップ、カテゴリ導線、共通ナビ、申請書単体、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass
- 到達点: 岐阜県は21201岐阜市から21507東白川村まで第1巡到達。全国公式棚卸しは未完了
- 次回: 岐阜県公式棚卸し009として、21521御嵩町から再開

### 岐阜県公式棚卸し009・静岡県公式棚卸し001（21521御嵩町・21604白川村・22101静岡市・22102浜松市・22203沼津市）
- 実施日: 2026-07-15
- 候補: 676件（スニペット676件、公式リスト9件、採用URL59本）
- 採用: 65件（御嵩町12件、白川村8件、静岡市15件、浜松市15件、沼津市15件）
- 公式URL: 採用URL到達確認は tasks/discovery/gifu-shizuoka-official-coverage-009-url-status.txt に記録（59本すべてHTTP 200）
- 保留: トップ、カテゴリ導線、共通ナビ、既存URL重複、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass
- 到達点: 岐阜県は21201岐阜市から21604白川村まで第1巡完了。静岡県は22101静岡市から22203沼津市まで第1巡到達。全国公式棚卸しは未完了
- 次回: 静岡県公式棚卸し002として、22205熱海市から再開

### 静岡県公式棚卸し002（22205熱海市・22206三島市・22207富士宮市・22208伊東市・22209島田市）
- 実施日: 2026-07-15
- 候補: 439件（スニペット439件、公式リスト25件、採用URL65本）
- 採用: 65件（熱海市13件、三島市13件、富士宮市13件、伊東市13件、島田市13件）
- 公式URL: 採用URL到達確認は tasks/discovery/shizuoka-official-coverage-002-url-status.txt に記録（65本すべてHTTP 200）
- 保留: トップ、カテゴリ導線、共通ナビ、重複トピック、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass
- 到達点: 静岡県は22101静岡市から22209島田市まで第1巡到達。全国公式棚卸しは未完了
- 次回: 静岡県公式棚卸し003として、22210富士市から再開

### 静岡県公式棚卸し003（22210富士市・22211磐田市・22212焼津市・22213掛川市・22214藤枝市）
- 実施日: 2026-07-15
- 候補: 450件（スニペット450件、公式リスト19件、採用URL65本）
- 採用: 65件（富士市14件、磐田市13件、焼津市14件、掛川市12件、藤枝市12件）
- 公式URL: 採用URL到達確認は tasks/discovery/shizuoka-official-coverage-003-url-status.txt に記録（65本すべてHTTP 200）
- 保留: トップ、カテゴリ導線、共通ナビ、重複トピック、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass
- 到達点: 静岡県は22101静岡市から22214藤枝市まで第1巡到達。全国公式棚卸しは未完了
- 次回: 静岡県公式棚卸し004として、22215御殿場市から再開

### 静岡県公式棚卸し004（22215御殿場市・22216袋井市・22219下田市・22220裾野市・22221湖西市）
- 実施日: 2026-07-15
- 候補: 160件（スニペット160件、公式カテゴリリンクリード338件、公式リスト21件、採用URL65本）
- 採用: 65件（御殿場市13件、袋井市13件、下田市13件、裾野市13件、湖西市13件）
- 公式URL: 採用URL到達確認は tasks/discovery/shizuoka-official-coverage-004-url-status.txt に記録（65本すべてHTTP 200）
- 保留: トップ、カテゴリ導線、共通ナビ、重複トピック、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass
- 到達点: 静岡県は22101静岡市から22221湖西市まで第1巡到達。全国公式棚卸しは未完了
- 次回: 静岡県公式棚卸し005として、22222伊豆市から再開

### 静岡県公式棚卸し005（22222伊豆市・22223御前崎市・22224菊川市・22225伊豆の国市・22226牧之原市）
- 実施日: 2026-07-15
- 候補: 331件（スニペット331件、公式カテゴリリンクリード163件、公式リスト21件、採用URL65本）
- 採用: 65件（伊豆市13件、御前崎市13件、菊川市13件、伊豆の国市13件、牧之原市13件）
- 公式URL: 採用URL到達確認は tasks/discovery/shizuoka-official-coverage-005-url-status.txt に記録（65本すべてHTTP 200）
- 保留: トップ、カテゴリ導線、共通ナビ、重複トピック、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass
- 到達点: 静岡県は22101静岡市から22226牧之原市まで第1巡到達。全国公式棚卸しは未完了
- 次回: 静岡県公式棚卸し006として、22301東伊豆町から再開

### 静岡県公式棚卸し006（22301東伊豆町・22302河津町・22304南伊豆町・22305松崎町・22306西伊豆町）
- 実施日: 2026-07-15
- 候補: 275件（スニペット275件、公式カテゴリリンクリード556件、詳細スニペット556件、公式リスト13件、採用URL65本）
- 採用: 65件（東伊豆町7件、河津町20件、南伊豆町15件、松崎町17件、西伊豆町6件）
- 公式URL: 採用URL到達確認は tasks/discovery/shizuoka-official-coverage-006-url-status.txt に記録（65本すべてHTTP 200）
- 保留: トップ、カテゴリ導線、共通ナビ、古い臨時給付、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass
- 到達点: 静岡県は22101静岡市から22306西伊豆町まで第1巡到達。全国公式棚卸しは未完了
- 次回: 静岡県公式棚卸し007として、22325函南町から再開

### 静岡県公式棚卸し007（22325函南町・22341清水町・22342長泉町・22344小山町・22424吉田町）
- 実施日: 2026-07-15
- 候補: 331件（スニペット331件、公式カテゴリリンクリード749件、詳細スニペット749件、公式リスト13件、採用URL65本）
- 採用: 65件（函南町6件、清水町17件、長泉町16件、小山町16件、吉田町10件）
- 公式URL: 採用URL到達確認は tasks/discovery/shizuoka-official-coverage-007-url-status.txt に記録（65本すべてHTTP 200）
- 保留: トップ、カテゴリ導線、共通ナビ、古い臨時給付、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass
- 到達点: 静岡県は22101静岡市から22424吉田町まで第1巡到達。全国公式棚卸しは未完了
- 次回: 静岡県公式棚卸し008として、22429川根本町から再開
### 静岡県公式棚卸し008（22429川根本町・22461森町）
- 実施日: 2026-07-15
- 候補: 30件（スニペット30件、公式カテゴリリンクリード710件、詳細スニペット710件、公式リスト9件、採用URL60本）
- 採用: 60件（川根本町30件、森町30件）
- 公式URL: 採用URL到達確認は tasks/discovery/shizuoka-official-coverage-008-url-status.txt に記録（60本すべてHTTP 200）
- 保留: トップ、カテゴリ導線、共通ナビ、受付終了明記、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass
- 到達点: 静岡県は22101静岡市から22461森町まで第1巡完了。全国公式棚卸しは未完了
- 次回: 愛知県公式棚卸し001として、23100名古屋市から再開
### 愛知県公式棚卸し001（23100名古屋市・23201豊橋市・23202岡崎市・23203一宮市・23204瀬戸市）
- 実施日: 2026-07-15
- 候補: 494件（スニペット494件、公式カテゴリリンクリード1878件、詳細スニペット1878件、公式リスト40件、採用URL70本）
- 採用: 70件（名古屋市22件、豊橋市13件、岡崎市8件、一宮市13件、瀬戸市14件）
- 公式URL: 採用URL到達確認は tasks/discovery/aichi-official-coverage-001-url-status.txt に記録（70本すべてHTTP 200）
- 保留: トップ、カテゴリ導線、共通ナビ、広報・採用・イベント・受付終了・既存URL重複・本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass
- 到達点: 愛知県は23100名古屋市から23204瀬戸市まで第1巡到達。全国公式棚卸しは未完了
- 次回: 愛知県公式棚卸し002として、23205半田市から再開
### 愛知県公式棚卸し002（23205半田市・23206春日井市・23207豊川市・23208津島市・23209碧南市）
- 実施日: 2026-07-15
- 候補: 391件（公式カテゴリリンクリード755件、詳細スニペット755件、公式リスト71件、採用URL71本）
- 採用: 71件（半田市18件、春日井市13件、豊川市8件、津島市14件、碧南市18件）
- 公式URL: 採用URL到達確認は tasks/discovery/aichi-official-coverage-002-url-status.txt に記録（71本すべてHTTP 200）
- 保留: トップ、カテゴリ導線、共通ナビ、広報・採用・イベント・申請書・要綱・手続専用ページ・既存URL重複・本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass
- 到達点: 愛知県は23100名古屋市から23209碧南市まで第1巡到達。全国公式棚卸しは未完了
- 次回: 愛知県公式棚卸し003として、23210刈谷市から再開
### 愛知県公式棚卸し003（23210刈谷市・23211豊田市・23212安城市・23213西尾市・23214蒲郡市）
- 実施日: 2026-07-15
- 候補: 840件（公式カテゴリリンクリード2231件、詳細スニペット2231件、公式リスト75件、採用URL75本）
- 採用: 75件（刈谷市15件、豊田市15件、安城市15件、西尾市15件、蒲郡市15件）
- 公式URL: 採用URL到達確認は tasks/discovery/aichi-official-coverage-003-url-status.txt に記録（75本すべてHTTP 200）
- 保留: トップ、カテゴリ導線、共通ナビ、広報・採用・イベント・申請書・要綱・手続専用ページ・PDF資料・本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass
- 到達点: 愛知県は23100名古屋市から23214蒲郡市まで第1巡到達。全国公式棚卸しは未完了
- 次回: 愛知県公式棚卸し004として、23215犬山市から再開
### 愛知県公式棚卸し004（23215犬山市・23216常滑市・23217江南市・23219小牧市・23220稲沢市）
- 実施日: 2026-07-15
- 候補: 531件（公式カテゴリリンクリード1550件、詳細スニペット1603件、公式リスト75件、採用URL75本）
- 採用: 75件（犬山市15件、常滑市15件、江南市15件、小牧市15件、稲沢市15件）
- 公式URL: 採用URL到達確認は tasks/discovery/aichi-official-coverage-004-url-status.txt に記録（75本すべてHTTP 200）
- 保留: トップ、カテゴリ導線、共通ナビ、広報・採用・イベント・申請書・要綱・手続専用ページ・PDF資料・本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass
- 到達点: 愛知県は23100名古屋市から23220稲沢市まで第1巡到達。全国公式棚卸しは未完了
- 次回: 愛知県公式棚卸し005として、23221新城市から再開
### 愛知県公式棚卸し005（23221新城市・23222東海市・23223大府市・23224知多市・23225知立市）
- 実施日: 2026-07-15
- 候補: 626件（公式カテゴリリンクリード1269件、詳細スニペット1269件、公式リスト75件、採用URL75本）
- 採用: 75件（新城市15件、東海市15件、大府市15件、知多市15件、知立市15件）
- 公式URL: 採用URL到達確認は tasks/discovery/aichi-official-coverage-005-url-status.txt に記録（75本すべてHTTP 200）
- 保留: トップ、カテゴリ導線、共通ナビ、広報・採用・イベント・申請書・要綱・手続専用ページ・PDF資料・受付終了のみ・本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass
- 到達点: 愛知県は23100名古屋市から23225知立市まで第1巡到達。全国公式棚卸しは未完了
- 次回: 愛知県公式棚卸し006として、23226尾張旭市から再開
### 愛知県公式棚卸し006（23226尾張旭市・23227高浜市・23228岩倉市・23229豊明市・23230日進市）
- 実施日: 2026-07-15
- 候補: 1291件（公式カテゴリリンクリード3919件、詳細スニペット1800件、公式リスト75件、採用URL75本）
- 採用: 75件（尾張旭市15件、高浜市15件、岩倉市15件、豊明市15件、日進市15件）
- 公式URL: 採用URL到達確認は tasks/discovery/aichi-official-coverage-006-url-status.txt に記録（75本すべてHTTP 200）
- 保留: トップ、カテゴリ導線、共通ナビ、広報・採用・イベント・申請書・要綱・手続専用ページ・PDF資料・受付終了のみ・本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass
- 到達点: 愛知県は23100名古屋市から23230日進市まで第1巡到達。全国公式棚卸しは未完了
- 次回: 愛知県公式棚卸し007として、23231田原市から再開
### 愛知県公式棚卸し007（23231田原市・23232愛西市・23233清須市・23234北名古屋市・23235弥富市）
- 実施日: 2026-07-15
- 候補: 743件（公式カテゴリリンクリード5989件、詳細スニペット2100件、公式リスト75件、採用URL75本）
- 採用: 75件（田原市15件、愛西市15件、清須市15件、北名古屋市15件、弥富市15件）
- 公式URL: 採用URL到達確認は tasks/discovery/aichi-official-coverage-007-url-status.txt に記録（75本すべてHTTP 200）
- 保留: トップ、カテゴリ導線、共通ナビ、広報・採用・イベント・申請書・要綱・PDF資料・受付終了のみ・本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass
- 到達点: 愛知県は23100名古屋市から23235弥富市まで第1巡到達。全国公式棚卸しは未完了
- 次回: 愛知県公式棚卸し008として、23236みよし市から再開

### 愛知県公式棚卸し008（23236みよし市・23237あま市・23238長久手市・23302東郷町・23342豊山町）
- 実施日: 2026-07-15
- 候補: 427件（公式カテゴリリンクリード3183件、詳細スニペット1811件、公式リスト75件、採用URL75本）
- 採用: 75件（みよし市15件、あま市15件、長久手市15件、東郷町15件、豊山町15件）
- 公式URL: 採用URL到達確認は tasks/discovery/aichi-official-coverage-008-url-status.txt に記録（75本すべてHTTP 200）
- 保留: トップ、カテゴリ導線、共通ナビ、広報・採用・イベント・申請書・要綱・PDF資料・受付終了のみ・本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass
- 到達点: 愛知県は23100名古屋市から23342豊山町まで第1巡到達。全国公式棚卸しは未完了
- 次回: 愛知県公式棚卸し009として、23361大口町から再開

### 愛知県公式棚卸し009（23361大口町・23362扶桑町・23424大治町・23425蟹江町・23427飛島村）
- 実施日: 2026-07-15
- 候補: 1041件（公式カテゴリリンクリード2227件、詳細スニペット2227件、詳細ショートリスト1482件、公式リスト75件、採用URL75本）
- 採用: 75件（大口町15件、扶桑町15件、大治町15件、蟹江町15件、飛島村15件）
- 公式URL: 採用URL到達確認は tasks/discovery/aichi-official-coverage-009-url-status.txt に記録（75本すべてHTTP 200）
- 保留: トップ、カテゴリ導線、共通ナビ、広報・採用・イベント・申請書・要綱・PDF資料・受付終了のみ・本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass
- 到達点: 愛知県は23100名古屋市から23427飛島村まで第1巡到達。全国公式棚卸しは未完了
- 次回: 愛知県公式棚卸し010として、23441阿久比町から再開

### 愛知県公式棚卸し010（23441阿久比町・23442東浦町・23445南知多町・23446美浜町・23447武豊町）
- 実施日: 2026-07-15
- 候補: 492件（公式カテゴリリンクリード706件、詳細スニペット706件、詳細ショートリスト327件、美浜町追加公式クロール1300URL・候補332件、公式リスト75件、採用URL75本）
- 採用: 75件（阿久比町15件、東浦町15件、南知多町15件、美浜町15件、武豊町15件）
- 公式URL: 採用URL到達確認は tasks/discovery/aichi-official-coverage-010-url-status.txt に記録（75本すべてHTTP 200）
- 保留: トップ、カテゴリ導線、共通ナビ、広報・採用・イベント・申請書・要綱・PDF資料・受付終了のみ・本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass
- 到達点: 愛知県は23100名古屋市から23447武豊町まで第1巡到達。全国公式棚卸しは未完了
- 次回: 愛知県公式棚卸し011として、23501幸田町から再開

### 愛知県公式棚卸し011（23501幸田町・23561設楽町・23562東栄町・23563豊根村）
- 実施日: 2026-07-15
- 候補: 1298件（公式カテゴリリンクリード1995件、詳細スニペット1662件、詳細ショートリスト251件、公式リスト60件、採用URL60本）
- 採用: 60件（幸田町15件、設楽町15件、東栄町15件、豊根村15件）
- 公式URL: 採用URL到達確認は tasks/discovery/aichi-official-coverage-011-url-status.txt に記録（60本すべてHTTP 200）
- 保留: トップ、カテゴリ導線、共通ナビ、外部サイト、広報・採用・イベント・申請書・要綱・PDF資料・受付終了のみ・本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass
- 到達点: 愛知県は23100名古屋市から23563豊根村まで第1巡到達し、県内全市区町村の第1巡完了。全国公式棚卸しは未完了
- 次回: 三重県公式棚卸し001として、津市から再開

### 三重県公式棚卸し001（24201津市・24202四日市市・24203伊勢市・24204松阪市・24205桑名市）
- 実施日: 2026-07-15
- 候補: 1323件（公式カテゴリリンクリード442件、詳細スニペット900件、詳細ショートリスト752件、公式リスト75件、採用URL75本）
- 採用: 75件（津市15件、四日市市15件、伊勢市15件、松阪市15件、桑名市15件）
- 公式URL: 採用URL到達確認は tasks/discovery/mie-official-coverage-001-url-status.txt に記録（75本すべてHTTP 200）
- 保留: トップ、カテゴリ導線、共通ナビ、通常行政案内、受付終了のみ、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass
- 到達点: 三重県は24201津市から24205桑名市まで第1巡到達。全国公式棚卸しは未完了
- 次回: 三重県公式棚卸し002として、24207鈴鹿市から再開


### 三重県公式棚卸し002（24207鈴鹿市・24208名張市・24209尾鷲市・24210亀山市・24211鳥羽市）
- 実施日: 2026-07-15
- 候補: 892件（公式カテゴリリンクリード297件、詳細スニペット724件、詳細ショートリスト632件、公式リスト85件、採用URL85本）
- 採用: 85件（鈴鹿市19件、名張市18件、尾鷲市23件、亀山市22件、鳥羽市3件）
- 公式URL: 採用URL到達確認は tasks/discovery/mie-official-coverage-002-url-status.txt に記録（85本すべてHTTP 200）
- 保留: トップ、カテゴリ導線、共通ナビ、通常行政案内、受付終了のみ、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass
- 到達点: 三重県は24201津市から24211鳥羽市まで第1巡到達。全国公式棚卸しは未完了
- 次回: 三重県公式棚卸し003として、24212熊野市から再開


### 三重県公式棚卸し003（24212熊野市・24214いなべ市・24215志摩市・24216伊賀市・24303木曽岬町）
- 実施日: 2026-07-15
- 候補: 949件（公式カテゴリリンクリード745件、詳細スニペット1609件、詳細ショートリスト986件、公式リスト64件、採用URL64本）
- 採用: 64件（熊野市15件、いなべ市15件、志摩市4件、伊賀市15件、木曽岬町15件）
- 公式URL: 採用URL到達確認は tasks/discovery/mie-official-coverage-003-url-status.txt に記録（64本すべてHTTP 200）
- 保留: トップ、カテゴリ導線、共通ナビ、通常行政案内、計画ページ、受付終了のみ、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass
- 到達点: 三重県は24201津市から24303木曽岬町まで第1巡到達。全国公式棚卸しは未完了
- 次回: 三重県公式棚卸し004として、24324東員町から再開


### 三重県公式棚卸し004（24324東員町・24341菰野町・24343朝日町・24344川越町・24441多気町）
- 実施日: 2026-07-15
- 候補: 1008件（公式カテゴリリンクリード1006件、詳細スニペット1006件、詳細ショートリスト593件、公式リスト54件、採用URL54本）
- 採用: 54件（東員町9件、菰野町10件、朝日町15件、川越町15件、多気町5件）
- 公式URL: 採用URL到達確認は tasks/discovery/mie-official-coverage-004-url-status.txt に記録（54本すべてHTTP 200）
- 保留: トップ、カテゴリ導線、共通ナビ、通常行政案内、計画ページ、受付終了のみ、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass
- 到達点: 三重県は24201津市から24441多気町まで第1巡到達。全国公式棚卸しは未完了
- 次回: 三重県公式棚卸し005として、24442明和町から再開


### 三重県公式棚卸し005（24442明和町・24443大台町・24461玉城町・24470度会町・24471大紀町）
- 実施日: 2026-07-15
- 候補: 227件（公式カテゴリリンクリード461件、詳細スニペット461件、詳細ショートリスト156件、公式リスト52件、採用URL52本）
- 採用: 52件（明和町4件、大台町20件、玉城町15件、度会町8件、大紀町5件）
- 公式URL: 採用URL到達確認は tasks/discovery/mie-official-coverage-005-url-status.txt に記録（52本すべてHTTP 200）
- 保留: トップ、カテゴリ導線、共通ナビ、通常行政案内、計画ページ、受付終了のみ、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass
...
### 滋賀県公式棚卸し004（25425愛荘町・25441豊郷町・25442甲良町・25443多賀町）
- 実施日: 2026-07-15
- 候補: 294件（公式カテゴリリンクリード1238件、公式リスト48件、採用URL48本）
- 採用: 48件（愛荘町10件、豊郷町5件、甲良町10件、多賀町23件）
- 公式URL: 採用URL到達確認は tasks/discovery/shiga-official-coverage-004-url-status.txt に記録（48本すべてHTTP 200）
- 保留: トップ、カテゴリ導線、共通ナビ、通常行政案内、PDF・申請書単体、計画ページ、予算・議会・広報、受付終了のみ、本文根拠が薄い候補は第2巡候補として保持
...
### 岡山県公式棚卸し003（33212瀬戸内市・33213赤磐市・33214真庭市・33215美作市・33216浅口市）
- 実施日: 2026-07-17
- 候補: 標準discoverは0件。公式sitemap、公式カテゴリ、公式制度一覧ページ、公式目的別ページ、本文抽出から、公式HTML個別制度ページ・公式制度掲載ページ94本を採用
- 採用: 94件（瀬戸内市18件、赤磐市20件、真庭市20件、美作市20件、浅口市16件）
- 公式URL: 採用URL到達確認は tasks/discovery/okayama-official-coverage-003-url-status.txt に記録（94本すべてHTTP 200）
- 保留: 標準discoverが0件のため、公式カテゴリと公式制度一覧ページを補完。トップ、カテゴリ導線、共通ナビ、PDF単体、申請書単体、外部制度のみ、報告・広報・会議・採用情報、本文根拠が薄い候補、同一制度の重複ページは第2巡候補として保持。浅口市の生活困窮者支援ページは旧URLから現行公式URLへ整理
...
### 広島県公式棚卸し001（34100広島市・34202呉市・34203竹原市・34204三原市・34205尾道市）
- 実施日: 2026-07-17
- 候補: 標準discoverは0件。公式カテゴリページ、公式サイト内リンク、公式sitemap、本文スニペット再スコアから、公式HTML個別制度ページ・公式制度掲載ページ85本を採用
- 採用: 85件（広島市8件、呉市24件、竹原市18件、三原市16件、尾道市19件）
- 公式URL: 採用URL到達確認は tasks/discovery/hiroshima-official-coverage-001-url-status.txt に記録（85本すべてHTTP 200）
- 保留: 標準discoverが0件のため、公式カテゴリと公式サイト内リンクを補完。呉市・三原市・尾道市はshortlistが150件超のため tasks/discovery/hiroshima-official-coverage-001-link-leads.json に本文スニペット付きリードを保存し、トップ、カテゴリ導線、共通ナビ、FAQ、申請書・PDF単体、広報・報告・相談・採用・外部制度のみ、本文根拠が薄い候補、同一制度の重複ページは第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass（failures 0、activePublished 20588、officialLinkedActive 20467、manuallyVerifiedActive 20467、広島県 localOfficial 184）
- 到達点: 広島県は34100広島市から34205尾道市まで第1巡到達。全国公式棚卸しは未完了
- 次回: 広島県公式棚卸し002として、34207福山市から再開

### 広島県公式棚卸し002（34207福山市・34208府中市・34209三次市・34210庄原市・34211大竹市）
- 実施日: 2026-07-17
- 候補: 標準discoverは0件。公式カテゴリページ、公式サイト内リンク、公式sitemap、本文スニペット再スコアから、公式HTML個別制度ページ・公式制度掲載ページ87本を採用
- 採用: 87件（福山市23件、府中市11件、三次市24件、庄原市22件、大竹市7件）
- 公式URL: 採用URL到達確認は tasks/discovery/hiroshima-official-coverage-002-url-status.txt に記録（87本すべてHTTP 200）
- 保留: 標準discoverが0件のため、公式カテゴリと公式サイト内リンクを補完。福山市・府中市・三次市・庄原市はshortlistが150件超のため tasks/discovery/hiroshima-official-coverage-002-link-leads.json に本文スニペット付きリードを保存し、トップ、カテゴリ導線、共通ナビ、FAQ、申請書・PDF単体、広報・報告・相談・採用・外部制度のみ、本文根拠が薄い候補、同一制度の重複ページは第2巡候補として保持
...
### 広島県公式棚卸し005（34431大崎上島町・34462世羅町・34545神石高原町）
- 実施日: 2026-07-17
- 候補: 標準discoverは0件。公式カテゴリページ、公式サイト内リンク、公式sitemap、本文スニペット再スコアから、公式HTML個別制度ページ・公式制度掲載ページ78本を採用
- 採用: 78件（大崎上島町24件、世羅町28件、神石高原町26件）
- 公式URL: 採用URL到達確認は tasks/discovery/hiroshima-official-coverage-005-url-status.txt に記録（78本すべてHTTP 200）
- 保留: 標準discoverが0件のため、公式カテゴリと公式サイト内リンクを補完。大崎上島町は福祉・補助・住まいカテゴリ、世羅町は子育て・住まい・環境・移住定住ページ、神石高原町は子育て・保健福祉・産業・定住住宅ページを起点に確認。トップ、カテゴリ導線、共通ナビ、FAQ、申請書・PDF単体、広報・報告・相談・採用・外部制度のみ、本文根拠が薄い候補、同一制度の重複ページは第2巡候補として保持
...
### 徳島県公式棚卸し003（36321佐那河内村・36341石井町・36342神山町・36368那賀町・36383牟岐町）
- 実施日: 2026-07-17
- 候補: 標準discoverは0件。公式トップ到達、Joruri/Shirasagi系公式sitemap、公式カテゴリリンク、佐那河内村の公式カテゴリ補完クロール、本文スニペット再スコアから1820件を抽出し、公式HTML個別制度ページ80本を採用
- 採用: 80件（佐那河内村0件、石井町20件、神山町20件、那賀町20件、牟岐町20件）
- 公式URL: 採用URL到達確認は tasks/discovery/tokushima-official-coverage-003-url-status.txt に記録（80本すべてHTTP 200）
- 保留: 佐那河内村は公式トップ、sitemap、暮らしガイド、健康・福祉・子育て・産業等カテゴリを確認したが、補助金・助成金・給付金等の個別公式ページとして採用できる本文要件を満たすページは本巡では0件。トップ、カテゴリ導線、共通ナビ、議会、計画・報告・実績、相談、イベント、外部制度のみ、同一制度の重複ページ、古い臨時給付は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass（failures 0、activePublished 21430、officialLinkedActive 21309、manuallyVerifiedActive 21309、徳島県 localOfficial 282）
- 15自治体単位メトリクス: 徳島県001-003の15自治体で235制度、監査3回、commit予定3回、shortlist採用率は80/1820（標準discover 0件のため公式本文再スコア母数比）。compactionとheartbeat中断を跨いだため自治体/時・制度/時の正確な実働値は未確定、次15自治体単位で実測を継続する
- 到達点: 徳島県は36201徳島市から36383牟岐町まで第1巡到達。全国公式棚卸しは未完了
- 次回: 徳島県公式棚卸し004として、36387美波町から再開

### 徳島県公式棚卸し004（36387美波町・36388海陽町・36401松茂町・36402北島町・36403藍住町）
- 実施日: 2026-07-17
- 候補: 標準discoverは0件。公式トップ到達、Joruri sitemap、美波町・北島町の公式カテゴリBFS、藍住町sitemap補完、本文スニペット再スコアから1811件を抽出し、公式HTML個別制度ページ80本を採用
- 採用: 80件（美波町15件、海陽町20件、松茂町20件、北島町15件、藍住町10件）
- 公式URL: 採用URL到達確認は tasks/discovery/tokushima-official-coverage-004-url-status.txt に記録（80本すべてHTTP 200）
- 保留: 標準discoverが0件のため、公式トップ、robots、sitemap、公式カテゴリリンク、本文スニペット再スコアを補完。美波町と北島町はBFS、海陽町・松茂町・藍住町はsitemapを主起点に確認。トップ、カテゴリ導線、共通ナビ、議会、計画・報告・実績、相談、イベント、外部制度のみ、同一制度の重複ページ、古い臨時給付は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass（failures 0、activePublished 21510、officialLinkedActive 21389、manuallyVerifiedActive 21389、徳島県 localOfficial 362）
- 15自治体単位メトリクス: 徳島県004は5自治体で80制度、監査1回、commit予定1回、shortlist採用率は80/1811（標準discover 0件のため公式本文再スコア母数比）。徳島県001-004累計は20自治体315制度、監査4回
- 到達点: 徳島県は36201徳島市から36403藍住町まで第1巡到達。全国公式棚卸しは未完了
- 次回: 徳島県公式棚卸し005として、36404板野町から再開

### 徳島県公式棚卸し005（36404板野町・36405上板町・36468つるぎ町・36489東みよし町）
- 実施日: 2026-07-17
- 候補: 標準discoverは0件。公式トップ到達、板野町公式記事一覧、上板町Joruri sitemap、つるぎ町深層記事一覧、東みよし町公式カテゴリ・記事一覧を補完し、本文スニペット再スコア707件から公式HTML個別制度ページ・公式制度掲載ページ80本を採用
- 採用: 80件（板野町20件、上板町20件、つるぎ町15件、東みよし町25件）
- 公式URL: 採用URL到達確認は tasks/discovery/tokushima-official-coverage-005-url-status.txt に記録（80本すべてHTTP 200）
- 保留: 標準discoverが0件のため、公式トップ、robots、記事一覧、sitemap、公式カテゴリリンク、本文スニペット再スコアを補完。つるぎ町は個別制度ページ不足を補うため公式の制度一覧ページも一部採用。トップ、カテゴリ導線、共通ナビ、議会、計画・報告・実績、相談、イベント、外部制度のみ、同一制度の重複ページ、古い臨時給付は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass（failures 0、activePublished 21590、officialLinkedActive 21469、manuallyVerifiedActive 21469、徳島県 localOfficial 442）
- 15自治体単位メトリクス: 徳島県004-005の9自治体で160制度、監査2回、commit予定2回、shortlist採用率は80/707（標準discover 0件のため公式本文再スコア母数比）。徳島県001-005累計は24自治体395制度、監査5回
- 到達点: 徳島県は36201徳島市から36489東みよし町まで第1巡完了。全国公式棚卸しは未完了
- 次回: 香川県公式棚卸し001として、37201高松市から再開

### 香川県公式棚卸し001（37201高松市・37202丸亀市・37203坂出市・37204善通寺市・37205観音寺市）
- 実施日: 2026-07-17
- 候補: 標準discoverは0件。公式トップ到達、高松市公式sitemap、丸亀市・坂出市・善通寺市・観音寺市の公式分類/組織ページを補完し、本文スニペット再スコア1400件から公式HTML個別制度ページ・公式制度掲載ページ80本を採用
- 採用: 80件（高松市12件、丸亀市14件、坂出市24件、善通寺市17件、観音寺市13件）
- 公式URL: 採用URL到達確認は tasks/discovery/kagawa-official-coverage-001-url-status.txt に記録（80本すべてHTTP 200）
- 保留: 標準discoverが0件のため、公式トップ、robots、sitemap、公式分類/組織リンク、本文スニペット再スコアを補完。高松市は公式sitemapに古い404 URLが混在したため採用前に除外し、公式200到達ページへ差し替えた。トップ、カテゴリ導線、共通ナビ、議会、計画・報告・実績、相談、イベント、外部制度のみ、同一制度の重複ページ、古い臨時給付は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass（failures 0、activePublished 21670、officialLinkedActive 21549、manuallyVerifiedActive 21549、香川県 localOfficial 130）
- 15自治体単位メトリクス: 香川県001は5自治体で80制度、監査予定1回、commit予定1回、shortlist採用率は80/1400（標準discover 0件のため公式本文再スコア母数比）。次の香川県002-003で15自治体単位の実測を継続する
- 到達点: 香川県は37201高松市から37205観音寺市まで第1巡到達。全国公式棚卸しは未完了
- 次回: 香川県公式棚卸し002として、37206さぬき市から再開

### 香川県公式棚卸し002（37206さぬき市・37207東かがわ市・37208三豊市・37322土庄町・37324小豆島町）
- 実施日: 2026-07-17
- 候補: 標準discoverは0件。公式トップ到達、東かがわ市・三豊市・土庄町・小豆島町の公式sitemapを再帰展開し、本文スニペット再スコア1021件から公式HTML個別制度ページ80本を採用
- 採用: 80件（さぬき市0件、東かがわ市20件、三豊市20件、土庄町20件、小豆島町20件）
- 公式URL: 採用URL到達確認は tasks/discovery/kagawa-official-coverage-002-url-status.txt に記録（80本すべてHTTP 200）
- 保留: さぬき市は公式トップのHEAD 200を確認したが、本文GETは403/503およびIncapsula応答で公式本文確認・URL到達監査ができないため本巡採用0件。東かがわ市・三豊市・土庄町・小豆島町は親sitemapが子sitemapへ分岐する構成のため再帰展開で補完。トップ、カテゴリ導線、共通ナビ、議会、計画・報告・実績、相談、イベント、外部制度のみ、同一制度の重複ページ、古い臨時給付は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass（failures 0、activePublished 21750、officialLinkedActive 21629、manuallyVerifiedActive 21629、香川県 localOfficial 210）
- 15自治体単位メトリクス: 香川県001-002の10自治体で160制度、監査予定2回、commit予定2回、shortlist採用率は80/1021（標準discover 0件のため公式本文再スコア母数比）。香川県003で15自治体到達時に実測を継続記録する
- 到達点: 香川県は37201高松市から37324小豆島町まで第1巡到達。全国公式棚卸しは未完了
- 次回: 香川県公式棚卸し003として、37341三木町から再開

### 香川県公式棚卸し003（37341三木町・37364直島町・37386宇多津町・37387綾川町・37403琴平町）
- 実施日: 2026-07-17
- 候補: 標準discoverは0件。公式トップ到達、標準sitemap 404、公式トップ/分類リンクBFS、本文スニペット再スコア794件から公式HTML個別制度ページ80本を採用
- 採用: 80件（三木町15件、直島町15件、宇多津町20件、綾川町15件、琴平町15件）
- 公式URL: 採用URL到達確認は tasks/discovery/kagawa-official-coverage-003-url-status.txt に記録（80本すべてHTTP 200）
- 保留: 標準discoverが0件のため、公式トップ、robots、公式カテゴリリンク、公式サイト内リンク、本文スニペット再スコアを補完。三木町はlife/dtl.php個別記事、直島町は子育て・まちづくり・環境・福祉カテゴリ、宇多津町は補助制度・子育て・移住定住カテゴリ、綾川町はdocs個別記事、琴平町は移住定住・子育て・生活環境カテゴリを起点に確認。トップ、カテゴリ導線、共通ナビ、議会、計画・報告・実績、相談、イベント、外部制度のみ、同一制度の重複ページ、古い臨時給付、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass（failures 0、activePublished 21830、officialLinkedActive 21709、manuallyVerifiedActive 21709、香川県 localOfficial 290）
- 15自治体単位メトリクス: 香川県001-003の15自治体で240制度、監査3回、commit予定3回、shortlist採用率は80/794（標準discover 0件のため公式本文再スコア母数比）。compactionとheartbeat中断を跨いだため自治体/時・制度/時の正確な実働値は未確定、次15自治体単位で実測を継続する
- 到達点: 香川県は37201高松市から37403琴平町まで第1巡到達。全国公式棚卸しは未完了
- 次回: 香川県公式棚卸し004として、37404多度津町から再開（香川県残り2自治体を確認して第1巡完了予定）

### 香川県公式棚卸し004（37404多度津町・37406まんのう町）
- 実施日: 2026-07-17
- 候補: 標準discoverは0件。公式トップ到達、多度津町・まんのう町の公式カテゴリ/サイト内リンクBFS、本文スニペット再スコア917件から公式HTML個別制度ページ・公式制度掲載ページ71本を採用
- 採用: 71件（多度津町38件、まんのう町33件）
- 公式URL: 採用URL到達確認は tasks/discovery/kagawa-official-coverage-004-url-status.txt に記録（71本すべてHTTP 200）
- 保留: 標準discoverが0件のため、公式トップ、robots、公式カテゴリリンク、サイト内リンク、本文スニペット再スコアを補完。多度津町は移住定住、子育て、医療福祉、住宅、防災、産業カテゴリを起点に確認。まんのう町は子育て、魅力発信、生活ステージ、防災、環境、教育カテゴリを起点に確認し、医療費助成・手当系で個別本文が一覧にまとまるものは公式制度掲載ページとして採用。トップ、カテゴリ導線、共通ナビ、議会、計画・報告・実績、相談、イベント、外部制度のみ、同一制度の重複ページ、古い臨時給付、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass（failures 0、activePublished 21901、officialLinkedActive 21780、manuallyVerifiedActive 21780、香川県 localOfficial 361）
- 15自治体単位メトリクス: 香川県004は2自治体で71制度、監査1回、commit予定1回、shortlist採用率は71/917（標準discover 0件のため公式本文再スコア母数比）。香川県001-004累計は17自治体311制度、監査4回
- 到達点: 香川県は37201高松市から37406まんのう町まで第1巡完了。全国公式棚卸しは未完了
- 次回: 愛媛県公式棚卸し001として、38201松山市から再開

### 愛媛県公式棚卸し001（38201松山市・38202今治市）
- 実施日: 2026-07-17
- 候補: 標準discoverは0件。公式トップ到達、松山市・今治市の公式カテゴリ/サイト内リンクBFS、既存公式確認URLの現行到達補完、本文スニペット再スコア367件から公式HTML個別制度ページ・公式制度掲載ページ69本を採用
- 採用: 69件（松山市42件、今治市27件）
- 公式URL: 採用URL到達確認は tasks/discovery/ehime-official-coverage-001-url-status.txt に記録（69本すべてHTTP 200）
- 保留: 宇和島市・八幡浜市・新居浜市は公式トップ200を確認したが、今回のseedでは制度ページ候補が十分に抽出できなかったため、次回はsitemap/公式検索/カテゴリ深掘りで補完する。松山市は子育て、福祉、医療、住宅、防災、産業カテゴリと既存公式確認URLを起点に確認。今治市は防災、観光、産業、環境、子育て公式サイト、移住定住、建築、介護カテゴリを起点に確認。トップ、カテゴリ導線、共通ナビ、議会、計画・報告・実績、相談、イベント、外部制度のみ、同一制度の重複ページ、古い臨時給付、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass（failures 0、activePublished 21970、officialLinkedActive 21849、manuallyVerifiedActive 21849、愛媛県 localOfficial 140）
- 15自治体単位メトリクス: 愛媛県001は2自治体で69制度、監査1回、commit予定1回、shortlist採用率は69/367（標準discover 0件のため公式本文再スコア母数比）。愛媛県は次15自治体単位の実測を継続する
- 到達点: 愛媛県は38201松山市から38202今治市まで第1巡到達。全国公式棚卸しは未完了
- 次回: 愛媛県公式棚卸し002として、38203宇和島市から再開

### 愛媛県公式棚卸し002（38203宇和島市・38204八幡浜市・38205新居浜市・38206西条市・38207大洲市）
- 実施日: 2026-07-17
- 候補: 標準discoverは0件。公式トップ到達、宇和島市・新居浜市・西条市・大洲市の公式カテゴリ/サイト内リンクBFS、八幡浜市の公式RSS/Atomから個別HTML記事URL抽出、既存公式確認URLの現行到達補完、本文スニペット再スコア2361件から公式HTML個別制度ページ・公式制度掲載ページ60本を採用
- 採用: 60件（宇和島市12件、八幡浜市12件、新居浜市12件、西条市12件、大洲市12件）
- 公式URL: 採用URL到達確認は tasks/discovery/ehime-official-coverage-002-url-status.txt に記録（60本すべてHTTP 200）
- 保留: 標準discoverが0件のため、公式トップ、公式カテゴリリンク、サイト内リンク、本文スニペット再スコア、RSS/Atom内の個別記事URLを補完。宇和島市は子育て、介護、国保、環境、浄化槽カテゴリ、八幡浜市は医療費助成、子育て支援、福祉、空き家カテゴリ、新居浜市は住宅、防災、子育て、医療、教育、創業、環境カテゴリ、西条市は子育て、国保、介護、移住、産業、脱炭素カテゴリ、大洲市は子育て、高齢福祉、環境、移住、税減免、防災カテゴリを起点に確認。トップ、カテゴリ導線、RSS/Atom自体、共通ナビ、FAQ、議会、計画・報告・実績、相談、イベント、外部制度のみ、同一制度の重複ページ、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass（failures 0、activePublished 22030、officialLinkedActive 21909、manuallyVerifiedActive 21909、愛媛県 localOfficial 200）
- 15自治体単位メトリクス: 愛媛県001-002累計は7自治体129制度、監査2回、commit予定2回、shortlist採用率は60/2361（標準discover 0件のため公式本文再スコア母数比）。compactionとheartbeat中断を跨いだため自治体/時・制度/時の正確な実働値は未確定、次15自治体単位で実測を継続する
- 到達点: 愛媛県は38201松山市から38207大洲市まで第1巡到達。全国公式棚卸しは未完了
- 次回: 愛媛県公式棚卸し003として、38210伊予市から再開（想定対象は38210伊予市・38213四国中央市・38214西予市・38215東温市・38356上島町）

### 愛媛県公式棚卸し003（38210伊予市・38213四国中央市・38214西予市・38215東温市・38356上島町）
- 実施日: 2026-07-17
- 候補: 標準discoverは0件。公式トップ到達、5市町の公式カテゴリ/サイト内リンクBFS、既存公式確認URLの現行到達補完、本文スニペット再スコア1203件から公式HTML個別制度ページ・公式制度掲載ページ60本を採用
- 採用: 60件（伊予市12件、四国中央市12件、西予市12件、東温市12件、上島町12件）
- 公式URL: 採用URL到達確認は tasks/discovery/ehime-official-coverage-003-url-status.txt に記録（60本すべてHTTP 200）
- 保留: 標準discoverが0件のため、公式トップ、公式カテゴリリンク、サイト内リンク、本文スニペット再スコアを補完。伊予市は医療費助成、子育て、ひとり親、障がい福祉、環境カテゴリ、四国中央市は空き家対策、中小企業支援、医療費助成、環境、移住定住カテゴリ、西予市は住宅、医療、介護、障がい、子育て、教育、産業補助カテゴリ、東温市は環境、移住、空き家、産業、母子保健、医療費、防災カテゴリ、上島町は子育て、奨学、住宅、空き家、移住、医療、環境、防災カテゴリを起点に確認。トップ、カテゴリ導線、一覧、共通ナビ、議会、計画・報告・実績、相談、イベント、外部制度のみ、同一制度の重複ページ、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass（failures 0、activePublished 22090、officialLinkedActive 21969、manuallyVerifiedActive 21969、愛媛県 localOfficial 260）
- 15自治体単位メトリクス: 愛媛県001-003累計は12自治体189制度、監査3回、commit予定3回、shortlist採用率は60/1203（標準discover 0件のため公式本文再スコア母数比）。compactionとheartbeat中断を跨いだため自治体/時・制度/時の正確な実働値は未確定、次15自治体単位で実測を継続する
- 到達点: 愛媛県は38201松山市から38356上島町まで第1巡到達。全国公式棚卸しは未完了
- 次回: 愛媛県公式棚卸し004として、38386久万高原町から再開（想定対象は38386久万高原町・38401松前町・38402砥部町・38422内子町・38442伊方町）

### 愛媛県公式棚卸し004（38386久万高原町・38401松前町・38402砥部町・38422内子町・38442伊方町）
- 実施日: 2026-07-17
- 候補: 標準discoverは0件。公式トップ到達、5町の公式カテゴリ/サイト内リンクBFS、本文スニペット再スコア924件から公式HTML個別制度ページ・公式制度掲載ページ60本を採用
- 採用: 60件（久万高原町12件、松前町12件、砥部町12件、内子町12件、伊方町12件）
- 公式URL: 採用URL到達確認は tasks/discovery/ehime-official-coverage-004-url-status.txt に記録（60本すべてHTTP 200）
- 保留: 標準discoverが0件のため、公式トップ、公式カテゴリリンク、サイト内リンク、本文スニペット再スコアを補完。既存データ内の同名「松前町」は北海道松前町の公式URLであり、愛媛県松前町（town.masaki.ehime.jp）とは自治体違いのため採用対象から除外。トップ、カテゴリ導線、一覧、共通ナビ、議会、計画・報告・実績、相談、イベント、外部制度のみ、同一制度の重複ページ、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass（failures 0、activePublished 22150、officialLinkedActive 22029、manuallyVerifiedActive 22029、愛媛県 localOfficial 320）
- 15自治体単位メトリクス: 愛媛県001-004累計は17自治体249制度、監査4回、commit予定4回、shortlist採用率は60/924（標準discover 0件のため公式本文再スコア母数比）。compactionとheartbeat中断を跨いだため自治体/時・制度/時の正確な実働値は未確定、次15自治体単位で実測を継続する
- 到達点: 愛媛県は38201松山市から38442伊方町まで第1巡到達。全国公式棚卸しは未完了
- 次回: 愛媛県公式棚卸し005として、38484松野町から再開（想定対象は38484松野町・38488鬼北町・38506愛南町）

### 愛媛県公式棚卸し005（38484松野町・38488鬼北町・38506愛南町）
- 実施日: 2026-07-17
- 候補: 標準discoverは0件。公式トップ到達、3町の公式カテゴリ/サイト内リンクBFS、本文スニペット再スコア1204件から公式HTML個別制度ページ・公式制度掲載ページ60本を採用
- 採用: 60件（松野町20件、鬼北町20件、愛南町20件）
- 公式URL: 採用URL到達確認は tasks/discovery/ehime-official-coverage-005-url-status.txt に記録（60本すべてHTTP 200）
- 保留: 一時的にJSTCDNの403が発生したため短時間の連続アクセスを避け、到達回復後に再スコアとURL監査を再実行。松野町は福祉・子育て・住宅・環境・産業支援、鬼北町は住宅・就職・子育て・福祉・環境・住宅支援、愛南町は防災・産業・子育て・医療費助成・住宅助成の個別制度ページおよび公式制度掲載ページを起点に確認。トップ、カテゴリ導線、一覧、共通ナビ、議会、計画・報告・実績、相談、イベント、外部制度のみ、同一制度の重複ページ、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass（failures 0、activePublished 22210、officialLinkedActive 22089、manuallyVerifiedActive 22089、愛媛県 localOfficial 380）
- 15自治体単位メトリクス: 愛媛県001-005累計は20自治体309制度、監査5回、commit予定5回、shortlist採用率は60/1204（標準discover 0件のため公式本文再スコア母数比）。JSTCDN 403による待機が発生したため自治体/時・制度/時の正確な実働値は未確定、次15自治体単位で実測を継続する
- 到達点: 愛媛県は38201松山市から38506愛南町まで第1巡完了。全国公式棚卸しは未完了
- 次回: 高知県公式棚卸し001として、39201高知市から再開

### 高知県公式棚卸し001（39201高知市・39202室戸市・39203安芸市・39204南国市・39205土佐市）
- 実施日: 2026-07-17
- 候補: 標準discoverは0件。公式トップ5自治体200到達、高知市・安芸市・南国市の公式カテゴリ/サイト内リンクBFS、本文スニペット再スコア834件から公式HTML個別制度ページ60本を採用
- 採用: 60件（高知市20件、室戸市0件、安芸市20件、南国市20件、土佐市0件）
- 公式URL: 採用URL到達確認は tasks/discovery/kochi-official-coverage-001-url-status.txt に記録（60本すべてHTTP 200）
- 保留: 室戸市・土佐市は公式トップ200を確認したが、今回seedでは制度ページ候補が抽出できなかったため第2巡でsitemap/公式検索/カテゴリ深掘りを継続。高知市は不妊治療・防災・住宅・下水道・見舞金・妊婦支援、安芸市は子育て医療・不妊治療・家計支援・移住・介護人材・環境・耐震、南国市はワクチン・医療費・手当・就学援助・事業者補助・住宅耐震を起点に確認。トップ、カテゴリ、検索、部署、共通ナビ、計画・報告・実績、単なる手続・告知、外部制度のみ、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass（failures 0、activePublished 22270、officialLinkedActive 22149、manuallyVerifiedActive 22149、高知県 localOfficial 101）
- 15自治体単位メトリクス: 高知県001は5自治体で60制度、監査1回、commit予定1回、shortlist採用率は60/834（標準discover 0件のため公式本文再スコア母数比）。次の高知県002-003で15自治体単位の実測を継続する
- 到達点: 高知県は39201高知市から39205土佐市まで第1巡到達。全国公式棚卸しは未完了
- 次回: 高知県公式棚卸し002として、39206須崎市から再開（想定対象は39206須崎市・39208宿毛市・39209土佐清水市・39210四万十市・39211香南市）

### 高知県公式棚卸し002（39206須崎市・39208宿毛市・39209土佐清水市・39210四万十市・39211香南市）
- 実施日: 2026-07-17
- 候補: 標準discoverは0件。公式トップ5自治体200到達、5市の公式カテゴリ/サイト内リンクBFS、宿毛市公式移住支援ページ補完、本文スニペット再スコア824件から公式HTML個別制度ページ・公式制度掲載ページ61本を採用
- 採用: 61件（須崎市16件、宿毛市2件、土佐清水市19件、四万十市12件、香南市12件）
- 公式URL: 採用URL到達確認は tasks/discovery/kochi-official-coverage-002-url-status.txt に記録（61本すべてHTTP 200）
- 保留: 宿毛市はBFSで空き家バンク物件個票が多かったため、公式支援制度掲載ページと移住応援事業補助金HTMLを採用し、物件個票・PDF要綱単体は第2巡候補/根拠補助へ。カテゴリ、検索、部署、計画、実績公表、募集職員、単なる手続・告知、外部制度のみ、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass（failures 0、activePublished 22331、officialLinkedActive 22210、manuallyVerifiedActive 22210、高知県 localOfficial 162）
- 15自治体単位メトリクス: 高知県001-002累計は10自治体121制度、監査2回、commit予定2回、shortlist採用率は61/824（標準discover 0件のため公式本文再スコア母数比）。次の高知県003で15自治体単位の実測を継続する
- 到達点: 高知県は39201高知市から39211香南市まで第1巡到達。全国公式棚卸しは未完了
- 次回: 高知県公式棚卸し003として、39212香美市から再開（想定対象は39212香美市・39301東洋町・39302奈半利町・39303田野町・39304安田町）

### 高知県公式棚卸し003（39212香美市・39301東洋町・39302奈半利町・39303田野町・39304安田町）
- 実施日: 2026-07-17
- 候補: 標準discoverは0件。公式トップは香美市・奈半利町・田野町・安田町が200到達、東洋町は公式HTTPSが到達不可のためHTTP公式トップ200へ補正。5市町の公式カテゴリ/サイト内リンクBFS、本文スニペット再スコア1370件から公式HTML個別制度ページ61本を採用
- 採用: 61件（香美市20件、東洋町12件、田野町12件、奈半利町9件、安田町8件）
- 公式URL: 採用URL到達確認は tasks/discovery/kochi-official-coverage-003-url-status.txt に記録（61本すべてHTTP 200）
- 保留: 東洋町はHTTP公式URLを採用。空き家バンク物件個票、カテゴリ/一覧、検索、部署、共通ナビ、計画、実績公表、募集職員、単なる手続・告知、外部制度のみ、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass（failures 0、activePublished 22392、officialLinkedActive 22271、manuallyVerifiedActive 22271、高知県 localOfficial 223）
- 15自治体単位メトリクス: 高知県001-003累計は15自治体182制度、監査3回、commit予定3回、shortlist採用率は61/1370（標準discover 0件のため公式本文再スコア母数比）。compactionとheartbeat中断を跨ぐため自治体/時・制度/時の厳密値は未確定、次15自治体単位で実測を継続する
- 到達点: 高知県は39201高知市から39304安田町まで第1巡到達。全国公式棚卸しは未完了
- 次回: 高知県公式棚卸し004として、39305北川村から再開（想定対象は39305北川村・39306馬路村・39307芸西村・39341本山町・39344大豊町）

### 高知県公式棚卸し004（39305北川村・39306馬路村・39307芸西村・39341本山町・39344大豊町）
- 実施日: 2026-07-17
- 候補: 標準discoverは0件。公式トップ5自治体200到達（馬路村は `www.vill.umaji.kochi.jp` が到達不可のため `https://umaji.gr.jp/` を公式到達形として確認）。公式カテゴリ/サイト内リンクBFSと芸西村公式list2補完、本文スニペット再スコア688件から公式HTML個別制度ページ61本を採用
- 採用: 61件（北川村20件、馬路村0件、芸西村8件、本山町15件、大豊町18件）
- 公式URL: 採用URL到達確認は tasks/discovery/kochi-official-coverage-004-url-status.txt に記録（61本すべてHTTP 200）
- 保留: 馬路村は公式到達したが現行トップ/公式内検索が観光寄りで制度候補0件のため第2巡で村公式行政導線・PDF・県連携ページを深掘り。芸西村はBFS候補が薄かったため公式list2カテゴリから個別制度ページを補完。空き家物件個票、カテゴリ/一覧、検索、部署、共通ナビ、計画、実績公表、募集職員、単なる手続・告知、外部制度のみ、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass（failures 0、activePublished 22453、officialLinkedActive 22332、manuallyVerifiedActive 22332、高知県 localOfficial 284）
- 15自治体単位メトリクス: 高知県004は5自治体61制度、監査1回、commit予定1回、shortlist採用率は61/688（標準discover 0件のため公式本文再スコア母数比）。高知県001-004累計は20自治体243制度、監査4回。馬路村0件のため次回以降で第2巡補完を継続する
- 到達点: 高知県は39201高知市から39344大豊町まで第1巡到達。全国公式棚卸しは未完了
- 次回: 高知県公式棚卸し005として、39363土佐町から再開（想定対象は39363土佐町・39364大川村・39386いの町・39387仁淀川町・39401中土佐町）

### 高知県公式棚卸し005（39363土佐町・39364大川村・39386いの町・39387仁淀川町・39401中土佐町）
- 実施日: 2026-07-17
- 候補: 標準discoverは0件。公式トップ5自治体200到達。公式カテゴリ/サイト内リンクBFSを上限240件で再スコアし、本文スニペット再スコア481件から公式HTML個別制度ページおよび制度本文を含む公式掲載ページ60本を採用
- 採用: 60件（土佐町17件、大川村7件、いの町16件、仁淀川町5件、中土佐町15件）
- 公式URL: 採用URL到達確認は tasks/discovery/kochi-official-coverage-005-url-status.txt に記録（60本すべてHTTP 200）
- 保留: 大川村は公式サイト巡回中に一部URL取得待ちが長くなったため上限240件に調整。仁淀川町は制度本文がカテゴリ/listページにまとまるものを公式制度掲載ページとして採用。トップ、カテゴリのみ、検索、部署、共通ナビ、計画、実績公表、募集職員、入札、単なる手続・告知、外部制度のみ、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass（failures 0、activePublished 22513、officialLinkedActive 22392、manuallyVerifiedActive 22392、高知県 localOfficial 344）
- 15自治体単位メトリクス: 高知県005は5自治体60制度、監査1回、commit予定1回、shortlist採用率は60/481（標準discover 0件のため公式本文再スコア母数比）。高知県001-005累計は25自治体303制度、監査5回
- 到達点: 高知県は39201高知市から39401中土佐町まで第1巡到達。全国公式棚卸しは未完了
- 次回: 高知県公式棚卸し006として、39402佐川町から再開（想定対象は39402佐川町・39403越知町・39405檮原町・39410日高村・39411津野町）

### 高知県公式棚卸し006（39402佐川町・39403越知町・39405檮原町・39410日高村・39411津野町）
- 実施日: 2026-07-17
- 候補: 標準discoverは0件。公式トップ5自治体200到達。公式カテゴリ/サイト内リンクBFSを上限240件で再スコアし、本文スニペット再スコア160件から公式HTML個別制度ページ、公式PDF、制度本文を含む公式掲載ページ83本を採用
- 採用: 83件（佐川町28件、越知町16件、檮原町6件、日高村25件、津野町8件）
- 公式URL: 採用URL到達確認は tasks/discovery/kochi-official-coverage-006-url-status.txt に記録（83本すべてHTTP 200）
- 保留: 津野町・檮原町は制度本文がまとめページ/PDFに寄るため、公式制度掲載ページとして根拠があるものを採用。PDF本文バイナリ断片は表示品質のため「公式PDF記載に従う」へ正規化。トップ、カテゴリのみ、検索、部署、共通ナビ、計画、実績公表、募集職員、入札、単なる手続・告知、外部制度のみ、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、audit:coverage はpass（failures 0、activePublished 22596、officialLinkedActive 22475、manuallyVerifiedActive 22475、高知県 localOfficial 427）。git diff --check はcommit前に実施
- 15自治体単位メトリクス: 高知県006は5自治体83制度、監査1回、commit予定1回、shortlist採用率は83/160（標準discover 0件のため公式本文再スコア母数比）。高知県004-006累計は15自治体204制度、監査3回
- 到達点: 高知県は39201高知市から39411津野町まで第1巡到達。全国公式棚卸しは未完了
- 次回: 高知県公式棚卸し007として、39412四万十町から再開（想定対象は39412四万十町・39424大月町・39427三原村・39428黒潮町）

### 高知県公式棚卸し007（39412四万十町・39424大月町・39427三原村・39428黒潮町）
- 実施日: 2026-07-17
- 候補: 標準discoverは0件。公式トップ4自治体200到達。公式カテゴリ/サイト内リンクBFSを上限240件で再スコアし、本文スニペット再スコア275件（三原村49件、四万十町108件、大月町118件）を抽出。黒潮町は再スコア0件だったため公式カテゴリ導線から直接抽出し、shortlistが150件超のためローカルJSON/本文スニペットで再選別
- 採用: 71件（四万十町29件、大月町11件、三原村19件、黒潮町12件）
- 公式URL: 採用URL到達確認は tasks/discovery/kochi-official-coverage-007-url-status.txt に記録（71本すべてHTTP 200）
- 保留: 黒潮町は公式サイト構造上、カテゴリ導線から個別 `/pb/cont/` ページへ到達して採用。大月町・三原村の支援制度一覧は制度本文を含む公式掲載ページとして採用。トップ、カテゴリのみ、検索、部署、共通ナビ、計画、実績公表、募集職員、入札、単なる手続・告知、外部制度のみ、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、audit:coverage はpass（failures 0、activePublished 22667、officialLinkedActive 22546、manuallyVerifiedActive 22546、高知県 localOfficial 498）。git diff --check はcommit前に実施
- 15自治体単位メトリクス: 高知県007は4自治体71制度、監査1回、commit予定1回、shortlist採用率は71/287（再スコア275件+黒潮町直接抽出12件）。高知県005-007累計は14自治体214制度、監査3回
- 到達点: 高知県は39201高知市から39428黒潮町まで全34市町村の第1巡に到達。高知県001-007累計は457制度。全国公式棚卸しは未完了
- 次回: 福岡県公式棚卸し001として、40100北九州市から再開（想定対象は40100北九州市・40130福岡市・40202大牟田市・40203久留米市・40204直方市）


### 福岡県公式棚卸し001（40100北九州市・40130福岡市・40202大牟田市・40203久留米市・40204直方市）
- 実施日: 2026-07-17
- 候補: 標準discoverは0件。公式トップ5自治体200到達。公式カテゴリ/サイト内リンクBFSを上限260件で再スコアし、候補254件（久留米市47件、直方市109件、福岡市81件、北九州市17件）を抽出。大牟田市は公式カテゴリ導線から直接抽出し、詳細スニペット427件で再選別
- 採用: 71件（北九州市15件、福岡市18件、大牟田市10件、久留米市10件、直方市18件）
- 公式URL: 採用URL到達確認は tasks/discovery/fukuoka-official-coverage-001-url-status.txt に記録（71本すべてHTTP 200）
- 保留: 大牟田市は共通ナビ由来の低品質タイトルが多かったため、公式カテゴリ/個別ページの見出しを再取得して採用。トップ、カテゴリのみ、検索、部署、共通ナビ、計画・実績公表、募集終了のみ、単なる手続・告知、外部制度のみ、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass（failures 0、activePublished 22738、officialLinkedActive 22616、manuallyVerifiedActive 22616、福岡県 localOfficial 215）
- 15自治体単位メトリクス: 福岡県001は5自治体71制度、監査1回、commit予定1回、shortlist採用率は71/681（再スコア254件+詳細スニペット427件）。次の福岡県002-003で15自治体単位の実測を継続する
- 到達点: 福岡県は40100北九州市から40204直方市まで第1巡到達。全国公式棚卸しは未完了
- 次回: 福岡県公式棚卸し002として、40205飯塚市から再開（想定対象は40205飯塚市・40206田川市・40207柳川市・40210八女市・40211筑後市）


### 福岡県公式棚卸し002（40205飯塚市・40206田川市・40207柳川市・40210八女市・40211筑後市）
- 実施日: 2026-07-17
- 候補: 標準discoverは0件。公式トップ5自治体200到達。公式カテゴリ/サイト内リンクBFSを上限260件で再スコアし、候補332件（筑後市95件、八女市75件、飯塚市108件、柳川市54件）を抽出。田川市は動的CMSで通常BFS候補0件だったため、公式sitemap.htmlから補助制度/補助助成カテゴリおよび補聴器購入助成個別ページを補完。shortlistが150件超のため詳細スニペット334件で再選別
- 採用: 60件（飯塚市15件、田川市3件、柳川市12件、八女市15件、筑後市15件）
- 公式URL: 採用URL到達確認は tasks/discovery/fukuoka-official-coverage-002-url-status.txt に記録（60本すべてHTTP 200。一時fetch失敗1件は単体確認後の再試行で200）
- 保留: 田川市は公式CMS構造上、制度カテゴリページにまとまるものを公式制度掲載ページとして最小限採用。トップ、部署、共通ナビ、計画・実績公表、職員募集、単なる手続・告知、外部制度のみ、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass（failures 0、activePublished 22798、officialLinkedActive 22676、manuallyVerifiedActive 22676、福岡県 localOfficial 275）
- 15自治体単位メトリクス: 福岡県001-002累計は10自治体131制度、監査2回、commit予定2回、shortlist採用率は60/334（詳細スニペット母数比）。次の福岡県003で15自治体単位の実測を継続する
- 到達点: 福岡県は40100北九州市から40211筑後市まで第1巡到達。全国公式棚卸しは未完了
- 次回: 福岡県公式棚卸し003として、40212大川市から再開（想定対象は40212大川市・40213行橋市・40214豊前市・40215中間市・40216小郡市）

### 福岡県公式棚卸し003（40212大川市・40213行橋市・40214豊前市・40215中間市・40216小郡市）
- 実施日: 2026-07-17
- 候補: 標準discoverは0件。公式トップ5市200到達。公式カテゴリ/サイト内リンクBFSを上限260件で再スコアし、候補249件（行橋市121件、小郡市19件、中間市46件、豊前市63件）を抽出。大川市は公式sitemap.xml本文走査で114件を補完し、統合候補363件へ拡張。中間市・小郡市・行橋市は公式カテゴリ配下リンクをfocused scanで補完し、詳細スニペット363件およびfocused link 350件で再選別
- 採用: 63件（大川市15件、行橋市15件、豊前市19件、中間市12件、小郡市2件）
- 公式URL: 採用URL到達確認は tasks/discovery/fukuoka-official-coverage-003-url-status.txt に記録（63本すべてHTTP 200）
- 保留: 大川市は公式HTTPSトップ到達後、公式sitemap.xmlがHTTP URLを返す構造だったため本文走査で制度ページを補完。小郡市はCMSタイトルが空になるため本文見出しから制度名を確認し、支援制度集約ページと空き家バンク登録物件購入等補助金を採用。トップ、カテゴリのみ、広報、計画・実績、イベント、外部制度のみ、物件個票、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check、audit:coverage すべてpass（failures 0、activePublished 22861、officialLinkedActive 22739、manuallyVerifiedActive 22739、福岡県 localOfficial 338）
- 15自治体単位メトリクス: 福岡県001-003累計は15自治体194制度、監査3回、commit予定3回、shortlist採用率は63/363（詳細スニペット母数比）。focused link補完を含めた候補採用率は63/(363+350)
- 到達点: 福岡県は40100北九州市から40216小郡市まで第1巡到達。全国公式棚卸しは未完了
- 次回: 福岡県公式棚卸し004として、40217筑紫野市から再開（想定対象は40217筑紫野市・40218春日市・40219大野城市・40220宗像市・40221太宰府市）

### 福岡県公式棚卸し004（40217筑紫野市・40218春日市・40219大野城市・40220宗像市・40221太宰府市）
- 実施日: 2026-07-17
- 候補: 標準discoverは0件。公式トップ5市200到達。公式カテゴリ/サイト内リンクBFSを上限260件で再スコアし、候補426件（春日市109件、太宰府市72件、大野城市208件、筑紫野市37件）を抽出。宗像市は通常BFS候補0件だったため公式sitemap.htmlとfocused link scanで補完し、筑紫野市もfocused link scanで個別制度ページを補完。詳細スニペット426件、focused link 477件、宗像sitemap scan 54件から再選別
- 採用: 75件（筑紫野市16件、春日市12件、大野城市17件、宗像市15件、太宰府市15件）
- 公式URL: 採用URL到達確認は tasks/discovery/fukuoka-official-coverage-004-url-status.txt に記録（75本すべてHTTP 200）
- 保留: 宗像市は公式sitemap.xmlが404のためsitemap.htmlとカテゴリ導線で個別 `/kiji` ページを補完。太宰府市はカテゴリページから個別制度ページを追加取得。トップ、カテゴリのみ、検索、部署、共通ナビ、計画・実績、イベント、受付終了のみの旧給付金、外部制度のみ、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check はpass。audit:coverage は作業ツリー上の未関係 `src/lib/grant-copy.ts` / `src/lib/grants.ts` 変更により `sanitizeGrantCopy` の `tags.map` で停止したため未通過（福岡004対象ファイル自体の構文・URL・重複・eslint・diff checkは通過）
- 15自治体単位メトリクス: 福岡県001-004累計は20自治体269制度、監査4回試行、commit予定4回。福岡県004のshortlist採用率は75/(426+477+54)。audit失敗は未関係作業ツリー要因として次回以降に再実行対象
- 到達点: 福岡県は40100北九州市から40221太宰府市まで第1巡到達。全国公式棚卸しは未完了
- 次回: 福岡県公式棚卸し005として、40223古賀市から再開（想定対象は40223古賀市・40224福津市・40225うきは市・40226宮若市・40227嘉麻市）

### 福岡県公式棚卸し005（40223古賀市・40224福津市・40225うきは市・40226宮若市・40227嘉麻市）
- 実施日: 2026-07-17
- 候補: 標準discoverは0件。公式トップ5市200到達。公式カテゴリ/サイト内リンクBFSを上限260件で再スコアし、候補331件（うきは市121件、嘉麻市44件、宮若市63件、古賀市29件、福津市74件）を抽出。古賀市は `/sitemap/`、福津市・うきは市・宮若市・嘉麻市は `sitemap.html` と制度カテゴリ導線をfocused link scanで補完し、822件を追加抽出。詳細スニペット331件、focused link 822件から再選別
- 採用: 83件（古賀市20件、福津市15件、うきは市18件、宮若市20件、嘉麻市10件）
- 公式URL: 採用URL到達確認は tasks/discovery/fukuoka-official-coverage-005-url-status.txt に記録（83本すべてHTTP 200）
- 保留: 嘉麻市は個別制度ページが薄いため、制度本文を含む公式掲載ページを最小限採用。トップ、カテゴリのみ、検索、部署、共通ナビ、実績公表、申請書様式のみ、物件個票、受付終了のみの旧給付金、外部制度のみ、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check はpass。audit:coverage は作業ツリー上の未関係 `src/lib/grant-copy.ts` / `src/lib/grants.ts` 変更により `sanitizeGrantCopy` の `tags.map` で停止したため未通過（福岡005対象ファイル自体の構文・URL・重複・eslint・diff checkは通過）
- 15自治体単位メトリクス: 福岡県004-005累計は10自治体158制度、監査2回試行。福岡県005のshortlist採用率は83/(331+822)。audit失敗は未関係作業ツリー要因として次回以降に再実行対象
- 到達点: 福岡県は40100北九州市から40227嘉麻市まで第1巡到達。全国公式棚卸しは未完了
- 次回: 福岡県公式棚卸し006として、40228朝倉市から再開（想定対象は40228朝倉市・40229みやま市・40230糸島市・40231那珂川市・40341宇美町）

### 福岡県公式棚卸し006（40228朝倉市・40229みやま市・40230糸島市・40231那珂川市・40341宇美町）
- 実施日: 2026-07-17
- 候補: 標準discoverは0件。公式トップ5自治体200到達。公式カテゴリ/サイト内リンクBFSを上限280件で再スコアし、候補535件（みやま市141件、宇美町122件、糸島市91件、朝倉市57件、那珂川市124件）を抽出。候補過多のため詳細スニペット535件をローカル再スコアし、みやま市・宇美町は制度カテゴリ導線からfocused link 1184件を補完。朝倉市は商工業・子育て・福祉・住まいカテゴリを追加走査し25件を補完
- 採用: 98件（朝倉市20件、みやま市37件、糸島市12件、那珂川市9件、宇美町20件）
- 公式URL: 採用URL到達確認は tasks/discovery/fukuoka-official-coverage-006-url-status.txt に記録（98本すべてHTTP 200）
- 保留: みやま市・宇美町はカテゴリ配下に制度ページが多く、個別HTMLページを優先採用。トップ、カテゴリのみ、部署、共通ナビ、計画・実績公表、受付終了のみの旧給付金、外部制度のみ、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check はpass。audit:coverage は作業ツリー上の未関係 `src/lib/grant-copy.ts` / `src/lib/grants.ts` 変更により `sanitizeGrantCopy` の `tags.map` で停止したため未通過（福岡006対象ファイル自体の構文・JSON・URL・重複・eslint・diff checkは通過）
- 15自治体単位メトリクス: 福岡県004-006累計は15自治体256制度、監査3回試行。福岡県006のshortlist採用率は98/(535+1184+25)。audit失敗は未関係作業ツリー要因として次回以降に再実行対象
- 到達点: 福岡県は40100北九州市から40341宇美町まで第1巡到達。全国公式棚卸しは未完了
- 次回: 福岡県公式棚卸し007として、40342篠栗町から再開（想定対象は40342篠栗町・40343志免町・40344須恵町・40345新宮町・40348久山町）


### 福岡県公式棚卸し007（40342篠栗町・40343志免町・40344須恵町・40345新宮町・40348久山町）
- 実施日: 2026-07-17
- 候補: 標準discoverは0件。公式トップ5自治体200到達。公式カテゴリ/サイト内リンクBFSを上限280件で再スコアし、候補230件（久山町41件、志免町37件、篠栗町82件、新宮町36件、須恵町34件）を抽出。候補過多のため詳細スニペット230件を生成し、shortlist 221件へローカル再スコア。志免町・新宮町・須恵町の個別制度ページ不足を補うため制度カテゴリ導線からfocused link scan 495件（久山町89件、志免町110件、篠栗町203件、新宮町54件、須恵町39件）を追加
- 採用: 96件（篠栗町20件、志免町22件、須恵町14件、新宮町17件、久山町23件）
- 公式URL: 採用URL到達確認は tasks/discovery/fukuoka-official-coverage-007-url-status.txt に記録（96本すべてHTTP 200、build non200空）
- 保留: 小規模町はカテゴリ配下に制度ページが散在するため、個別HTML制度ページを優先し、制度本文を含む公式掲載ページを必要最小限採用。トップ、カテゴリのみ、部署、共通ナビ、計画・実績公表、受付終了のみの旧給付金、外部制度のみ、注意喚起のみ、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check はpass。audit:coverage は作業ツリー上の未関係 `src/lib/grant-copy.ts` / `src/lib/grants.ts` 変更により `sanitizeGrantCopy` の `tags.map` で停止したため未通過（福岡007対象ファイル自体の構文・JSON・URL・重複・eslint・diff checkは通過）
- 15自治体単位メトリクス: 福岡県005-007累計は15自治体277制度、監査3回試行。福岡県007のshortlist採用率は96/(230+495)。audit失敗は未関係作業ツリー要因として次回以降に再実行対象
- 到達点: 福岡県は40100北九州市から40348久山町まで第1巡到達。全国公式棚卸しは未完了
- 次回: 福岡県公式棚卸し008として、40349粕屋町から再開（想定対象は40349粕屋町・40381芦屋町・40382水巻町・40383岡垣町・40384遠賀町）

### 福岡県公式棚卸し008（40349粕屋町・40381芦屋町・40382水巻町・40383岡垣町・40384遠賀町）
- 実施日: 2026-07-17
- 候補: 標準discoverは0件。公式トップ5自治体200到達。公式カテゴリ/サイト内リンクBFSを上限280件で再スコアし、候補240件（芦屋町54件、遠賀町61件、岡垣町1件、水巻町37件、粕屋町87件）を抽出。候補過多のため詳細スニペット240件・shortlist240件を生成し、岡垣町の公式カテゴリ導線不足をfocused link scan 605件（芦屋町196件、遠賀町10件、岡垣町134件、水巻町187件、粕屋町78件）で補完
- 採用: 95件（粕屋町20件、芦屋町23件、水巻町24件、岡垣町18件、遠賀町10件）
- 公式URL: 採用URL到達確認は tasks/discovery/fukuoka-official-coverage-008-url-status.txt に記録（95本すべてHTTP 200、build non200空）
- 保留: 遠賀町は候補数が少ないため制度性のある公式掲載ページを最小限採用。小規模町はカテゴリ配下に制度ページが散在するため、個別HTML制度ページを優先し、制度本文を含む公式掲載ページを必要最小限採用。トップ、カテゴリのみ、部署、共通ナビ、計画・実績公表、受付終了のみの旧給付金、外部制度のみ、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check はpass。audit:coverage は作業ツリー上の未関係 `src/lib/grant-copy.ts` / `src/lib/grants.ts` 変更により `sanitizeGrantCopy` の `tags.map` で停止したため未通過（福岡008対象ファイル自体の構文・JSON・URL・重複・eslint・diff checkは通過）
- 15自治体単位メトリクス: 福岡県006-008累計は15自治体289制度、監査3回試行。福岡県008のshortlist採用率は95/(240+605)。audit失敗は未関係作業ツリー要因として次回以降に再実行対象
- 到達点: 福岡県は40100北九州市から40384遠賀町まで第1巡到達。福岡県001-008累計は40自治体641制度。全国公式棚卸しは未完了
- 次回: 福岡県公式棚卸し009として、40401小竹町から再開（想定対象は40401小竹町・40402鞍手町・40421桂川町・40447筑前町・40448東峰村）

### 福岡県公式棚卸し009（40401小竹町・40402鞍手町・40421桂川町・40447筑前町・40448東峰村）
- 実施日: 2026-07-17
- 候補: 標準discoverは0件。公式トップ5自治体200到達。通常再スコアは小竹町100/280時点で長時間化したため停止し、制度語リンクを並列取得するfocused link scanへ切替。focused link scan 341件（鞍手町146件、桂川町153件、小竹町26件、筑前町13件、東峰村3件）を抽出し、筑前町・東峰村は公式カテゴリ導線を追加確認して制度ページを補完
- 採用: 92件（小竹町12件、鞍手町28件、桂川町26件、筑前町16件、東峰村10件）
- 公式URL: 採用URL到達確認は tasks/discovery/fukuoka-official-coverage-009-url-status.txt に記録（92本すべてHTTP 200、build non200空）
- 保留: 東峰村は公式行政サイトと移住・定住サイトの双方に制度ページが分散するため、公式ドメイン配下の制度本文ページを採用。筑前町はカテゴリ配下に個別制度ページがまとまっていたため追加カテゴリ確認で補完。トップ、カテゴリのみ、部署、共通ナビ、計画・実績公表、受付終了のみの旧給付金、外部制度のみ、物件個票、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint はpass。audit:coverage は作業ツリー上の未関係 `src/lib/grant-copy.ts` / `src/lib/grants.ts` 変更により `sanitizeGrantCopy` の `tags.map` で停止したため未通過（福岡009対象ファイル自体の構文・JSON・URL・重複・eslint・diff checkは通過）
- 15自治体単位メトリクス: 福岡県007-009累計は15自治体283制度、監査3回試行。福岡県009のshortlist採用率は92/341（追加カテゴリ確認で補完した筑前町・東峰村の採用を含む）。audit失敗は未関係作業ツリー要因として次回以降に再実行対象
- 到達点: 福岡県は40100北九州市から40448東峰村まで第1巡到達。福岡県001-009累計は45自治体733制度。全国公式棚卸しは未完了
- 次回: 福岡県公式棚卸し010として、40503大刀洗町から再開（想定対象は40503大刀洗町・40522大木町・40544広川町・40601香春町・40602添田町）

### 福岡県公式棚卸し010（40503大刀洗町・40522大木町・40544広川町・40601香春町・40602添田町）
- 実施日: 2026-07-17
- 候補: 標準discoverは0件。公式トップ5自治体200到達。制度語リンクを並列取得するfocused link scan 853件（広川町106件、香春町8件、大刀洗町314件、大木町65件、添田町360件）を抽出。大刀洗町・大木町・香春町は公式カテゴリ導線を追加確認し、CMSの空title候補と不足カテゴリから個別制度ページを補完
- 採用: 88件（大刀洗町16件、大木町14件、広川町22件、香春町22件、添田町14件）
- 公式URL: 採用URL到達確認は tasks/discovery/fukuoka-official-coverage-010-url-status.txt に記録（88本すべてHTTP 200、build non200空）
- 保留: 大刀洗町はCMS共通ナビ一致が多いため、個別HTML制度ページを優先し、受付終了のみの旧給付金は除外。大木町は子育て・医療・福祉カテゴリ内の個別制度ページを補完。香春町は手当・助成・補助金、移住・定住、商工業、高齢者福祉カテゴリから制度本文ページを採用。トップ、カテゴリのみ、問い合わせ、イベント告知、外部制度のみ、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check はpass。audit:coverage は作業ツリー上の未関係 `src/lib/grant-copy.ts` / `src/lib/grants.ts` 変更により `sanitizeGrantCopy` の `tags.map` で停止したため未通過（福岡010対象ファイル自体の構文・JSON・URL・重複・eslint・diff checkは通過）
- 15自治体単位メトリクス: 福岡県008-010累計は15自治体275制度、監査3回試行。福岡県010のshortlist採用率は88/853（追加カテゴリ確認で補完した大刀洗町・大木町・香春町の採用を含む）。audit失敗は未関係作業ツリー要因として次回以降に再実行対象
- 到達点: 福岡県は40100北九州市から40602添田町まで第1巡到達。福岡県001-010累計は50自治体821制度。全国公式棚卸しは未完了
- 次回: 福岡県公式棚卸し011として、40604糸田町から再開（想定対象は40604糸田町・40605川崎町・40608大任町・40609赤村・40610福智町）

### 福岡県公式棚卸し011（40604糸田町・40605川崎町・40608大任町・40609赤村・40610福智町）
- 実施日: 2026-07-17
- 候補: 標準discoverは0件。公式トップ5自治体200到達（糸田町は通常curl 403のため公式UA付きで200確認）。糸田町・大任町・赤村・福智町は公式カテゴリ導線からtargeted/focused link scan 209件（糸田町90件、赤村14件、大任町52件、福智町53件）を抽出。川崎町は公式カテゴリ・検索導線から個別制度ページを補完
- 採用: 97件（糸田町25件、川崎町35件、大任町10件、赤村6件、福智町21件）
- 公式URL: 採用URL到達確認は tasks/discovery/fukuoka-official-coverage-011-url-status.txt に記録（97本すべてHTTP 200、build non200空）
- 保留: 赤村は公式PDF中心の制度導線のため、到達できる制度PDFと公式ニュースのみ採用。大任町は個別制度ページが少ないため、子育て・医療・空き家の制度本文ページを最小限採用。トップ、カテゴリのみ、検索、部署、共通ナビ、申請様式のみ、計画、実績公表、職員募集、外部制度のみ、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check はpass。audit:coverage は作業ツリー上の未関係 `src/lib/grant-copy.ts` / `src/lib/grants.ts` 変更により `sanitizeGrantCopy` の `tags.map` で停止したため未通過（福岡011対象ファイル自体の構文・JSON・URL・重複・eslint・diff checkは通過）
- 15自治体単位メトリクス: 福岡県009-011累計は15自治体277制度、監査3回試行、commit予定3回。福岡県011のshortlist採用率は97/(209+川崎町公式カテゴリ補完35)。audit失敗は未関係作業ツリー要因として次回以降に再実行対象
- 到達点: 福岡県は40100北九州市から40610福智町まで第1巡到達。福岡県001-011累計は55自治体918制度。全国公式棚卸しは未完了
- 次回: 福岡県公式棚卸し012として、40621苅田町から再開（想定対象は40621苅田町・40625みやこ町・40642吉富町・40646上毛町・40647築上町）

### 福岡県公式棚卸し012（40621苅田町・40625みやこ町・40642吉富町・40646上毛町・40647築上町）
- 実施日: 2026-07-17
- 候補: 標準discoverは0件。公式トップ5自治体200到達。公式トップ・補助助成一覧・子育て/医療/福祉/住宅/移住/産業カテゴリ導線からtargeted/focused link scan 833件（みやこ町244件、苅田町151件、吉富町147件、上毛町151件、築上町140件）を抽出。shortlistが150件超のためローカル本文スニペット再スコアで498件へ圧縮し、個別制度ページ100件を採用
- 採用: 100件（苅田町21件、みやこ町23件、吉富町11件、上毛町23件、築上町22件）
- 公式URL: 採用URL到達確認は tasks/discovery/fukuoka-official-coverage-012-url-status.txt に記録（100本すべてHTTP 200、build non200空）
- 保留: 吉富町は制度ページが子育て・移住定住カテゴリに偏るため、公式本文で制度条件が確認できるものを採用。みやこ町はカテゴリ重複と外部制度告知が多いため町公式制度ページを優先。トップ、カテゴリのみ、検索、共通ナビ、コラム、物件個票、申請書のみ、計画・実績公表、プロポーザル、古い接種予約告知、外部制度のみ、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check はpass。audit:coverage は作業ツリー上の未関係 `src/lib/grant-copy.ts` / `src/lib/grants.ts` 変更により `sanitizeGrantCopy` の `tags.map` で停止したため未通過（福岡012対象ファイル自体の構文・JSON・URL・重複・eslint・diff checkは通過）
- 15自治体単位メトリクス: 福岡県010-012累計は15自治体285制度、監査3回試行、commit予定3回。福岡県012のshortlist採用率は100/498（focused母数比は100/833）
- 到達点: 福岡県は40100北九州市から40647築上町まで全60市区町村の第1巡に到達。福岡県001-012累計は1018制度。全国公式棚卸しは未完了
- 次回: 佐賀県公式棚卸し001として、41201佐賀市から再開（想定対象は41201佐賀市・41202唐津市・41203鳥栖市・41204多久市・41205伊万里市）

### 佐賀県公式棚卸し001（41201佐賀市・41202唐津市・41203鳥栖市・41204多久市・41205伊万里市）
- 実施日: 2026-07-17
- 候補: 標準discoverは0件。公式トップ5自治体200到達。公式トップ・子育て/医療/福祉/住宅/移住/産業カテゴリ導線からtargeted/focused link scan 1003件（佐賀市240件、唐津市221件、鳥栖市196件、多久市138件、伊万里市208件）を抽出。shortlistが150件超のためローカル本文スニペット再スコアで487件へ圧縮し、個別制度ページ100件を採用
- 採用: 100件（佐賀市12件、唐津市24件、鳥栖市20件、多久市22件、伊万里市22件）
- 公式URL: 採用URL到達確認は tasks/discovery/saga-official-coverage-001-url-status.txt に記録（100本すべてHTTP 200、build non200空）
- 保留: 佐賀市は移住・子育て・福祉カテゴリの制度ページを優先。唐津市は子育て・福祉制度と景観/固定電話機補助を採用。鳥栖市は電子申請告知のみや受付停止のみの候補を除外し、個別制度ページを優先。多久市・伊万里市は太陽光、住宅、医療、福祉、教育、事業者支援の公式本文ページを採用。トップ、カテゴリのみ、検索、共通ナビ、FAQ、旧告知、受付終了のみ、外部制度のみ、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check はpass。audit:coverage は作業ツリー上の未関係 `src/lib/grant-copy.ts` / `src/lib/grants.ts` 変更により `sanitizeGrantCopy` の `tags.map` で停止したため未通過（佐賀001対象ファイル自体の構文・JSON・URL・重複・eslint・diff checkは通過）
- 15自治体単位メトリクス: 佐賀県001は5自治体100制度、監査1回試行、commit予定1回。佐賀県001のshortlist採用率は100/487（focused母数比は100/1003）。佐賀県は次の10自治体で15自治体単位の実測を継続する
- 到達点: 佐賀県は41201佐賀市から41205伊万里市まで第1巡到達。佐賀県001累計は5自治体100制度。全国公式棚卸しは未完了
- 次回: 佐賀県公式棚卸し002として、41206武雄市から再開（想定対象は41206武雄市・41207鹿島市・41208小城市・41209嬉野市・41210神埼市）

### 佐賀県公式棚卸し002（41206武雄市・41207鹿島市・41208小城市・41209嬉野市・41210神埼市）
- 実施日: 2026-07-17
- 候補: 標準discoverは0件。公式トップ5自治体200到達。公式トップ・子育て/医療/福祉/住宅/移住/産業カテゴリ導線からfocused scan 1300件（武雄市260件、鹿島市260件、小城市260件、嬉野市260件、神埼市260件）を抽出。shortlist 377件（武雄市81件、鹿島市51件、小城市59件、嬉野市153件、神埼市33件）へ圧縮。鹿島市・神埼市は公式サイトマップ/組織カテゴリ導線から個別制度ページを補完し、100件を採用
- 採用: 100件（武雄市25件、鹿島市20件、小城市20件、嬉野市20件、神埼市15件）
- 公式URL: 採用URL到達確認は tasks/discovery/saga-official-coverage-002-url-status.txt に記録（100本すべてHTTP 200、build non200空）
- 保留: 武雄市・小城市・嬉野市は子育て、医療、住宅、移住、就農、事業者支援の個別制度ページを優先。鹿島市は公式くらしのガイド/組織カテゴリから医療費助成、住居確保給付、環境補助、空き家補助を補完。神埼市は公式サイトマップから太陽光・省エネ・住宅・移住・空き家・子育て制度を補完。トップ、カテゴリのみ、検索、共通ナビ、FAQ、計画、実績、旧告知、受付終了のみ、外部制度のみ、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check はpass。audit:coverage は作業ツリー上の未関係 `src/lib/grant-copy.ts` / `src/lib/grants.ts` 変更により `sanitizeGrantCopy` の `tags.map` で停止したため未通過（佐賀002対象ファイル自体の構文・JSON・URL・重複・eslint・diff checkは通過）
- 15自治体単位メトリクス: 佐賀県001-002累計は10自治体200制度、監査2回試行、commit予定2回。佐賀県002のshortlist採用率は100/377（focused母数比は100/1300）。佐賀県003で15自治体単位の実測を継続する
- 到達点: 佐賀県は41201佐賀市から41210神埼市まで第1巡到達。佐賀県001-002累計は10自治体200制度。全国公式棚卸しは未完了
- 次回: 佐賀県公式棚卸し003として、41327吉野ヶ里町から再開（想定対象は41327吉野ヶ里町・41341基山町・41345上峰町・41346みやき町・41387玄海町）

### 佐賀県公式棚卸し003（41327吉野ヶ里町・41341基山町・41345上峰町・41346みやき町・41387玄海町）
- 実施日: 2026-07-17
- 候補: 標準discoverは0件。公式トップ5自治体200到達。公式トップ・子育て/医療/福祉/住宅/移住/産業カテゴリ導線からfocused scan 1049件（吉野ヶ里町260件、基山町260件、上峰町9件、みやき町260件、玄海町260件）を抽出。shortlist 317件（吉野ヶ里町32件、基山町50件、上峰町8件、みやき町169件、玄海町58件）へ圧縮。吉野ヶ里町・玄海町・上峰町は公式カテゴリ/個別制度導線から制度ページを補完し、84件を採用
- 採用: 84件（吉野ヶ里町13件、基山町14件、上峰町14件、みやき町24件、玄海町19件）
- 公式URL: 採用URL到達確認は tasks/discovery/saga-official-coverage-003-url-status.txt に記録（84本すべてHTTP 200、build non200空）
- 保留: 吉野ヶ里町は子育て・医療費・学校給食費・低所得者支援・移住/空家導線を補完。基山町は妊婦健診、医療費、ひとり親、産後ケア、保育、移住導線を採用。上峰町は給付金、結婚新生活、医療費、妊婦支援、子育て、医療・福祉助成を補完。みやき町は福祉、医療、子育て、物価高騰給付、住宅・文化スポーツ助成を採用。玄海町は子育て、教育、まちづくり、空き家、定住、障がい福祉、医療費助成を採用。トップ、カテゴリのみ、検索、共通ナビ、FAQ、計画、実績、旧告知、受付終了のみ、外部制度のみ、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check はpass。audit:coverage は作業ツリー上の未関係 `src/lib/grant-copy.ts` / `src/lib/grants.ts` 変更により `sanitizeGrantCopy` の `tags.map` で停止したため未通過（佐賀003対象ファイル自体の構文・JSON・URL・重複・eslint・diff checkは通過）
- 15自治体単位メトリクス: 佐賀県001-003累計は15自治体284制度、監査3回試行、commit予定3回。佐賀県003のshortlist採用率は84/317（focused母数比は84/1049）。直近15自治体の概算速度は自動ハートビート再開をまたぐため厳密な実働時間は未計測だが、次の15自治体では自治体/時・制度/時・compaction数・shortlist採用率・監査回数・commit数を継続記録する
- 到達点: 佐賀県は41201佐賀市から41387玄海町まで第1巡到達。佐賀県001-003累計は15自治体284制度。全国公式棚卸しは未完了
- 次回: 佐賀県公式棚卸し004として、41401有田町から再開（想定対象は41401有田町・41423大町町・41424江北町・41425白石町・41441太良町）

### 佐賀県公式棚卸し004（41401有田町・41423大町町・41424江北町・41425白石町・41441太良町）
- 実施日: 2026-07-17
- 候補: 標準discoverは0件。公式トップ5自治体200到達。公式トップ・子育て/医療/福祉/住宅/移住/産業カテゴリ導線からfocused scan 1042件（有田町260件、大町町260件、江北町2件、白石町260件、太良町260件）を抽出。shortlist 688件（有田町112件、大町町229件、江北町2件、白石町136件、太良町209件）へ圧縮。江北町は公式トップ/生活分類導線から個別制度ページを補完し、80件を採用
- 採用: 80件（有田町18件、大町町14件、江北町14件、白石町17件、太良町17件）
- 公式URL: 採用URL到達確認は tasks/discovery/saga-official-coverage-004-url-status.txt に記録（80本すべてHTTP 200、build non200空）
- 保留: 有田町は出産・不妊・医療費・児童手当・就学/奨学制度を採用。大町町は子ども新生活応援金、在宅保育、定住奨励、給食費無償、妊産婦タクシー、不妊治療、子ども医療、出生祝金を採用。江北町は国保/年金給付、保険料免除、不妊治療、育英資金、フリースクール奨学金、英検補助、省エネ・太陽光補助を補完。白石町は子ども医療、物価高子育て応援、ひとり親、母子父子貸付、妊婦支援、骨髄ドナー、障がい福祉、結婚/移住/住宅支援を採用。太良町は高齢者エアコン、誕生祝金、町税減免、移住定住、民間賃貸住宅、予防接種、骨髄ドナー、アピアランスケア、結婚祝金を採用。トップ、カテゴリのみ、検索、共通ナビ、FAQ、計画、実績、旧告知、受付終了のみ、外部制度のみ、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check はpass。audit:coverage は作業ツリー上の未関係 `src/lib/grant-copy.ts` / `src/lib/grants.ts` 変更により `sanitizeGrantCopy` の `tags.map` で停止したため未通過（佐賀004対象ファイル自体の構文・JSON・URL・重複・eslint・diff checkは通過）
- 15自治体単位メトリクス: 佐賀県004単体は5自治体80制度、監査1回試行、commit予定1回。佐賀県004のshortlist採用率は80/688（focused母数比は80/1042）。佐賀県001-004累計は20自治体364制度、commit予定4回。次の15自治体単位は長崎県001から継続記録する
- 到達点: 佐賀県は41201佐賀市から41441太良町まで第1巡完了。佐賀県001-004累計は20自治体364制度。全国公式棚卸しは未完了
- 次回: 長崎県公式棚卸し001として、42201長崎市から再開（想定対象は42201長崎市・42202佐世保市・42203島原市・42204諫早市・42205大村市）

### 長崎県公式棚卸し001（42201長崎市・42202佐世保市・42203島原市・42204諫早市・42205大村市）
- 実施日: 2026-07-17
- 候補: 標準discoverは0件。公式トップ5自治体200到達。公式トップ・子育て/医療/福祉/住宅/移住/産業カテゴリ導線からfocused scan 1344件（長崎市300件、佐世保市300件、島原市144件、諫早市300件、大村市300件）を抽出。shortlist 533件（長崎市87件、佐世保市134件、島原市28件、諫早市130件、大村市154件）へ圧縮。shortlist過多のためローカルTSV/JSONで制度強語、金額・対象・受付表現、個別ページ性を再スコアリング。長崎市・島原市・諫早市は公式カテゴリ配下の個別制度ページを補完し、83件を採用
- 採用: 83件（長崎市18件、佐世保市18件、島原市8件、諫早市19件、大村市20件）
- 公式URL: 採用URL到達確認は tasks/discovery/nagasaki-official-coverage-001-url-status.txt に記録（83本すべてHTTP 200、build non200空）
- 保留: 長崎市は住宅、医療、障がい福祉、脱炭素、下水道助成を採用。佐世保市は離島出産、福祉医療、保育料、ひとり親、子育て、母子父子貸付、若者活動補助を採用。島原市は臨時給付、自主防災、お見合い登録、3世代ファミリー、移住支援金、保育料、予防接種を補完。諫早市は移住支援、給付金、文化奨励、自立支援医療、妊婦・不妊、住宅、奨学制度を採用。大村市は年金免除、児童手当、障がい福祉、医療、妊婦、不妊、家電、省エネ、予防接種を採用。トップ、カテゴリのみ、検索、共通ナビ、FAQ、計画、実績、外部制度のみ、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check はpass。audit:coverage は作業ツリー上の未関係 `src/lib/grant-copy.ts` / `src/lib/grants.ts` 変更により `sanitizeGrantCopy` の `tags.map` で停止したため未通過（長崎001対象ファイル自体の構文・JSON・URL・重複・eslint・diff checkは通過）
- 15自治体単位メトリクス: 長崎県001単体は5自治体83制度、監査1回予定、commit予定1回。長崎県001のshortlist採用率は83/533（focused母数比は83/1344）。長崎県001-003で次の15自治体単位の実測を継続する
- 到達点: 長崎県は42201長崎市から42205大村市まで第1巡到達。長崎県001累計は5自治体83制度。全国公式棚卸しは未完了
- 次回: 長崎県公式棚卸し002として、42207平戸市から再開（想定対象は42207平戸市・42208松浦市・42209対馬市・42210壱岐市・42211五島市）

### 長崎県公式棚卸し002（42207平戸市・42208松浦市・42209対馬市・42210壱岐市・42211五島市）
- 実施日: 2026-07-17
- 候補: 標準discoverは0件。公式トップ5自治体到達。通常curl/fetchで一部Akamai系CDNがAccess Deniedを返したため、既存focused scan 548件（平戸市300件、松浦市61件、五島市187件）に加え、Chrome channel browserで公式カテゴリ・移住/子育て/医療/福祉/住宅/産業導線を再取得し188件（平戸市62件、松浦市33件、対馬市9件、壱岐市30件、五島市54件）を抽出。個別制度ページ97件を採用
- 採用: 97件（平戸市25件、松浦市17件、対馬市4件、壱岐市15件、五島市36件）
- 公式URL: 採用URL到達確認は tasks/discovery/nagasaki-official-coverage-002-url-status.txt に記録（97本すべてHTTP 200、build non200空）。対馬市・壱岐市を含むCDN拒否ページはChrome channel browserで公式本文を確認し、公式トップ到達だけでは完了扱いにしていない
- 保留: 平戸市は子育て医療、ひとり親、妊娠出産、高齢者・障がい福祉、移住定住、スポーツ補助を採用。松浦市は妊婦支援、不妊、子育て、障がい福祉、事業者・雇用、住宅/定住支援を採用。対馬市は移住定住、下見、空き家改修、定住支援住宅を採用。壱岐市は補助金一覧、子育て、介護用品、福祉医療、奨学制度を採用。五島市は子育て、福祉医療、不妊、障がい福祉、高齢者介護、介護人材、環境、奨学、住宅/浄化槽補助を採用。トップ、カテゴリのみ、相談窓口、検索、共通ナビ、計画、実績、外部制度のみ、本文根拠が薄い候補は第2巡候補として保持
- 検証: node --check、JSON.parse、slug重複、URL到達、eslint、git diff --check はpass。audit:coverage は作業ツリー上の未関係 `src/lib/grant-copy.ts` / `src/lib/grants.ts` 変更により `sanitizeGrantCopy` の `tags.map` で停止したため未通過（長崎002対象ファイル自体の構文・JSON・URL・重複・eslint・diff checkは通過）
- 15自治体単位メトリクス: 長崎県001-002累計は10自治体180制度、監査2回予定、commit予定2回。長崎県002の採用率は97/188（browser再取得母数比、focused母数比は97/548）。長崎県003で15自治体単位の実測を継続する
- 到達点: 長崎県は42201長崎市から42211五島市まで第1巡到達。長崎県001-002累計は10自治体180制度。全国公式棚卸しは未完了
- 次回: 長崎県公式棚卸し003として、42212西海市から再開（想定対象は42212西海市・42213雲仙市・42214南島原市・42307長与町・42308時津町）

### 長崎県公式棚卸し003（42212西海市・42213雲仙市・42214南島原市・42307長与町・42308時津町）
- 対象: 42212西海市、42213雲仙市、42214南島原市、42307長与町、42308時津町
- 公式トップ到達: 西海市・雲仙市・南島原市・長与町・時津町の公式トップを確認。長与町は `https://webtown.nagayo.jp/` を公式URLとして使用
- 収集: 標準discoverは0件。focused scanは1092件（西海市300、雲仙市300、南島原市24、長与町168、時津町300）、shortlist 382件。rescored 211件、browser公式取得33件を併用
- 採用: 67制度（西海市11、雲仙市37、長与町5、時津町14）。制度名・対象・支援内容・申請/受付表現を公式本文または公式取得キャッシュで確認し、`nagasaki-official-003-001-2026` から `nagasaki-official-003-067-2026` として追加
- 南島原市: 公式トップ、カテゴリ、サイトマップ、PDF断片はHTTP 200で取得したが、制度名・対象・金額/上限・条件・期限/受付が揃う個別制度ページまで到達しなかったため、削除せず第2巡候補として保持。トップ/カテゴリ到達のみで完了扱いにしていない
- 公式URL: build non200空。採用67本は focused/browser cache または build fetch でHTTP 200確認
- 検証: node --check、JSON parse、slug重複、eslint、diff check は通過。audit:coverage は既存の対象外 dirty 変更（src/lib/grant-copy.ts / src/lib/grants.ts）により sanitizeGrantCopy の tags.map で失敗し、coverage 集計前に停止
- 15自治体単位メトリクス: 長崎県001-003累計は15自治体247制度。長崎県003の採用率は67/382（shortlist比）、67/1092（focused母数比）。監査1回予定、commit予定1回
- 到達点: 長崎県は42201長崎市から42308時津町まで第1巡到達。全国公式棚卸しは未完了
- 次回: 長崎県公式棚卸し004として、42321東彼杵町から再開（想定対象は42321東彼杵町・42322川棚町・42323波佐見町・42383小値賀町・42391佐々町）


### 長崎県公式棚卸し004（42321東彼杵町・42322川棚町・42323波佐見町・42383小値賀町・42391佐々町）
- 対象: 42321東彼杵町、42322川棚町、42323波佐見町、42383小値賀町、42391佐々町
- 公式トップ到達: 東彼杵町、川棚町、波佐見町、小値賀町、佐々町の公式トップをHTTP 200で確認。小値賀町は `https://www.town.ojika.lg.jp/`、佐々町は `https://www.sazacho-nagasaki.jp/` を公式URLとして使用
- 収集: 標準discoverは0件。focused scanは670件（東彼杵町300、川棚町66、波佐見町2、小値賀町300、佐々町2）、shortlist 164件。rescored 119件から制度強語・金額/対象/受付表現が揃う個別ページを優先
- 採用: 60制度（東彼杵町35、川棚町5、小値賀町20）。`nagasaki-official-004-001-2026` から `nagasaki-official-004-060-2026` として追加
- 波佐見町・佐々町: 公式トップ/サイトマップまでは到達したが、制度名・対象・金額/上限・条件・期限/受付が揃う個別制度ページまで到達しなかったため、削除せず第2巡候補として保持。トップ/カテゴリ到達のみで完了扱いにしていない
- 公式URL: build non200空。採用60本は focused cache または build fetch でHTTP 200確認
- 検証: node --check、JSON parse、slug重複、eslint、diff check は通過。audit:coverage は既存の対象外 dirty 変更（src/lib/grant-copy.ts / src/lib/grants.ts）により sanitizeGrantCopy の tags.map で失敗し、coverage 集計前に停止
...
### 熊本県公式棚卸し001（43100熊本市・43202八代市・43203人吉市・43204荒尾市・43205水俣市）
- 対象: 43100熊本市、43202八代市、43203人吉市、43204荒尾市、43205水俣市
- 公式トップ到達: 熊本市、八代市、人吉市、荒尾市、水俣市の公式トップを確認。熊本市・八代市・水俣市は既存公式確認済みURLを再確認し、人吉市・荒尾市は公式検索/カテゴリ導線から個別制度ページを抽出
- 収集: 標準discoverは0件。search-scanは88候補（熊本市3、荒尾市14、人吉市65、水俣市6）を抽出。熊本市・八代市・水俣市は既存公式確認済みURL32件を補完し、個別制度ページ65件を採用
- 採用: 65制度（熊本市19、八代市11、人吉市30、荒尾市4、水俣市1）。`kumamoto-official-001-001-2026` から `kumamoto-official-001-065-2026` として追加
- 保留: 熊本市検索スキャンのアクセス、窓口時間、ホームページ案内、荒尾市の入札、最低賃金、イベント、住まいカテゴリ、動物・ペット、人吉市の補助金一覧カテゴリや相談会・空き家バンク一覧等は、トップ/カテゴリ/一般案内一致として第2巡候補に保持。八代市は公式確認済み個別制度URLを優先し、検索結果不足のみで完了扱いにしていない
- 公式URL: 採用65本は build fetch でHTTP 200確認。到達確認は `tasks/discovery/kumamoto-official-coverage-001-url-status.txt` に記録し、build non200は空
- 検証: node --check、JSON parse、slug重複、URL到達、eslint は通過。audit:coverage は既存の対象外 dirty 変更（src/lib/grant-copy.ts / src/lib/grants.ts）により sanitizeGrantCopy の tags.map で失敗する既知ブロックを継続確認する
- 15自治体単位メトリクス: 熊本県001単体は5自治体65制度。search-scan採用率は33/88（人吉市・荒尾市・水俣市の検索候補比、既存公式確認URL補完を除く）、総採用は65制度。監査1回予定、commit予定1回。次の10自治体で15自治体単位の速度・採用率を継続記録する
- 到達点: 熊本県は43100熊本市から43205水俣市まで第1巡到達。全国公式棚卸しは未完了
- 次回: 熊本県公式棚卸し002として、43206玉名市から再開（想定対象は43206玉名市・43208山鹿市・43210菊池市・43211宇土市・43212上天草市）

### 熊本県公式棚卸し002（43206玉名市・43208山鹿市・43210菊池市・43211宇土市・43212上天草市）
- 対象: 43206玉名市、43208山鹿市、43210菊池市、43211宇土市、43212上天草市
- 公式トップ到達: 玉名市、山鹿市、菊池市、宇土市、上天草市の公式トップをHTTP 200で確認。玉名市・上天草市はEUC-JPページを文字コード指定で再取得し、文字化けを解消して本文確認
- 収集: 標準discoverは0件。search-scanは56候補（山鹿市56）を抽出。focused scanは19候補（上天草市7、山鹿市4、玉名市7、菊池市1）を抽出。宇土市は公式キーワードページ、菊池市は公式カテゴリ配下、上天草市は補助・助成カテゴリと水産/雇用カテゴリを入口に個別制度ページを確認
- 採用: 49制度（玉名市1、山鹿市2、菊池市25、宇土市14、上天草市7）。`kumamoto-official-002-001-2026` から `kumamoto-official-002-049-2026` として追加
- 保留: 玉名市の公役・スポーツ大会補助関連、宇土市の物価高騰交付金概要、山鹿市のカテゴリ/ナビ一致ページ、菊池市・上天草市のカテゴリ一覧や一般案内は、トップ/カテゴリ/概要一致として第2巡候補に保持。既存raw gap 0やカテゴリ到達のみでは完了扱いにしていない
- 公式URL: build non200空。採用49本は build fetch でHTTP 200確認。宇土市の就学援助制度は404旧URLを公式現行URLへ差し替え済み
- 検証: node --check、JSON parse、slug重複、URL到達、eslint、diff check は通過。URL到達確認は `tasks/discovery/kumamoto-official-coverage-002-url-status.txt` に保存。audit:coverage は既存の対象外 dirty 変更（src/lib/grant-copy.ts / src/lib/grants.ts）により sanitizeGrantCopy の tags.map でcoverage集計前に失敗する既知ブロックを継続確認
- 15自治体単位メトリクス: 熊本県002単体は5自治体49制度。熊本県001-002累計は10自治体114制度。採用率は49/49（選定比）、49/75（search/focused候補合計比、宇土市・菊池市カテゴリ手動確認を除く）。監査1回、commit予定1回。次の5自治体で15自治体単位の速度・採用率を集計する
- 到達点: 熊本県は43100熊本市から43212上天草市まで第1巡到達。全国公式棚卸しは未完了
- 次回: 熊本県公式棚卸し003として、43213宇城市から再開（想定対象は43213宇城市・43214阿蘇市・43215天草市・43216合志市・43348美里町）

### 熊本県公式棚卸し003（43213宇城市・43214阿蘇市・43215天草市・43216合志市・43348美里町）
- 対象: 43213宇城市、43214阿蘇市、43215天草市、43216合志市、43348美里町
- 公式トップ到達: 宇城市、阿蘇市、天草市、合志市、美里町の公式トップをHTTP 200で確認。宇城市・阿蘇市・美里町はsitemapを併用し、天草市・合志市は公式カテゴリ/検索リストから個別 `kiji` ページを抽出
- 収集: 公式sitemap/検索/カテゴリBFSで314候補（宇城市84、阿蘇市37、天草市124、合志市7、美里町62）を抽出。shortlistが150件超のためローカルJSON/TSVに本文スニペットを保存し、制度強語・金額/対象/受付表現・個別URLを再スコアして採用候補を絞り込み
- 採用: 72制度（宇城市12、阿蘇市20、天草市20、合志市10、美里町10）。`kumamoto-official-003-001-2026` から `kumamoto-official-003-072-2026` として追加
- 保留: 天草市・合志市の補助金カテゴリ一覧、各自治体のカテゴリ/検索結果/広報/採用/イベント/一般案内、阿蘇市の介護事業者届出・相談案内等は第2巡候補として保持。トップ/カテゴリ到達のみでは完了扱いにしていない
- 公式URL: build non200空。採用72本は build fetch でHTTP 200確認し、最終URL到達確認も全件2xxで `tasks/discovery/kumamoto-official-coverage-003-url-status.txt` に保存
- 検証: node --check、JSON parse、slug重複、URL到達、eslint、diff check は通過。audit:coverage は既存の対象外 dirty 変更（src/lib/grant-copy.ts / src/lib/grants.ts）により sanitizeGrantCopy の tags.map で失敗する既知ブロックを継続確認
- 15自治体単位メトリクス: 熊本県003単体は5自治体72制度。熊本県001-003累計は15自治体186制度。熊本県003の採用率は72/314（一次候補比）、72/72（選定比）。監査1回予定、commit予定1回。次回から次の15自治体単位の速度・採用率を開始する
- 到達点: 熊本県は43100熊本市から43348美里町まで第1巡到達。全国公式棚卸しは未完了
- 次回: 熊本県公式棚卸し004として、43364玉東町から再開（想定対象は43364玉東町・43367南関町・43368長洲町・43369和水町・43403大津町）

### 熊本県公式棚卸し004（43364玉東町・43367南関町・43368長洲町・43369和水町・43403大津町）
- 対象: 43364玉東町、43367南関町、43368長洲町、43369和水町、43403大津町
- 公式トップ到達: 玉東町、南関町、長洲町、和水町、大津町の公式トップをHTTP 200で確認。5町ともsitemap.xmlは404のため、公式カテゴリ・公式検索・公式一覧導線から個別ページを抽出
- 収集: 公式カテゴリ/検索BFSで592候補（玉東町52、南関町283、長洲町50、和水町102、大津町105）を抽出。shortlistが150件超のためローカルJSON/TSVに本文スニペットを保存し、制度強語・金額/対象/受付表現・個別URLを再スコアして採用候補を絞り込み
- 採用: 80制度（玉東町9、南関町24、長洲町11、和水町18、大津町18）。`kumamoto-official-004-001-2026` から `kumamoto-official-004-080-2026` として追加
- 保留: RSS、一覧/カテゴリ、広報、採用、公募、イベント、一般案内、本文に「只今情報はございません」とある旧制度ページは第2巡候補として保持。トップ/カテゴリ到達のみでは完了扱いにしていない
- 公式URL: build non200空。採用80本は build fetch でHTTP 200確認し、最終URL到達確認も全件2xxで `tasks/discovery/kumamoto-official-coverage-004-url-status.txt` に保存
- 検証: node --check、JSON parse、slug重複、URL到達、eslint、diff check は通過。audit:coverage は既存の対象外 dirty 変更（src/lib/grant-copy.ts / src/lib/grants.ts）により sanitizeGrantCopy の tags.map で失敗する既知ブロックを継続確認
- 15自治体単位メトリクス: 熊本県004単体は5自治体80制度。次の15自治体単位は熊本県004から開始し、1/3ブロックで5自治体80制度。採用率は80/592（一次候補比）、80/80（選定比）。監査1回予定、commit予定1回
- 到達点: 熊本県は43100熊本市から43403大津町まで第1巡到達。全国公式棚卸しは未完了
- 次回: 熊本県公式棚卸し005として、43404菊陽町から再開（想定対象は43404菊陽町・43423南小国町・43424小国町・43425産山村・43428高森町）

### 熊本県公式棚卸し005（43404菊陽町・43423南小国町・43424小国町・43425産山村・43428高森町）
- 対象: 43404菊陽町、43423南小国町、43424小国町、43425産山村、43428高森町
- 公式トップ到達: 菊陽町、南小国町、小国町、産山村、高森町の公式トップをHTTP 200で確認。小国町・産山村はsitemap.xmlを併用し、菊陽町・南小国町・高森町は公式カテゴリ/検索導線から個別ページを抽出
- 収集: 公式sitemap/検索/カテゴリBFSで325候補（菊陽町102、高森町106、産山村29、小国町32、南小国町56）を抽出。shortlistが150件超のためローカルJSON/TSVに本文スニペットを保存し、制度強語・金額/対象/受付表現・個別URLを再スコアして採用候補を絞り込み
- 採用: 60制度（菊陽町10、南小国町14、小国町13、産山村7、高森町16）。`kumamoto-official-005-001-2026` から `kumamoto-official-005-060-2026` として追加
- 保留: 広報、採用、会計年度任用職員、イベント、計画公表、一般案内、カテゴリ一覧、検索結果、本文だけでは現行制度要件を確認できないページは第2巡候補として保持。トップ/カテゴリ到達のみでは完了扱いにしていない
- 公式URL: build non200空。採用60本は build fetch と `tasks/discovery/kumamoto-official-coverage-005-url-status.txt` の最終到達確認でHTTP 200を確認
- 検証: node --check、JSON parse、slug重複、URL到達、eslint、diff check は通過。audit:coverage は既存の対象外 dirty 変更（src/lib/grant-copy.ts / src/lib/grants.ts）により sanitizeGrantCopy の tags.map で失敗する既知ブロックを継続確認
- 15自治体単位メトリクス: 熊本県005単体は5自治体60制度。次の15自治体単位は熊本県004-005累計で10自治体140制度。採用率は60/325（一次候補比）、60/60（選定比）。監査1回、commit1回
- 到達点: 熊本県は43100熊本市から43428高森町まで第1巡到達。全国公式棚卸しは未完了
- 次回: 熊本県公式棚卸し006として、43432西原村から再開（想定対象は43432西原村・43433南阿蘇村・43441御船町・43442嘉島町・43443益城町）

### 熊本県公式棚卸し006（43432西原村・43433南阿蘇村・43441御船町・43442嘉島町・43443益城町）
- 対象: 43432西原村、43433南阿蘇村、43441御船町、43442嘉島町、43443益城町
- 公式トップ到達: 西原村、南阿蘇村、御船町、嘉島町、益城町の公式トップをHTTP 200で確認。嘉島町は `https://www.town.kumamoto-kashima.lg.jp/` を公式URLとして使用し、EUC-JPページを文字コード指定で再取得して本文確認
- 収集: 公式sitemap/検索/カテゴリBFSで549候補（益城112、嘉島73、御船299、西原5、南阿蘇60）を抽出。shortlistが150件超のためローカルJSON/TSVに本文スニペットを保存し、制度強語・金額/対象/受付表現・個別URLを再スコアして採用候補を絞り込み
- 採用: 55制度（西原村1、南阿蘇村11、御船町18、嘉島町17、益城町8）。`kumamoto-official-006-001-2026` から `kumamoto-official-006-055-2026` として追加
- 保留: 広報、入札、プロポーザル、採用、イベント、カテゴリ一覧、申請書一覧、一般案内、重複または現行制度要件不明ページは第2巡候補として保持。トップ/カテゴリ到達のみでは完了扱いにしていない
- 公式URL: build non200空。採用55本は build fetch と `tasks/discovery/kumamoto-official-coverage-006-url-status.txt` の最終到達確認でHTTP 200を確認
- 検証: node --check、JSON parse、slug重複、URL到達、eslint、diff check は通過。audit:coverage は既存の対象外 dirty 変更（src/lib/grant-copy.ts / src/lib/grants.ts）により sanitizeGrantCopy の tags.map でcoverage集計前に失敗する既知ブロックを継続確認
- 15自治体単位メトリクス: 熊本県006単体は5自治体55制度。熊本県004-006累計は15自治体195制度。熊本県006の採用率は55/549（一次候補比）、55/55（選定比）。監査1回、commit1回
- 到達点: 熊本県は43100熊本市から43443益城町まで第1巡到達。全国公式棚卸しは未完了
- 次回: 熊本県公式棚卸し007として、43444甲佐町から再開（想定対象は43444甲佐町・43447山都町・43468氷川町・43482芦北町・43484津奈木町）

### 熊本県公式棚卸し007（43444甲佐町・43447山都町・43468氷川町・43482芦北町・43484津奈木町）
- 対象: 43444甲佐町、43447山都町、43468氷川町、43482芦北町、43484津奈木町
- 公式トップ到達: 甲佐町、山都町、氷川町、芦北町、津奈木町の公式トップをHTTP 200で確認。甲佐町はEUC-JPページを文字コード指定で再取得し、芦北町は公式sitemapを補完入口として使用
- 収集: 公式sitemap/検索/カテゴリBFSで458候補（甲佐92、山都45、氷川109、芦北2、津奈木210）を抽出。shortlistが150件超のためローカルTSVに本文スニペットを保存し再スコア。芦北町は公式sitemap 1,266URLを追加走査し160候補を補完
- 採用: 47制度（甲佐町12、山都町1、氷川町10、芦北町24、津奈木町0）。`kumamoto-official-007-001-2026` から `kumamoto-official-007-047-2026` として追加
- 津奈木町: 公式トップとカテゴリ一覧はHTTP 200で確認したが、制度名・対象・金額/上限・条件・期限/受付が揃う個別制度ページまで到達しなかったため、削除せず第2巡候補として保持。トップ/カテゴリ到達のみでは完了扱いにしていない
- 保留: カテゴリ一覧、検索結果、一般制度説明、相談窓口、届出・証明、広報、入札、プロポーザル、採用、イベント、本文だけでは現行制度要件を確認できないページは第2巡候補として保持
- 公式URL: build non200空。採用47本は build fetch と `tasks/discovery/kumamoto-official-coverage-007-url-status.txt` の最終到達確認でHTTP 200を確認
- 検証: node --check、JSON parse、slug重複、URL到達、eslint、diff check は通過。audit:coverage は既存の対象外 dirty 変更（src/lib/grant-copy.ts / src/lib/grants.ts）により sanitizeGrantCopy の tags.map でcoverage集計前に失敗する既知ブロックを継続確認
...
### 大分県公式棚卸し004（44213由布市補完・44341日出町・44461九重町・44462玖珠町）

- 対象公式トップ: 由布市 `https://www.city.yufu.oita.jp/`、日出町 `https://www.town.hiji.lg.jp/`、九重町 `https://www.town.kokonoe.oita.jp/`、玖珠町 `https://www.town.kusu.oita.jp/` をHTTP 200で確認。
- 公式sitemap/検索/カテゴリBFS候補: 365件（日出町88、九重町117、玖珠町160）。由布市は公式トップHTTP 200を確認したが、sitemap/search系は404またはトップ同等で、公式カテゴリ11ページの3秒タイムアウト軽量確認は全件 abort。制度候補0件確定ではなく、応答遅延による未判定保留。
- 採用: 60制度（日出町21、九重町19、玖珠町20）。`oita-official-004-001-2026` から `oita-official-004-060-2026` として追加。制度名・対象・金額/上限または支援内容・条件・申請/受付/更新状況を公式本文で確認。
- 低優先/第2巡: RSS、カテゴリ、検索結果、申請書単体、終了済み、外部制度、一般案内、同一制度の重複ページは採用せず、候補JSON/TSVに残置。由布市は003/004とも応答遅延で候補未判定のため、次回の最終補完対象として保持。
- 検証: `node --check src/data/grants/verified-local-misc-2026.ts`、`node --check`（004 discover/build）、JSON parse、追加slug重複なし、`npx eslint src/data/grants/verified-local-misc-2026.ts`、対象ファイル `git diff --check`、公式URL 60/60 HTTP 200（`tasks/discovery/oita-official-coverage-004-url-status.txt`）は pass。`npm run audit:coverage` は004構文修正後、既知の `src/lib/grant-copy.ts` `sanitizeGrantCopy` `tags.map` TypeError で停止。
- メトリクス: 3自治体採用、1自治体保留、60制度採用、一次候補365件、採用率は一次候補比16.4%。大分県001-004累計は18自治体相当310制度（由布市は応答遅延により未完了保留）。
- 到達点: 大分県は自治体コード上の全市町村に到達済みだが、44213由布市は最終補完待ち。全国公式棚卸しは未完了。
- 次回: 大分県公式棚卸し005として、44213由布市の最終補完を行い、候補未判定を解消したうえで都道府県順の次ブロックへ進む。


### 大分県公式棚卸し005（44213由布市 最終補完）

- 対象公式トップ: 由布市 `https://www.city.yufu.oita.jp/` をHTTP 200で確認。sitemap/search系は404またはトップ同等だったため、公式カテゴリ11ページを `curl --max-time 15` で取得し直し、全件HTTP 200本文を確認。
- 公式カテゴリ候補: 健康医療、福祉介護、教育学校、住まい空家、商工業、農政農業委員会、環境ごみエコ、防災、biz、商工労働、download の11ページから制度語リンク55件を抽出。
- 採用: 26制度（由布市26）。`oita-official-005-001-2026` から `oita-official-005-026-2026` として追加。制度名・対象・金額/上限または支援内容・条件・申請/受付状況を公式本文で確認。
- 低優先/除外: 国制度周知、カテゴリページ、評価ページ、終了済み、404旧導線、同一制度の重複導線は採用せず、候補JSON/TSVに残置。これにより由布市の候補未判定を解消。
- 検証: 公式URL 26/26 HTTP 200（`tasks/discovery/oita-official-coverage-005-url-status.txt`）。`node --check src/data/grants/verified-local-misc-2026.ts`、`node --check`（005 build）、JSON parse、追加slug重複なし、`npx eslint src/data/grants/verified-local-misc-2026.ts`、対象ファイル `git diff --check` は pass。`npm run audit:coverage` は既知の `src/lib/grant-copy.ts` `sanitizeGrantCopy` `tags.map` TypeError で停止。
...
### 鹿児島県公式棚卸し006（46468大崎町・46482東串良町・46490錦江町・46491南大隅町・46492肝付町）

- 対象公式トップ: 大崎町 `https://www.town.kagoshima-osaki.lg.jp/`、東串良町 `https://www.higashikushira.com/`、錦江町 `https://www.town.kinko.lg.jp/`、南大隅町 `https://www.town.minamiosumi.lg.jp/`、肝付町 `https://kimotsuki-town.jp/` をHTTP 200で確認。sitemap.xmlは東串良町・肝付町が200、大崎町・錦江町・南大隅町が404のため公式カテゴリBFSで補完。大崎町は `sitemap.html`、肝付町は `sitemap.xml` と `sitemap.html` も確認。
- 公式sitemap/カテゴリBFS候補: 460件（大崎町134、東串良町75、錦江町86、南大隅町17、肝付町148）。title強一致85件。候補数が150件超のため `tasks/discovery/kagoshima-official-coverage-006-rescored-shortlist.tsv` と `tasks/discovery/kagoshima-official-coverage-006-auto-selection.tsv` へ本文スニペット付き再スコアを保存。大崎町・錦江町・南大隅町は自治体CMSの部署別導線、東串良町はJoruri docs sitemap、肝付町は `sitemap.dir.xml` 系導線で補完。
- 採用: 100制度（大崎町25、東串良町25、錦江町25、南大隅町7、肝付町18）。`kagoshima-official-006-001-2026` から `kagoshima-official-006-100-2026` として追加。制度名・対象・金額/上限または支援内容・条件・申請/受付状況を公式本文で確認。
- 低優先/除外: カテゴリ、トップ、共通ナビ、申請書単体、受付終了、募集終了、実績/採択、職員採用、同一制度の重複導線、国・県事業の単純紹介、効果検証・使途公表は採用せず、候補JSON/TSVに残置。南大隅町は個別制度ページが少ないため、公式本文に対象・支援内容・申請情報がまとまる移住・子育て関連ページを採用。
...
### 沖縄県公式棚卸し006（47328中城村・47329西原町・47348与那原町・47350南風原町・47353渡嘉敷村）

- 対象公式トップ: 中城村 `https://www.vill.nakagusuku.okinawa.jp/`、西原町 `https://www.town.nishihara.okinawa.jp/`、与那原町 `https://www.town.yonabaru.okinawa.jp/`、南風原町 `https://www.town.haebaru.lg.jp/`、渡嘉敷村 `https://www.vill.tokashiki.okinawa.jp/` をHTTP 200で確認。中城村は `sitemap.xml` と `/sitemap/`、西原町・与那原町・南風原町は `sitemap_index.xml` と `sitemap.html`、渡嘉敷村は `sitemap.xml` と `sitemap.html` を確認。
- 公式sitemap/カテゴリBFS候補: 910件（中城村373、西原町251、与那原町107、南風原町173、渡嘉敷村6）。通常BFSでは渡嘉敷村0件だったため、公式sitemap再帰確認と公式検索結果/PDFスニペットで6候補を補足。title強一致72件。shortlistが150件超のため `tasks/discovery/okinawa-official-coverage-006-rescored-shortlist.tsv` と `tasks/discovery/okinawa-official-coverage-006-auto-selection.tsv` へ本文スニペット付き再スコアを保存。
- 採用: 43制度（中城村23、西原町7、与那原町3、南風原町6、渡嘉敷村4）。`okinawa-official-006-001-2026` から `okinawa-official-006-043-2026` として追加。制度名・対象・金額/上限または支援内容・条件・申請/受付状況を公式本文で確認。
- 低優先/除外: トップ、カテゴリ、共通ナビ、申請書単体、職員採用、入札・プロポーザル、COVID過年度、広報・議会だより、情報提供のみ、制度改正だけの導線、同一制度の補足導線は採用せず、候補JSON/TSVに残置。渡嘉敷村は一部ページのローカル再取得がAccess DeniedとなるためfallbackEvidence付きで採用し、制限内容をURL台帳に残した。
...
### 全国公式棚卸し最終監査018（山口県・青森県・大分県・長崎県raw gap 4件解消）

- 対象: `tasks/discovery/nationwide-final-audit-017-raw-gaps-after.json` の山口県1件、周南市 `shunan-newlywed-rent`、青森県1件、弘前市 `hirosaki-newlywed-rent`、大分県1件、大分市 `oita-city-newlywed-rent`、長崎県1件、佐世保市 `sasebo-newlywed-rent` を確認。
- 公式確認: 周南市は生活支援課の住居確保給付金等を確認したが、現行の新婚世帯家賃補助・結婚新生活支援の個別募集ページは確認不可。弘前市は公式補助・助成一覧、住居確保給付金PDF、就農希望者等住居確保事業費補助金を確認したが、新婚世帯向け家賃補助は確認不可。大分市は手当・助成一覧、住居確保給付金（家賃補助分・転居費用補助分）を確認したが、新婚世帯住居費補助は確認不可。佐世保市は市長への手紙回答で結婚新生活支援事業の過年度実施見送りを確認し、現行公式制度として子育て応援住宅支援事業補助金の中古住宅取得費5分の1・上限40万円、令和8年度受付2026年5月18日開始、予算終了までを確認。
- 解消方法: 周南市、弘前市、大分市は現行公式個別募集ページを確認できないため掲載抑止。佐世保市は旧rawの結婚新生活支援最大60万円を現行公式確認不可とし、子育て応援住宅支援事業補助金へ補正統合して通常一覧への重複・誤掲載を抑止。
...
### 全国公式棚卸し最終監査035（北海道第2巡015 浦臼町・新十津川町・妹背牛町・秩父別町）

- 対象: `tasks/discovery/hokkaido-second-pass-015-snippets.json` の浦臼町・新十津川町・妹背牛町・秩父別町を確認。
- 公式確認: 浦臼町は就学援助、任意予防接種、医療費助成/児童手当等候補を確認。新十津川町は奨学金/給食費無料、妊婦歯科健診等、文化スポーツ団体助成等、出生記念品等候補を確認。妹背牛町は奨学資金貸付、風しん予防接種、児童手当/国保/町営住宅等候補を確認。秩父別町は新婚・子育て世帯引越し費用助成、予防接種/奨学資金貸与、出会い応援/同窓会開催補助、結婚祝金/国保/住宅情報等候補を確認。
- 解消方法: 追加採用0件。4町とも第1巡掲載済み制度、通常行政/国制度、リンク先不一致、現行性疑義、又は金額/上限・受付状況不足の候補が中心で、新規に制度名・対象・金額/上限・条件・期限/受付状況が揃う未掲載制度は確認できなかった。
- 保留継続: 浦臼町の就学援助制度、任意予防接種、医療費助成/児童手当等、新十津川町の奨学金制度/給食費無料、妊婦歯科健診/インフルエンザ、文化スポーツ団体助成等、妹背牛町の奨学資金貸付、風しん予防接種、児童手当/国保/住宅情報等、秩父別町の新婚・子育て世帯引越し費用助成、インフルエンザ/奨学資金貸与、出会い応援/同窓会開催補助、結婚祝金等を台帳に残す。
- 成果物: `tasks/discovery/nationwide-final-audit-035-hokkaido-second-pass-015-resolution.json`、`tasks/discovery/nationwide-final-audit-035-hokkaido-second-pass-015-url-status.txt` を作成。代表確認URL 14/14 はHTTP 200。
- 検証: 監査JSON parse、checkpoint JSON parse、対象ファイル `git diff --check` はpass。助成金データ本体の追加・編集はないため `node --check src/data/grants/verified-local-misc-2026.ts` と eslint は今回省略。`npm run audit:coverage` は今回の追加採用0件では再実行しない。
...
### 全国公式棚卸し最終監査037（北海道第2巡017 東神楽町・当麻町・比布町・愛別町）

- 対象: `tasks/discovery/hokkaido-second-pass-017-snippets.json` の東神楽町・当麻町・比布町・愛別町を確認。
- 公式確認: 東神楽町は幼児教育・保育施設給食費助成、産前・産後ヘルパー/妊産婦健診、児童手当等候補を確認。当麻町は定額減税調整給付金/非課税世帯給付金、機械等導入補助、予防接種/国保/障害福祉等候補を確認。比布町は2026生活応援商品券、任意予防接種/就学援助/木造住宅耐震改修、子育て応援商品券等候補を確認。愛別町は妊産婦安心出産支援、消防団免許/ヘルメット助成、児童手当/障害福祉等候補を確認。
- 解消方法: 追加採用0件。4自治体とも第1巡掲載済み制度、通常行政/国制度、期限到来済み制度、又は金額/上限・受付状況不足の候補が中心で、新規に制度名・対象・金額/上限・条件・期限/受付状況が揃う未掲載制度は確認できなかった。
- 保留継続: 東神楽町の給食費助成、産前・産後ヘルパー/妊産婦健診、児童手当等、当麻町の定額減税調整給付金/非課税世帯給付金、機械等導入補助、予防接種/通常給付等、比布町の2026生活応援商品券、任意予防接種/就学援助/耐震改修、子育て応援商品券等、愛別町の妊産婦安心出産支援、消防団免許/ヘルメット助成、児童手当/障害福祉等を台帳に残す。
- 成果物: `tasks/discovery/nationwide-final-audit-037-hokkaido-second-pass-017-resolution.json`、`tasks/discovery/nationwide-final-audit-037-hokkaido-second-pass-017-url-status.txt` を作成。代表確認URL 12/12 はHTTP 200。
- 検証: 監査JSON parse、checkpoint JSON parse、対象ファイル `git diff --check` はpass。助成金データ本体の追加・編集はないため `node --check src/data/grants/verified-local-misc-2026.ts` と eslint は今回省略。`npm run audit:coverage` は今回の追加採用0件では再実行しない。
- 到達点: 北海道第2巡017は4自治体確認済み、追加採用0、保留継続12。全国公式棚卸しは未完了。
- 次回: 北海道第2巡018として、上川町・東川町・美瑛町・上富良野町など前方保留候補を自治体コード順に継続確認する。

### 全国公式棚卸し最終監査038（北海道第2巡018 上川町・東川町・美瑛町・上富良野町）

- 対象: `tasks/discovery/hokkaido-second-pass-018-snippets.json` の上川町・東川町・美瑛町・上富良野町を確認。
- 公式確認: 上川町は令和8年度住宅リフォーム等補助金、みんなが輝くまち上川事業支援金、産後ケア/任意予防接種/児童手当等候補を確認。東川町は妊産婦応援/産後ケア/ヘルパー/補聴器購入費、人づくり地域づくり/生涯教育/奨学金返還支援、国保/介護/年金等候補を確認。美瑛町は妊婦健診/不妊治療/任意予防接種、農業振興条例/担い手研修、新生児祝品/入学祝品/町営住宅等候補を確認。上富良野町は妊婦RSウイルス予防接種、児童手当/障害児福祉手当、ふるさと納税/住宅/移住相談等候補を確認。
- 解消方法: 追加採用0件。4自治体とも第1巡掲載済み制度、通常行政/国制度、現物給付、又は金額/上限・受付状況不足の候補が中心で、新規に制度名・対象・金額/上限・条件・期限/受付状況が揃う未掲載制度は確認できなかった。
- 保留継続: 上川町の住宅リフォーム等補助、みんなが輝くまち上川事業支援金、産後ケア/任意予防接種等、東川町の妊産婦応援/産後ケア/ヘルパー/補聴器、人づくり地域づくり/生涯教育/奨学金返還支援、WELCOME事業等、美瑛町の妊婦健診/不妊治療/任意予防接種、農業振興条例/担い手研修、新生児祝品等、上富良野町の妊婦RSウイルス予防接種、児童手当/障害児福祉手当等、ふるさと納税/町営住宅/移住相談等を台帳に残す。
- 成果物: `tasks/discovery/nationwide-final-audit-038-hokkaido-second-pass-018-resolution.json`、`tasks/discovery/nationwide-final-audit-038-hokkaido-second-pass-018-url-status.txt` を作成。代表確認URL 12/12 はHTTP 200。
- 検証: 監査JSON parse、checkpoint JSON parse、対象ファイル `git diff --check` はpass。助成金データ本体の追加・編集はないため `node --check src/data/grants/verified-local-misc-2026.ts` と eslint は今回省略。`npm run audit:coverage` は今回の追加採用0件では再実行しない。
- 到達点: 北海道第2巡018は4自治体確認済み、追加採用0、保留継続12。全国公式棚卸しは未完了。
- 次回: 北海道第2巡019として、中富良野町・南富良野町・占冠村・和寒町など前方保留候補を自治体コード順に継続確認する。
