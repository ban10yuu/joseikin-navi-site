...
const batch = 'miyazaki-official-coverage-005';

const orgs = [
  {
    org: '門川町',
    base: 'https://www.town.kadogawa.lg.jp',
    sitemaps: [],
    seeds: ['/', '/live/', '/learn/', '/industry/', '/administration/', '/news/general/', '/news/business/', '/sitemap.html'],
    keep: /\/(?:live|learn|industry|administration|news|download|disaster|akiyabank|reiki_int|uploads|files|common)[^"'<> ]*(?:\.html|\.pdf|\/)(?:$|\?)/i,
    crawl: /\/(?:live|learn|industry|administration|news|download|disaster|akiyabank)(?:\/|\.html|$)/i,
    limit: 900,
  },
  {
    org: '諸塚村',
    base: 'https://www.vill.morotsuka.miyazaki.jp',
    sitemaps: ['https://www.vill.morotsuka.miyazaki.jp/sitemap.xml'],
    seeds: ['/', '/jumin/', '/kenko-fukushi/', '/kosodate-kyoiku/', '/sangyo/', '/iju/', '/kurashi/', '/gyosei/'],
    keep: /\/(?:jumin|kenko-fukushi|kosodate-kyoiku|sangyo|iju|kurashi|gyosei|kanko-bunka|top|uploads|files|download|wp-content)[^"'<> ]*(?:\.html|\.pdf|\/)(?:$|\?)/i,
    crawl: /\/(?:jumin|kenko-fukushi|kosodate-kyoiku|sangyo|iju|kurashi|gyosei|top)(?:\/|$)|sitemap\.dir\.xml/i,
    limit: 900,
  },
  {
    org: '椎葉村',
    base: 'https://www.vill.shiiba.miyazaki.jp',
    sitemaps: ['https://www.vill.shiiba.miyazaki.jp/sitemap.xml'],
    seeds: ['/', '/index.php', '/welfare/', '/education/', '/promote/', '/construct/', '/affair/', '/news/index.php', '/sitemap.php'],
    keep: /\/(?:welfare|education|promote|construct|affair|news|road|publicity|pdf|uploads|files|download)[^"'<> ]*(?:\.php|\.html|\.pdf|\/|index-itemid=\d+)(?:$|\?)/i,
    crawl: /\/(?:welfare|education|promote|construct|affair|news|road)(?:\/|$)|sitemap\.dir\.xml|sitemap\.php|index\.php/i,
    limit: 900,
  },
  {
    org: '美郷町',
    base: 'https://www.town.miyazaki-misato.lg.jp',
    sitemaps: [],
    seeds: [
      '/',
      '/default.html',
      ...
      '/list00193.html',
      '/list00460.html',
      '/dynamic/info/pub/default.aspx?c_id=26',
      '/dynamic/page/',
      '/dynamic/hpkiji/pub/',
      '/dynamic/page/pub/',
      '/dynamic/page/publist.aspx',
      '/dynamic/search/pub/default.aspx',
    ],
    keep: /\/(?:dynamic|content|files|upload|download)[^"'<> ]*(?:\.aspx|\.html|\.pdf|\/)(?:$|\?)|\/(?:list\d+\.html|kiji\d+\/index\.html)(?:$|\?)/i,
    crawl: /\/(?:dynamic|content)(?:\/|$)|publist\.aspx|default\.aspx|\/(?:list\d+\.html|kiji\d+\/index\.html)(?:$|\?)/i,
    limit: 720,
  },
  {
    org: '高千穂町',
    base: 'https://www.town-takachiho.jp',
    sitemaps: ['https://www.town-takachiho.jp/sitemap.xml'],
    seeds: ['/', '/top/', '/top/kurashi/', '/top/kenko/', '/top/kosodate/', '/top/sangyo/', '/top/iju/', '/top/gyosei/', '/furusato/'],
    keep: /\/(?:top|kurashi|kenko|kosodate|sangyo|iju|gyosei|furusato|uploads|files|download)[^"'<> ]*(?:\.html|\.pdf|\/)(?:$|\?)/i,
    crawl: /\/(?:top|kurashi|kenko|kosodate|sangyo|iju|gyosei|furusato)(?:\/|$)|sitemap\.dir\.xml/i,
    limit: 900,
  },
];
