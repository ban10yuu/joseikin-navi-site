...
const batch = 'miyazaki-official-coverage-006';

const orgs = [
  {
    org: '日之影町',
    base: 'https://www.town.hinokage.lg.jp',
    sitemaps: ['https://www.town.hinokage.lg.jp/sitemap.xml'],
    seeds: ['/', '/docs/', '/docs/life/', '/docs/health/', '/docs/childcare/', '/docs/industry/', '/docs/migration/', '/docs/administration/'],
    keep: /\/(?:docs|life|health|childcare|industry|migration|administration|kurashi|fukushi|kosodate|sangyo|download|files|uploads)[^"'<> ]*(?:\.html|\.pdf|\/)(?:$|\?)/i,
    crawl: /\/(?:docs|life|health|childcare|industry|migration|administration|kurashi|fukushi|kosodate|sangyo)(?:\/|$)|sitemap\.xml/i,
    limit: 900,
  },
  {
    org: '五ヶ瀬町',
    base: 'https://www.town.gokase.miyazaki.jp',
    sitemaps: ['https://www.town.gokase.miyazaki.jp/sitemap.xml'],
    seeds: ['/', '/sitemap.html', '/gyosei/index.html', '/jigyousha/index.html', '/kurashi/index.html', '/chousei/hozyokin/', '/kakuka/fukushi/', '/kakuka/choumin/', '/kakuka/nourin/', '/kakuka/kikaku/', '/kakuka/kyouiku/'],
    keep: /\/(?:gyosei|jigyousha|kurashi|chousei\/hozyokin|kakuka\/(?:fukushi|choumin|nourin|kikaku|kyouiku|kensetsu)|files|uploads|download)[^"'<> ]*(?:\.html|\.pdf|\/)(?:$|\?)/i,
    crawl: /\/(?:gyosei|jigyousha|kurashi|chousei\/hozyokin|kakuka\/(?:fukushi|choumin|nourin|kikaku|kyouiku|kensetsu))(?:\/|$)|sitemap\.dir\.xml/i,
    limit: 900,
  },
];
