...
const batch = 'fukuoka-official-coverage-005';
const outFile = `tasks/discovery/${batch}-rescored-candidates.json`;

const municipalities = [
  { org: '古賀市', base: 'https://www.city.koga.fukuoka.jp', seeds: ['/', '/cityhall/', '/kurashi/', '/life/', '/kosodate/', '/kenko/', '/business/', '/sangyo/', '/education/'], mode: 'cms', max: 260 },
  { org: '福津市', base: 'https://www.city.fukutsu.lg.jp', seeds: ['/', '/kurashi/', '/kosodate/', '/kenko/', '/sangyo/', '/kyoiku/', '/shisei/', '/soshiki/'], mode: 'cms', max: 260 },
  { org: 'うきは市', base: 'https://www.city.ukiha.fukuoka.jp', seeds: ['/', '/kurashi/', '/kosodate/', '/kenko/', '/sangyo/', '/kyoiku/', '/shisei/', '/soshiki/'], mode: 'cms', max: 260 },
  { org: '宮若市', base: 'https://www.city.miyawaka.lg.jp', seeds: ['/', '/kurashi/', '/kosodate/', '/kenko/', '/sangyo/', '/kyoiku/', '/shisei/', '/soshiki/'], mode: 'cms', max: 260 },
  { org: '嘉麻市', base: 'https://www.city.kama.lg.jp', seeds: ['/', '/soshiki/', '/life/', '/kurashi/', '/kosodate/', '/kenko/', '/sangyo/', '/kyoiku/', '/shisei/'], mode: 'cms', max: 260 },
];
