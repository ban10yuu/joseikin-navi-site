...
const batch = 'fukuoka-official-coverage-003';
const outFile = `tasks/discovery/${batch}-rescored-candidates.json`;

const municipalities = [
  { org: '大川市', base: 'https://www.city.okawa.lg.jp', seeds: ['https://www.city.okawa.lg.jp/sitemap.xml'], mode: 'sitemap', max: 260 },
  { org: '行橋市', base: 'https://www.city.yukuhashi.fukuoka.jp', seeds: ['/', '/kurashi/', '/kosodate/', '/kenko/', '/sangyo/', '/kyoiku/', '/shisei/', '/soshiki/'], mode: 'cms', max: 260 },
  { org: '豊前市', base: 'https://www.city.buzen.lg.jp', seeds: ['/', '/kurashi/', '/kosodate/', '/kenko/', '/sangyo/', '/kyoiku/', '/shisei/', '/soshiki/'], mode: 'cms', max: 260 },
  { org: '中間市', base: 'https://www.city.nakama.lg.jp', seeds: ['/', '/kurashi/', '/kosodate/', '/kenko/', '/sangyo/', '/kyoiku/', '/shisei/', '/soshiki/'], mode: 'cms', max: 260 },
  { org: '小郡市', base: 'https://www.city.ogori.fukuoka.jp', seeds: ['/', '/kurashi/', '/kosodate/', '/kenko/', '/sangyo/', '/kyoiku/', '/shisei/', '/soshiki/'], mode: 'cms', max: 260 },
];
