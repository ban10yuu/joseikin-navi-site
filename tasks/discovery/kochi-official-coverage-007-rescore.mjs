...
const batch = 'kochi-official-coverage-007';
const outFile = `tasks/discovery/${batch}-rescored-candidates.json`;

const municipalities = [
  { org: '四万十町', base: 'https://www.town.shimanto.lg.jp', seeds: ['/', '/life/', '/kurashi/', '/soshiki/', '/kosodate/', '/business/', '/iju/', '/category/'], mode: 'cms', max: 240 },
  { org: '大月町', base: 'https://www.town.otsuki.kochi.jp', seeds: ['/', '/life/', '/kurashi/', '/soshiki/', '/kosodate/', '/business/', '/iju/', '/category/'], mode: 'cms', max: 240 },
  { org: '三原村', base: 'https://www.vill.mihara.kochi.jp', seeds: ['/', '/life/', '/kurashi/', '/soshiki/', '/kosodate/', '/business/', '/iju/', '/category/'], mode: 'cms', max: 240 },
  { org: '黒潮町', base: 'https://www.town.kuroshio.lg.jp', seeds: ['/', '/life/', '/kurashi/', '/soshiki/', '/kosodate/', '/business/', '/iju/', '/category/'], mode: 'cms', max: 240 },
];
