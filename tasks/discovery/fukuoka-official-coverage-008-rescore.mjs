...
const batch = 'fukuoka-official-coverage-008';
const outFile = `tasks/discovery/${batch}-rescored-candidates.json`;

const municipalities = [
  { org: '粕屋町', base: 'https://www.town.kasuya.fukuoka.jp', seeds: ['/', '/soshiki/', '/life/', '/kurashi/', '/kosodate/', '/kenko/', '/sangyo/', '/kyoiku/', '/shisei/'], mode: 'cms', max: 280 },
  { org: '芦屋町', base: 'https://www.town.ashiya.lg.jp', seeds: ['/', '/soshiki/', '/life/', '/kurashi/', '/kosodate/', '/kenko/', '/sangyo/', '/kyoiku/', '/shisei/'], mode: 'cms', max: 280 },
  { org: '水巻町', base: 'https://www.town.mizumaki.lg.jp', seeds: ['/', '/soshiki/', '/life/', '/kurashi/', '/kosodate/', '/kenko/', '/sangyo/', '/kyoiku/', '/shisei/'], mode: 'cms', max: 280 },
  { org: '岡垣町', base: 'https://www.town.okagaki.lg.jp', seeds: ['/', '/soshiki/', '/life/', '/kurashi/', '/kosodate/', '/kenko/', '/sangyo/', '/kyoiku/', '/shisei/'], mode: 'cms', max: 280 },
  { org: '遠賀町', base: 'https://www.town.onga.lg.jp', seeds: ['/', '/soshiki/', '/life/', '/kurashi/', '/kosodate/', '/kenko/', '/sangyo/', '/kyoiku/', '/shisei/'], mode: 'cms', max: 280 },
];
