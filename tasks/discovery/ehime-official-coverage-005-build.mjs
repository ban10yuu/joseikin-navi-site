...
const { selections } = JSON.parse(fs.readFileSync('tasks/discovery/ehime-official-coverage-005-selections.json','utf8'));
const outBase='tasks/discovery/ehime-official-coverage-005';
...
fs.writeFileSync(outBase+'-ts-snippet.ts',`const ehimeOfficial005Grants: Array<{
  slug: string;
  title: string;
  organization: string;
  maxAmount: string;
