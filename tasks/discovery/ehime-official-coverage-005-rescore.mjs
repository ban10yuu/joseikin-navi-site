...
const batch = 'ehime-official-coverage-005';
const outFile = `tasks/discovery/${batch}-rescored-candidates.json`;

const municipalities = [
  { org: '松野町', base: 'https://www.town.matsuno.ehime.jp', seeds: ['/', '/site/', '/soshiki/', '/kurashi/', '/kosodate/', '/business/', '/life/'], mode: 'cms', max: 800 },
  { org: '鬼北町', base: 'https://www.town.kihoku.ehime.jp', seeds: ['/', '/site/', '/soshiki/', '/kurashi/', '/kosodate/', '/business/', '/life/'], mode: 'cms', max: 800 },
  { org: '愛南町', base: 'https://www.town.ainan.ehime.jp', seeds: ['/', '/kurashi/', '/soshiki/', '/site/', '/kosodate/', '/business/', '/life/'], mode: 'cms', max: 800 },
];
