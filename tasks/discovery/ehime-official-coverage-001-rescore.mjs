...
const batch = 'ehime-official-coverage-001';
const outFile = `tasks/discovery/${batch}-rescored-candidates.json`;

const municipalities = [
  { org: '松山市', base: 'https://www.city.matsuyama.ehime.jp', seeds: ['/', '/kurashi/', '/shisei/', '/kosodate/', '/kenko/', '/jigyosha/'], mode: 'cms', max: 900 },
  { org: '今治市', base: 'https://www.city.imabari.ehime.jp', seeds: ['/', '/soshiki/', '/kurashi/', '/kosodate/', '/kenko/', '/shigoto/'], mode: 'cms', max: 850 },
  { org: '宇和島市', base: 'https://www.city.uwajima.ehime.jp', seeds: ['/', '/soshiki/', '/site/', '/kurashi/', '/kosodate/', '/business/'], mode: 'cms', max: 850 },
  { org: '八幡浜市', base: 'https://www.city.yawatahama.ehime.jp', seeds: ['/', '/soshiki/', '/site/', '/kurashi/', '/kosodate/', '/business/'], mode: 'cms', max: 800 },
  { org: '新居浜市', base: 'https://www.city.niihama.lg.jp', seeds: ['/', '/soshiki/', '/site/', '/kurashi/', '/kosodate/', '/business/'], mode: 'cms', max: 850 },
];
