...
const batch = 'kochi-official-coverage-002';
const outFile = `tasks/discovery/${batch}-rescored-candidates.json`;

const municipalities = [
  { org: '須崎市', base: 'https://www.city.susaki.lg.jp', seeds: ['/', '/life/', '/soshiki/', '/site/', '/kurashi/', '/business/', '/kosodate/', '/kanko/'], mode: 'cms', max: 900 },
  { org: '宿毛市', base: 'https://www.city.sukumo.kochi.jp', seeds: ['/', '/docs/', '/life/', '/soshiki/', '/site/', '/kurashi/', '/business/', '/kosodate/'], mode: 'cms', max: 900 },
  { org: '土佐清水市', base: 'https://www.city.tosashimizu.kochi.jp', seeds: ['/', '/kurashi/', '/soshiki/', '/site/', '/life/', '/business/', '/kosodate/', '/iju/'], mode: 'cms', max: 900 },
  { org: '四万十市', base: 'https://www.city.shimanto.lg.jp', seeds: ['/', '/site/', '/life/', '/soshiki/', '/kurashi/', '/business/', '/kosodate/', '/iju/'], mode: 'cms', max: 900 },
  { org: '香南市', base: 'https://www.city.kochi-konan.lg.jp', seeds: ['/', '/soshikikarasagasu/', '/kurashi/', '/kosodate_kyoiku/', '/kenko_fukushi/', '/sangyo_business/', '/iju_teiju/'], mode: 'cms', max: 900 },
];
