...
const { selections } = JSON.parse(fs.readFileSync('tasks/discovery/ehime-official-coverage-002-selections.json','utf8'));
const outBase='tasks/discovery/ehime-official-coverage-002';
...
fs.writeFileSync(outBase+'-ts-snippet.ts',`const ehimeOfficial002Grants: Array<{
  slug: string;
  title: string;
  organization: string;
  maxAmount: string;
