...
const batch = 'miyazaki-official-coverage-004';

const orgs = [
  {
    org: '新富町',
    base: 'https://www.town.shintomi.lg.jp',
    sitemaps: ['https://www.town.shintomi.lg.jp/sitemap.xml'],
    seeds: [
      '/',
      '/kurashi/index.html',
      '/iryo_kenko_fukushi/index.html',
      '/kosodate_kyoiku/index.html',
      '/shigoto_sangyo/index.html',
      '/iju_teiju/index.html',
      '/bousai_anzen/index.html',
      '/chosei/index.html',
    ],
    keep: /\/(?:kurashi|iryo_kenko_fukushi|kosodate_kyoiku|shigoto_sangyo|iju_teiju|bousai_anzen|chosei|file|files|upload|download|material)[^"'<> ]*(?:\.html|\.pdf|\/)(?:$|\?)/i,
    crawl: /\/(?:kurashi|iryo_kenko_fukushi|kosodate_kyoiku|shigoto_sangyo|iju_teiju|bousai_anzen|chosei)(?:\/|\.html|$)/i,
    limit: 900,
  },
  {
    org: '西米良村',
    base: 'https://www.vill.nishimera.lg.jp',
    sitemaps: ['https://www.vill.nishimera.lg.jp/sitemap.xml'],
    seeds: ['/', '/village/', '/village/villagelife', '/village/businessperson', '/village/admininfo', '/village/category/b-00-businessperson/b-01', '/village/category/a-00-villagelife', '/village/category/c-00-admininfo'],
    keep: /\/(?:village|wp-content|assets|files|uploads)[^"'<> ]*(?:\.html|\.pdf|\/|p=\d+)(?:$|\?)/i,
    crawl: /\/village(?:\/|$)|[?&]p=\d+/i,
    limit: 720,
  },
  {
    org: '木城町',
    base: 'https://www.town.kijo.lg.jp',
    sitemaps: ['https://www.town.kijo.lg.jp/sitemap.xml'],
    seeds: ['/', '/kurashi/index.html', '/kenkou_fukushi/index.html', '/kosodate_kyoiku/index.html', '/sangyou_shigoto/index.html', '/ijyu_teijyu/index.html', '/gyouseizyouhou/index.html', '/bosyu/index.html'],
    keep: /\/(?:kurashi|kenkou_fukushi|kosodate_kyoiku|sangyou_shigoto|ijyu_teijyu|gyouseizyouhou|bosyu|file|files|upload|download|material)[^"'<> ]*(?:\.html|\.pdf|\/)(?:$|\?)/i,
    crawl: /\/(?:kurashi|kenkou_fukushi|kosodate_kyoiku|sangyou_shigoto|ijyu_teijyu|gyouseizyouhou|bosyu)(?:\/|\.html|$)/i,
    limit: 900,
  },
  {
    org: '川南町',
    base: 'https://www.town.kawaminami.miyazaki.jp',
    sitemaps: [],
    seeds: ['/', '/sitemap.html', '/life/1/', '/life/2/', '/life/3/', '/life/4/', '/life/5/', '/life/6/', '/soshiki/', '/site/guide/'],
    keep: /\/(?:life|soshiki|site|calendar|material|upload|download|files)[^"'<> ]*(?:\.html|\.pdf|\/)(?:$|\?)/i,
    crawl: /\/(?:life|soshiki|site)(?:\/|\.html|$)/i,
    limit: 720,
  },
  {
    org: '都農町',
    base: 'https://www.town.tsuno.lg.jp',
    sitemaps: ['https://www.town.tsuno.lg.jp/sitemap.xml'],
    seeds: ['/', '/section/', '/article/', '/life/', '/category/', '/kurashi/', '/kosodate/', '/kenko/', '/sangyo/', '/gyosei/'],
    keep: /\/(?:article|section|life|category|kurashi|kosodate|kenko|sangyo|gyosei|assets|files|uploads|download)[^"'<> ]*(?:\.html|\.pdf|\/|[0-9a-z_-]+)(?:$|\?)/i,
    crawl: /\/(?:article|section|life|category|kurashi|kosodate|kenko|sangyo|gyosei)(?:\/|$)/i,
    limit: 900,
  },
];
