...
const batch = 'kochi-official-coverage-003';
const outFile = `tasks/discovery/${batch}-rescored-candidates.json`;

const municipalities = [
  { org: '香美市', base: 'https://www.city.kami.lg.jp', seeds: ['/', '/soshiki/', '/site/', '/life/', '/kurashi/', '/kosodate/', '/business/', '/teiju/'], mode: 'cms', max: 900 },
  { org: '東洋町', base: 'http://www.town.toyo.kochi.jp', seeds: ['/', '/contents/', '/life/', '/soshiki/', '/kurashi/', '/kosodate/', '/business/', '/iju/'], mode: 'cms', max: 900 },
  { org: '奈半利町', base: 'https://www.town.nahari.kochi.jp', seeds: ['/', '/life/', '/soshiki/', '/kurashi/', '/kosodate/', '/business/', '/iju/', '/category/'], mode: 'cms', max: 900 },
  { org: '田野町', base: 'https://tanocho.jp', seeds: ['/', '/life/', '/kurashi/', '/kosodate/', '/business/', '/iju/', '/information/', '/category/'], mode: 'cms', max: 900 },
  { org: '安田町', base: 'https://www.town.yasuda.kochi.jp', seeds: ['/', '/life/', '/soshiki/', '/kurashi/', '/kosodate/', '/business/', '/iju/', '/category/'], mode: 'cms', max: 900 },
];
