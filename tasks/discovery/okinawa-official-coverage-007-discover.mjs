...
const batch = 'okinawa-official-coverage-007';

const orgs = [
  {
    org: '座間味村',
    base: 'https://www.vill.zamami.okinawa.jp',
    sitemaps: ['https://www.vill.zamami.okinawa.jp/sitemap.xml'],
    seeds: ['/', '/sitemap/', '/kurashi/', '/topics/', '/info/', '/download/'],
    keep: new RegExp(String.raw`/(?:kurashi|topics|info|download|uploads|files|documents)[^"'<> ]*(?:\.html|\.php|\.pdf|/)(?:$|\?)|sitemap(?:\.dir)?\.xml`, 'i'),
    crawl: new RegExp(String.raw`/(?:kurashi|topics|info|download)[^"'<> ]*(?:/|\.html|\.xml)|sitemap(?:\.dir)?\.xml|sitemap/`, 'i'),
    limit: 850,
  },
  {
    org: '粟国村',
    base: 'https://www.vill.aguni.okinawa.jp',
    sitemaps: ['https://www.vill.aguni.okinawa.jp/sitemap.xml'],
    seeds: ['/', '/sitemap.html', '/kurashi/', '/kosodate/', '/kennkouhuskusi/', '/jigyo/', '/ijyuteijyu/'],
    keep: new RegExp(String.raw`/(?:kurashi|kosodate|kennkouhuskusi|jigyo|ijyuteijyu|important|download|files|documents)[^"'<> ]*(?:\.html|\.php|\.pdf|/)(?:$|\?)|sitemap(?:\.dir)?\.xml`, 'i'),
    crawl: new RegExp(String.raw`/(?:kurashi|kosodate|kennkouhuskusi|jigyo|ijyuteijyu|important|download)[^"'<> ]*(?:/|\.html|\.xml)|sitemap(?:\.dir)?\.xml|sitemap\.html`, 'i'),
    limit: 750,
  },
  {
    org: '渡名喜村',
    base: 'http://www.vill.tonaki.okinawa.jp',
    sitemaps: [],
    seeds: ['/', '/index.jsp', '/topics.jsp?type=TopicsTopPage', '/list_typeB.jsp?menuid=12314&funcid=3', '/list_typeB.jsp?menuid=12315&funcid=3', '/list_typeB.jsp?menuid=12316&funcid=3', '/list_typeB.jsp?menuid=12317&funcid=3', '/list_typeB.jsp?menuid=12318&funcid=3', '/list_typeB.jsp?menuid=12319&funcid=3', '/list_typeB.jsp?menuid=12320&funcid=3', '/list_typeB.jsp?menuid=12321&funcid=3'],
    keep: new RegExp(String.raw`/(?:detail|list_typeB|menuIndex|topics)\.jsp\?[^"'<> ]+`, 'i'),
    crawl: new RegExp(String.raw`/(?:detail|list_typeB|menuIndex|topics)\.jsp\?[^"'<> ]+`, 'i'),
    limit: 750,
  },
  {
    org: '南大東村',
    base: 'https://www.vill.minamidaito.okinawa.jp',
    sitemaps: ['https://www.vill.minamidaito.okinawa.jp/sitemap_index.xml'],
    seeds: ['/', '/sitemap.html', '/life/', '/life/1/', '/life/2/', '/life/3/', '/life/4/', '/life/5/', '/life/6/', '/soshiki/'],
    keep: new RegExp(String.raw`/(?:life|soshiki|site|news|pickup|boshu|oshirase|download|files|documents)[^"'<> ]*(?:\.html|\.php|\.pdf|/)(?:$|\?)|sitemap(?:_index|[0-9]+|\.dir)?\.xml`, 'i'),
    crawl: new RegExp(String.raw`/(?:life|soshiki|site|news|pickup|boshu|oshirase|download)[^"'<> ]*(?:/|\.html|\.xml)|sitemap(?:_index|[0-9]+|\.dir)?\.xml|sitemap\.html`, 'i'),
    limit: 750,
  },
  {
    org: '北大東村',
    base: 'https://vill.kitadaito.okinawa.jp',
    sitemaps: ['https://vill.kitadaito.okinawa.jp/sitemap.xml'],
    seeds: ['/', '/sitemap.html', '/docs/', '/category/', '/sangyo/', '/kurashi/', '/kosodate/', '/kenko/'],
    keep: new RegExp(String.raw`/(?:docs|category|sangyo|news|pickup|oshirase|download|files|documents)[^"'<> ]*(?:\.html|\.php|\.pdf|/)(?:$|\?)|sitemap(?:\.node)?\.xml`, 'i'),
    crawl: new RegExp(String.raw`/(?:docs|category|sangyo|news|pickup|oshirase|download)[^"'<> ]*(?:/|\.html|\.xml)|sitemap(?:\.node)?\.xml|sitemap\.html`, 'i'),
    limit: 750,
  },
];
