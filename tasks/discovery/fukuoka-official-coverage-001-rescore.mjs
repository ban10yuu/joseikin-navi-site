...
const batch = 'fukuoka-official-coverage-001';
const outFile = `tasks/discovery/${batch}-rescored-candidates.json`;

const municipalities = [
  { org: '北九州市', base: 'https://www.city.kitakyushu.lg.jp', seeds: ['/', '/kurashi/', '/business/', '/sangyo/', '/kosodate/', '/ho-huku/', '/contents/', '/page/'], mode: 'cms', max: 260 },
  { org: '福岡市', base: 'https://www.city.fukuoka.lg.jp', seeds: ['/', '/life/', '/business/', '/child/', '/health/', '/housing/', '/keizai/', '/data/'], mode: 'cms', max: 260 },
  { org: '大牟田市', base: 'https://www.city.omuta.lg.jp', seeds: ['/', '/kiji003', '/kurashi/', '/shigoto/', '/kosodate/', '/hpkiji/', '/list'], mode: 'cms', max: 260 },
  { org: '久留米市', base: 'https://www.city.kurume.fukuoka.jp', seeds: ['/', '/kurashi/', '/1500soshiki/', '/1050kurashi/', '/1060manabi/', '/1070kenko/', '/1080sangyou/'], mode: 'cms', max: 260 },
  { org: '直方市', base: 'https://www.city.nogata.fukuoka.jp', seeds: ['/', '/kurashi/', '/kenko/', '/kosodate/', '/sangyo/', '/kanko/', '/shisei/'], mode: 'cms', max: 260 },
];
