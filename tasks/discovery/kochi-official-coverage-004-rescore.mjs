...
const batch = 'kochi-official-coverage-004';
const outFile = `tasks/discovery/${batch}-rescored-candidates.json`;

const municipalities = [
  { org: '北川村', base: 'https://www.kitagawamura.jp', seeds: ['/', '/life/', '/soshiki/', '/kurashi/', '/kosodate/', '/business/', '/iju/', '/category/'], mode: 'cms', max: 900 },
  { org: '馬路村', base: 'https://umaji.gr.jp', seeds: ['/', '/life/', '/kurashi/', '/kosodate/', '/business/', '/iju/', '/category/', '/info/'], mode: 'cms', max: 900 },
  { org: '芸西村', base: 'https://www.vill.geisei.kochi.jp', seeds: ['/', '/pages/', '/life/', '/soshiki/', '/kurashi/', '/kosodate/', '/business/', '/iju/'], mode: 'cms', max: 900 },
  { org: '本山町', base: 'https://www.town.motoyama.kochi.jp', seeds: ['/', '/life/', '/soshiki/', '/kurashi/', '/kosodate/', '/business/', '/iju/', '/category/'], mode: 'cms', max: 900 },
  { org: '大豊町', base: 'https://www.town.otoyo.kochi.jp', seeds: ['/', '/life/', '/soshiki/', '/kurashi/', '/kosodate/', '/business/', '/iju/', '/category/'], mode: 'cms', max: 900 },
];
