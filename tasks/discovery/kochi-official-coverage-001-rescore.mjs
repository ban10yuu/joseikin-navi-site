...
const batch = 'kochi-official-coverage-001';
const outFile = `tasks/discovery/${batch}-rescored-candidates.json`;

const municipalities = [
  { org: '高知市', base: 'https://www.city.kochi.kochi.jp', seeds: ['/', '/soshiki/', '/site/', '/life/', '/kurashi/', '/business/', '/kosodate/'], mode: 'cms', max: 800 },
  { org: '室戸市', base: 'https://www.city.muroto.kochi.jp', seeds: ['/', '/soshiki/', '/site/', '/life/', '/kurashi/', '/business/', '/kosodate/'], mode: 'cms', max: 800 },
  { org: '安芸市', base: 'https://www.city.aki.kochi.jp', seeds: ['/', '/soshiki/', '/site/', '/life/', '/kurashi/', '/business/', '/kosodate/'], mode: 'cms', max: 800 },
  { org: '南国市', base: 'https://www.city.nankoku.lg.jp', seeds: ['/', '/life/', '/soshiki/', '/site/', '/kurashi/', '/business/', '/kosodate/'], mode: 'cms', max: 800 },
  { org: '土佐市', base: 'https://www.city.tosa.lg.jp', seeds: ['/', '/life/', '/soshiki/', '/site/', '/kurashi/', '/business/', '/kosodate/'], mode: 'cms', max: 800 },
];
