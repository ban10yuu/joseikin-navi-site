...
const batch = 'kochi-official-coverage-005';
const outFile = `tasks/discovery/${batch}-rescored-candidates.json`;

const municipalities = [
  { org: '土佐町', base: 'https://www.town.tosa.kochi.jp', seeds: ['/', '/life/', '/kurashi/', '/soshiki/', '/kosodate/', '/business/', '/iju/', '/category/'], mode: 'cms', max: 240 },
  { org: '大川村', base: 'https://www.vill.okawa.kochi.jp', seeds: ['/', '/life/', '/kurashi/', '/soshiki/', '/kosodate/', '/business/', '/iju/', '/category/'], mode: 'cms', max: 240 },
  { org: 'いの町', base: 'https://www.town.ino.kochi.jp', seeds: ['/', '/kurashi/', '/life/', '/soshiki/', '/kosodate/', '/business/', '/iju/', '/category/'], mode: 'cms', max: 240 },
  { org: '仁淀川町', base: 'https://www.town.niyodogawa.lg.jp', seeds: ['/', '/life/', '/kurashi/', '/soshiki/', '/kosodate/', '/business/', '/iju/', '/category/'], mode: 'cms', max: 240 },
  { org: '中土佐町', base: 'https://www.town.nakatosa.lg.jp', seeds: ['/', '/life/', '/kurashi/', '/soshiki/', '/kosodate/', '/business/', '/iju/', '/category/'], mode: 'cms', max: 240 },
];
