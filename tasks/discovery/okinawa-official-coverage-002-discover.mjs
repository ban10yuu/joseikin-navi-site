...
const batch = 'okinawa-official-coverage-002';

const orgs = [
  {
    org: '名護市',
    base: 'https://www.city.nago.okinawa.jp',
    sitemaps: [],
    seeds: ['/', '/sitemap.html', '/category/guide/kosodate/', '/category/guide/kyoiku/', '/category/guide/kenkou/', '/category/guide/kourei/', '/category/guide/sumai/', '/category/guide/sangyou/', '/category/guide/todokede/sinseisho/'],
    keep: /\/(?:category|articles|guide|kurashi|kosodate|kenkou|kourei|sumai|sangyou|kyoiku|files|documents)[^"'<> ]*(?:\.html|\.php|\.pdf|\/)(?:$|\?)/i,
    crawl: /\/(?:category|articles|guide|kurashi|kosodate|kenkou|kourei|sumai|sangyou|kyoiku)[^"'<> ]*(?:\/|\.html|\.xml)|sitemap\.html/i,
    limit: 650,
  },
  {
    org: '糸満市',
    base: 'https://www.city.itoman.lg.jp',
    sitemaps: [],
    seeds: ['/', '/sitemap.html', '/life/sub/3/', '/life/2/', '/life/3/', '/life/4/', '/life/5/', '/life/4/12/', '/life/4/12/67/', '/life/4/14/', '/site/kosodate/', '/soshiki/list8-1.html'],
    keep: /\/(?:life|site|soshiki|kurashi|kenko|kosodate|fukushi|sangyo|business|files|documents)[^"'<> ]*(?:\.html|\.php|\.pdf|\/)(?:$|\?)/i,
    crawl: /\/(?:life|site|soshiki|kurashi|kenko|kosodate|fukushi|sangyo|business)[^"'<> ]*(?:\/|\.html|\.xml)|sitemap\.html|rss\//i,
    limit: 650,
  },
  {
    org: '沖縄市',
    base: 'https://www.city.okinawa.okinawa.jp',
    sitemaps: ['https://www.city.okinawa.okinawa.jp/sitemap.xml'],
    seeds: ['/', '/sitemap.html', '/kurashi/index.html', '/kosodate/index.html', '/kenkou/index.html', '/sangyou/index.html', '/kurashi/download/index.html', '/k026/kosodate/kosodateshien/kodomo/index.html'],
    keep: /\/(?:kurashi|kosodate|kenkou|sangyou|sportsbunka|k\d+|contents|info|files|documents)[^"'<> ]*(?:\.html|\.php|\.pdf|\/)(?:$|\?)|sitemap(?:\.dir)?\.xml/i,
    crawl: /\/(?:kurashi|kosodate|kenkou|sangyou|sportsbunka|k\d+|contents|info)[^"'<> ]*(?:\/|\.html|\.xml)|sitemap(?:\.dir)?\.xml|sitemap\.html/i,
    limit: 650,
  },
  {
    org: '豊見城市',
    base: 'https://www.city.tomigusuku.lg.jp',
    sitemaps: ['https://www.city.tomigusuku.lg.jp/sitemap.xml'],
    seeds: ['/', '/sitemap.html', '/kurashi_tetsuzuki/index.html', '/iryo_kenko_fukushi/index.html', '/kosodate_kyoiku/index.html', '/shigoto_sangyo/index.html', '/life_vent/kosodate/index.html', '/life_vent/kyoiku/index.html', '/life_vent/hikkoshi_sumai/index.html', '/life_vent/koreisha_kaigo/index.html', '/soshiki/15/1002/gyomuannai/1/1026.html'],
    keep: /\/(?:kurashi_tetsuzuki|iryo_kenko_fukushi|kosodate_kyoiku|shigoto_sangyo|life_vent|soshiki|bosyu|event_lecture|files|documents)[^"'<> ]*(?:\.html|\.php|\.pdf|\/)(?:$|\?)|sitemap(?:\.dir)?\.xml/i,
    crawl: /\/(?:kurashi_tetsuzuki|iryo_kenko_fukushi|kosodate_kyoiku|shigoto_sangyo|life_vent|soshiki|bosyu|event_lecture)[^"'<> ]*(?:\/|\.html|\.xml)|sitemap(?:\.dir)?\.xml|sitemap\.html/i,
    limit: 650,
  },
  {
    org: 'うるま市',
    base: 'https://www.city.uruma.lg.jp',
    sitemaps: ['https://www.city.uruma.lg.jp/sitemap.xml'],
    seeds: ['/', '/sitemap.html', '/kurashitetsuzuki/index.html', '/kosodatekyouiku/index.html', '/kenkouiryoufukushi/index.html', '/sangyoushigoto/index.html', '/tetsuduki/index.php', '/kosodatekyouiku/kosodate/index.html', '/shiseijouhou/onrainservice/index.html', '/jigyosha/index.html'],
    keep: /\/(?:kurashitetsuzuki|kosodatekyouiku|kenkouiryoufukushi|sangyoushigoto|tetsuduki|shiseijouhou|jigyosha|\d{10}|files|documents)[^"'<> ]*(?:\.html|\.php|\.pdf|\/)(?:$|\?)|sitemap(?:\.dir)?\.xml/i,
    crawl: /\/(?:kurashitetsuzuki|kosodatekyouiku|kenkouiryoufukushi|sangyoushigoto|tetsuduki|shiseijouhou|jigyosha|\d{10})[^"'<> ]*(?:\/|\.html|\.xml)|sitemap(?:\.dir)?\.xml|sitemap\.html/i,
    limit: 650,
  },
];
