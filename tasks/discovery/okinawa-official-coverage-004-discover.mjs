...
const batch = 'okinawa-official-coverage-004';

const orgs = [
  {
    org: '今帰仁村',
    base: 'https://www.nakijin.jp',
    sitemaps: ['https://www.nakijin.jp/sitemap.xml'],
    seeds: ['/', '/pagtop/kakuka/kikakuzaisei/2/4834.html', '/pagtop/kakuka/', '/pagtop/kurashi/', '/pagtop/kosodate/', '/pagtop/kenko_fukushi/', '/pagtop/sangyo/', '/pagtop/sinsei/'],
    keep: /\/(?:pagtop|kakuka|kurashi|kosodate|kenko|fukushi|sangyo|shigoto|sumai|ijyu|teijyu|sinsei|download|news|files|documents)[^"'<> ]*(?:\.html|\.php|\.pdf|\/)(?:$|\?)|sitemap(?:\.dir)?\.xml/i,
    crawl: /\/(?:pagtop|kakuka|kurashi|kosodate|kenko|fukushi|sangyo|shigoto|sumai|ijyu|teijyu|sinsei|download|news)[^"'<> ]*(?:\/|\.html|\.xml)|sitemap(?:\.dir)?\.xml/i,
    limit: 650,
  },
  {
    org: '本部町',
    base: 'https://www.town.motobu.okinawa.jp',
    sitemaps: ['https://www.town.motobu.okinawa.jp/sitemap.xml'],
    seeds: ['/', '/sitemap.html', '/soshiki/', '/soshiki/kyouiku/', '/soshiki/kikakusyoukou/', '/soshiki/jyuminka/', '/soshiki/fukushika/', '/soshiki/kenkou/', '/soshiki/nougyou/', '/kurashi/', '/kosodate/', '/sangyo/'],
    keep: /\/(?:doc|soshiki|kurashi|kosodate|kenkou|fukushi|kyouiku|kikakusyoukou|jyuminka|nougyou|kensetuka|shigoto|sangyo|sumai|ijyu|download|files|documents)[^"'<> ]*(?:\.html|\.php|\.pdf|\/)(?:$|\?)|sitemap(?:\.dir)?\.xml/i,
    crawl: /\/(?:doc|soshiki|kurashi|kosodate|kenkou|fukushi|kyouiku|kikakusyoukou|jyuminka|nougyou|kensetuka|shigoto|sangyo|sumai|ijyu|download)[^"'<> ]*(?:\/|\.html|\.xml)|sitemap(?:\.dir)?\.xml|sitemap\.html/i,
    limit: 650,
  },
  {
    org: '恩納村',
    base: 'https://www.vill.onna.okinawa.jp',
    sitemaps: [],
    seeds: ['/', '/sitemap/', '/kurashi/', '/kenkou_fukushi/', '/kosodate_kyoiku/', '/sangyo_shigoto/', '/ijyu_teijyu/', '/download/', '/topics/'],
    keep: /\/(?:kurashi|kenkou|fukushi|kosodate|kyoiku|sangyo|shigoto|ijyu|teijyu|sumai|download|topics|life|business|welfare|files|documents)[^"'<> ]*(?:\.html|\.php|\.pdf|\/)(?:$|\?)/i,
    crawl: /\/(?:kurashi|kenkou|fukushi|kosodate|kyoiku|sangyo|shigoto|ijyu|teijyu|sumai|download|topics|life|business|welfare)[^"'<> ]*(?:\/|\.html|\.xml)|sitemap\//i,
    limit: 650,
  },
  {
    org: '宜野座村',
    base: 'https://www.vill.ginoza.okinawa.jp',
    sitemaps: ['https://www.vill.ginoza.okinawa.jp/sitemap.xml'],
    seeds: ['/', '/sitemap.html', '/kurashi/index.html', '/kenko-fukushi/index.html', '/kosodate-kyoiku/index.html', '/shigoto-sangyo/index.html', '/soshiki/index.html', '/kyoiku/index.html', '/shinseishodownload/index.html'],
    keep: /\/(?:kurashi|kenko-fukushi|kosodate-kyoiku|shigoto-sangyo|soshiki|kyoiku|shinseishodownload|boshu|oshirase|lifescene|files|documents)[^"'<> ]*(?:\.html|\.php|\.pdf|\/)(?:$|\?)|sitemap(?:\.dir)?\.xml/i,
    crawl: /\/(?:kurashi|kenko-fukushi|kosodate-kyoiku|shigoto-sangyo|soshiki|kyoiku|shinseishodownload|boshu|oshirase|lifescene)[^"'<> ]*(?:\/|\.html|\.xml)|sitemap(?:\.dir)?\.xml|sitemap\.html/i,
    limit: 650,
  },
  {
    org: '金武町',
    base: 'https://www.town.kin.okinawa.jp',
    sitemaps: ['https://www.town.kin.okinawa.jp/sitemap.xml'],
    seeds: ['/', '/sitemap.html', '/kurashi_tetsuzuki/index.html', '/iryo_kenko_fukushi/index.html', '/kosodate_kyoiku/index.html', '/shigoto_sangyo/index.html', '/soshiki/index.html', '/lifescene/kosodate/index.html', '/lifescene/koreikaigo/index.html', '/shinseishodownload/index.html'],
    keep: /\/(?:kurashi_tetsuzuki|iryo_kenko_fukushi|kosodate_kyoiku|shigoto_sangyo|soshiki|lifescene|shinseishodownload|boshu|oshirase|files|documents)[^"'<> ]*(?:\.html|\.php|\.pdf|\/)(?:$|\?)|sitemap(?:\.dir)?\.xml/i,
    crawl: /\/(?:kurashi_tetsuzuki|iryo_kenko_fukushi|kosodate_kyoiku|shigoto_sangyo|soshiki|lifescene|shinseishodownload|boshu|oshirase)[^"'<> ]*(?:\/|\.html|\.xml)|sitemap(?:\.dir)?\.xml|sitemap\.html/i,
    limit: 650,
  },
];
