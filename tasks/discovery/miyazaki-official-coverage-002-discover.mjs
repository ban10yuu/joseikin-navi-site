...
const batch = 'miyazaki-official-coverage-002';

const orgs = [
  {
    org: '小林市',
    base: 'https://www.city.kobayashi.lg.jp',
    sitemaps: ['https://www.city.kobayashi.lg.jp/sitemap.xml'],
    seeds: [
      '/',
      '/kurashi_tetsuzuki/',
      '/kosodate_kyoiku/',
      ...
      '/shigoto_sangyo/',
      '/soshikikarasagasu/',
      '/kurashi_tetsuzuki/iju_teiju/',
      '/kurashi_tetsuzuki/sumai/',
      '/kosodate_kyoiku/jidofukushi_hitorioyafukushi/',
      '/iryo_kenko_fukushi/fukushi/',
      '/shigoto_sangyo/noringyo/',
    ],
    keep: /\/(?:kurashi_tetsuzuki|kosodate_kyoiku|iryo_kenko_fukushi|shigoto_sangyo|soshikikarasagasu|boshu|material)[^"'<> ]*(?:\.html|\.pdf|\/)(?:$|\?)/i,
    crawl: /\/(?:kurashi_tetsuzuki|kosodate_kyoiku|iryo_kenko_fukushi|shigoto_sangyo|soshikikarasagasu|boshu)(?:\/|\.html|$)/i,
    limit: 720,
  },
  {
    org: '日向市',
    base: 'https://www.hyugacity.jp',
    sitemaps: [],
    seeds: ['/', '/sitemap.html', '/sp/', '/display.php?cont=100000000000', '/display.php?cont=100100000000', '/display.php?cont=100200000000', '/display.php?cont=100300000000', '/display.php?cont=100400000000'],
    keep: /\/(?:display\.php|sitemap\.html|sp\/)[^"'<> ]*(?:$|\?)/i,
    crawl: /\/(?:display\.php|sitemap\.html|sp\/)(?:$|\?)/i,
    limit: 760,
  },
  {
    org: '串間市',
    base: 'https://www.city.kushima.lg.jp',
    sitemaps: [],
    seeds: ['/', '/main/', '/main/city/', '/main/health/', '/main/education/', '/main/business/', '/main/living/', '/main/disaster/', '/main/city/iju.html', '/main/business/index.html'],
    keep: /\/(?:main|enjoy|ijyuteijyu|mynumbercard_point)[^"'<> ]*(?:\.html|\.pdf|\/)(?:$|\?)/i,
    crawl: /\/(?:main|enjoy)(?:\/|\.html|$)/i,
    limit: 700,
  },
  {
    org: '西都市',
    base: 'https://www.city.saito.lg.jp',
    sitemaps: ['https://www.city.saito.lg.jp/sitemap.xml'],
    seeds: ['/', '/kurashi/', '/kurashi/hojokin/', '/kenko_kyoiku/', '/sangyo/', '/shiseigyosei/', '/organization/', '/kurashi/jutaku/', '/kurashi/ijuteiju/', '/kenko_kyoiku/iryoseido/', '/sangyo/shoko/'],
    keep: /\/(?:kurashi|kenko_kyoiku|sangyo|shiseigyosei|organization|archive|common)[^"'<> ]*(?:\.html|\.pdf|\/)(?:$|\?)/i,
    crawl: /\/(?:kurashi|kenko_kyoiku|sangyo|shiseigyosei|organization)(?:\/|\.html|$)/i,
    limit: 720,
  },
  {
    org: 'えびの市',
    base: 'https://www.city.ebino.lg.jp',
    sitemaps: ['https://www.city.ebino.lg.jp/sitemap.xml'],
    seeds: ['/', '/josei_list.html', '/kurashi_tetsuduki/', '/kenko_fukushi/', '/kosodate_kyoiku/', '/sangyo_business/', '/life_scene/', '/soshiki/', '/kanko/iju_teiju/', '/sangyo_business/sangyoshinko/'],
    keep: /\/(?:kurashi_tetsuduki|kenko_fukushi|kosodate_kyoiku|sangyo_business|life_scene|soshiki|kanko|josei_list|material)[^"'<> ]*(?:\.html|\.pdf|\/)(?:$|\?)/i,
    crawl: /\/(?:kurashi_tetsuduki|kenko_fukushi|kosodate_kyoiku|sangyo_business|life_scene|soshiki|kanko)(?:\/|\.html|$)/i,
    limit: 720,
  },
];
...
function scoreCandidate(title, text, url) {
  ...
  if (/\/(?:soshiki|organization|kurashi|kenko|kosodate|sangyo|display\.php|main)\/|20\d{2}|\/\d+\.html|cont=\d+/.test(url)) score += 2;
