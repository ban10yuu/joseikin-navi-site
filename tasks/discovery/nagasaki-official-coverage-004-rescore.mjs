...
const batch = 'nagasaki-official-coverage-004';
const outFile = `tasks/discovery/${batch}-rescored-candidates.json`;

const municipalities = [
  { org: '東彼杵町', base: 'https://www.town.higashisonogi.lg.jp', seeds: ['/', '/index.html', '/kurashi/', '/kosodate/', '/kenko_fukushi/', '/sangyo/', '/sumai/', '/soshiki/'], mode: 'cms', max: 220 },
  { org: '川棚町', base: 'https://www.kawatana.jp', seeds: ['/', '/index.html', '/kurashi/', '/kosodate/', '/kenko_fukushi/', '/sangyo/', '/sumai/', '/soshiki/'], mode: 'cms', max: 220 },
  { org: '波佐見町', base: 'https://www.town.hasami.lg.jp', seeds: ['/', '/index.html', '/kurashi/', '/kosodate/', '/kenko_fukushi/', '/sangyo/', '/sumai/', '/soshiki/'], mode: 'cms', max: 220 },
  { org: '小値賀町', base: 'https://www.town.ojika.lg.jp', seeds: ['/', '/index.html', '/kurashi/', '/kosodate/', '/kenko_fukushi/', '/sangyo/', '/sumai/', '/soshiki/'], mode: 'cms', max: 220 },
  { org: '佐々町', base: 'https://www.sazacho-nagasaki.jp', seeds: ['/', '/index.html', '/kurashi/', '/kosodate/', '/kenko_fukushi/', '/sangyo/', '/sumai/', '/soshiki/'], mode: 'cms', max: 220 },
];
