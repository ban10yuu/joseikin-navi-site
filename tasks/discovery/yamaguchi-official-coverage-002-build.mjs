...
const { selections } = JSON.parse(fs.readFileSync('tasks/discovery/yamaguchi-official-coverage-002-selections.json','utf8'));
...
fs.writeFileSync(outBase+'-ts-snippet.ts',`const yamaguchiOfficial002Grants: Array<{
  slug: string;
  title: string;
  organization: string;
  maxAmount: string;
