...
const batch = 'kagoshima-official-coverage-008';

const orgs = [
  {
    org: '瀬戸内町',
    base: 'https://www.town.setouchi.lg.jp',
    sitemaps: ['https://www.town.setouchi.lg.jp/sitemap.xml'],
    seeds: ['/', '/sitemap.html', '/cho/kurashi/index.html', '/cho/kenko/index.html', '/cho/kyoiku/index.html', '/cho/sangyo/index.html', '/cho/kurashi/sumai/index.html', '/cho/kenko/kenko/index1.html', '/cho/kenko/fukushi/index.html', '/cho/kenko/kosodate/index.html', '/cho/kyoiku/kyoiku/index.html', '/cho/sangyo/sangyo/index.html', '/cho/sangyo/suisangyo/index.html', '/kan/iju/index.html'],
    keep: /\/(?:cho|joho|kan|kikaku|hoken|fukushi|kyoiku|sangyo|suido|nougyo|suisan|files|documents)[^"'<> ]*(?:\.html|\.php|\.pdf|\/)(?:$|\?)|sitemap(?:\.dir)?\.xml/i,
    crawl: /\/(?:cho|joho|kan|kikaku|hoken|fukushi|kyoiku|sangyo|suido|nougyo|suisan)[^"'<> ]*(?:\/|\.html|\.xml)|sitemap(?:\.dir)?\.xml|sitemap\.html/i,
    limit: 650,
  },
  {
    org: '龍郷町',
    base: 'https://www.town.tatsugo.lg.jp',
    sitemaps: [],
    seeds: ['/', '/kikakukanko/sangyo/index.html', '/kikakukanko/kurashi/tetsuzuki/index.html', '/kikakukanko/kurashi/kenko/index.html', '/kikakukanko/sangyo/shokogyo/index.html', '/kikakukanko/sangyo/nogyo/index.html', '/kikakukanko/sangyo/ringyo/index.html', '/kikakukanko/chose/kakuka/sinseisho.html', '/kikakukanko/kurashi/akiyafeaa.html'],
    keep: /\/(?:kikakukanko|seikatsu|hokenfukushi|kyoiku|nougyo|sangyo|kurashi|event|files|documents)[^"'<> ]*(?:\.html|\.php|\.pdf|\/)(?:$|\?)|\/(?:chumoku|shinchaku)\.xml/i,
    crawl: /\/(?:kikakukanko|seikatsu|hokenfukushi|kyoiku|nougyo|sangyo|kurashi|event)[^"'<> ]*(?:\/|\.html|\.xml)|(?:chumoku|shinchaku)\.xml/i,
    limit: 650,
  },
  {
    org: '喜界町',
    base: 'https://www.town.kikai.lg.jp',
    sitemaps: [],
    seeds: ['/', '/sitemap.html', '/densan/kanko-iju/index.html', '/densan/sangyo/index.html', '/densan/shinse-todokede.html', '/densan/hikkoshi-sumai.html', '/densan/kosodate-kenko.html'],
    keep: /\/(?:densan|hokenfukushi|kyoiku|sangyo|kanko|iju|kurashi|files|documents)[^"'<> ]*(?:\.html|\.php|\.pdf|\/)(?:$|\?)|\/(?:chumoku|shinchaku)\.xml/i,
    crawl: /\/(?:densan|hokenfukushi|kyoiku|sangyo|kanko|iju|kurashi)[^"'<> ]*(?:\/|\.html|\.xml)|sitemap\.html|(?:chumoku|shinchaku)\.xml/i,
    limit: 650,
  },
  {
    org: '徳之島町',
    base: 'https://www.tokunoshima-town.org',
    sitemaps: [],
    seeds: ['/', '/sitemap.html', '/kurashi/', '/kosodate/index.html', '/kurashi/kenko/index.html', '/kurashi/sangyo/index.html', '/kurashi/iju/index.html', '/kurashi/sumai/index.html', '/kurashi/fukushi/index.html', '/kurashi/kyoiku/index.html'],
    keep: /\/(?:kurashi|kosodate|kenko|fukushi|sangyo|iju|sumai|kyoiku|chosei|shigoto|files|documents)[^"'<> ]*(?:\.html|\.php|\.pdf|\/)(?:$|\?)|sitemap\.html/i,
    crawl: /\/(?:kurashi|kosodate|kenko|fukushi|sangyo|iju|sumai|kyoiku|chosei|shigoto)[^"'<> ]*(?:\/|\.html|\.xml)|sitemap\.html/i,
    limit: 650,
  },
  {
    org: '天城町',
    base: 'https://www.town.amagi.lg.jp',
    sitemaps: [],
    seeds: ['/', '/sitemap/', '/kurashi/', '/kurashi/iju/', '/kurashi/iju/iju-support/', '/kurashi/gomi/hojo/', '/kosodate/', '/kosodate/shien/teate/', '/kosodate/ninshin/', '/kosodate/iryo/', '/kosodate/school/shogakukin/', '/kenko/', '/kenko/iryo/josei/', '/kenko/fukushi/', '/jigyo/', '/jigyo/jigyo/sangyoshinko/', '/chosei/shisaku/teiju/', '/chosei/chiiki/kokyokukan/', '/application-form/', '/attention/'],
    keep: /\/(?:kurashi|kosodate|kenko|jigyo|chosei|kanko|oshirase|attention|application-form|files|documents)[^"'<> ]*(?:\.html|\.php|\.pdf|\/)(?:$|\?)/i,
    crawl: /\/(?:kurashi|kosodate|kenko|jigyo|chosei|kanko|oshirase|attention|application-form)[^"'<> ]*(?:\/|\.html|\.xml)|sitemap\/?/i,
    limit: 650,
  },
];
