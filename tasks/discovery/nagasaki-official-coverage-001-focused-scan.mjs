...
const batch = 'nagasaki-official-coverage-001';
const municipalities = [
  { org: '長崎市', base: 'https://www.city.nagasaki.lg.jp', seeds: ['/', '/life/1/', '/life/2/', '/life/3/', '/life/4/', '/life/5/', '/life/6/', '/site/ijyu/', '/site/kosodate/'], max: 300 },
  { org: '佐世保市', base: 'https://www.city.sasebo.lg.jp', seeds: ['/', '/index.html', '/kodomomirai/kodosei/kosodate-portal.html', '/benrityo/', '/hokenhukusi/', '/kankyo/', '/sangyo/'], max: 300 },
  { org: '島原市', base: 'https://www.city.shimabara.lg.jp', seeds: ['/', '/hpkiji/pub/List.aspx?c_id=3&class_set_id=1&class_id=112', '/page16865.html', '/page3327.html', '/new_list/pub/Default.aspx?c_id=1'], max: 300 },
  { org: '諫早市', base: 'https://www.city.isahaya.nagasaki.jp', seeds: ['/', '/life/1/', '/life/2/', '/life/3/', '/site/colorful/', '/site/i-iju/', '/site/sinseisho/', '/soshiki/'], max: 300 },
  { org: '大村市', base: 'https://www.city.omura.nagasaki.jp', seeds: ['/', '/index.html', '/kurashi/index.html', '/kenko/index.html', '/kyoiku/index.html', '/machi/index.html', '/shise/index.html'], max: 300 },
];
