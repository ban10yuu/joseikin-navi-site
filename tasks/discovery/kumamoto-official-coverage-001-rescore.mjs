...
const municipalities = [
  { org: '熊本市', base: 'https://www.city.kumamoto.jp', seeds: ['https://www.city.kumamoto.jp/dynamic/sitemap.ashx'], mode: 'sitemap', max: 180 },
  { org: '八代市', base: 'https://www.city.yatsushiro.lg.jp', seeds: ['https://www.city.yatsushiro.lg.jp/dynamic/sitemap.ashx'], mode: 'sitemap', max: 180 },
  { org: '人吉市', base: 'https://www.city.hitoyoshi.lg.jp', seeds: ['https://www.city.hitoyoshi.lg.jp/sitemap.xml'], mode: 'sitemap', max: 180 },
  { org: '荒尾市', base: 'https://www.city.arao.lg.jp', seeds: ['/', '/kurashi/', '/kenko/', '/kosodate/', '/sangyo/', '/shigoto/', '/ijuteiju-tokusetsu/', '/riyoshabetsu/kodomo.html', '/riyoshabetsu/jigyosha.html'], mode: 'cms', max: 180 },
  { org: '水俣市', base: 'https://www.city.minamata.lg.jp', seeds: ['https://www.city.minamata.lg.jp/dynamic/sitemap.ashx'], mode: 'sitemap', max: 180 },
];
