...
const batch = 'kagawa-official-coverage-004';
const outFile = `tasks/discovery/${batch}-rescored-candidates.json`;

const municipalities = [
  { org: '多度津町', base: 'https://www.town.tadotsu.kagawa.jp', seeds: ['/', '/kurashi/', '/life/', '/soshiki/', '/site/', '/category/'], mode: 'cms', max: 800 },
  { org: 'まんのう町', base: 'https://www.town.manno.lg.jp', seeds: ['/', '/life/', '/kurashi/', '/soshiki/', '/site/', '/category/'], mode: 'cms', max: 800 },
];
