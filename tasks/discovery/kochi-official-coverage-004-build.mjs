...
const { selections } = JSON.parse(fs.readFileSync('tasks/discovery/kochi-official-coverage-004-selections.json','utf8'));
const outBase='tasks/discovery/kochi-official-coverage-004';
