...
const { selections } = JSON.parse(fs.readFileSync('tasks/discovery/fukuoka-official-coverage-009-selections.json','utf8'));
const outBase='tasks/discovery/fukuoka-official-coverage-009';
...
fs.writeFileSync(outBase+'-ts-snippet.ts',`const fukuokaOfficial009Grants: Array<{
  slug: string;
  title: string;
  organization: string;
  maxAmount: string;
