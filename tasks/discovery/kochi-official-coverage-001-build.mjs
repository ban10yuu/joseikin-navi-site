...
const { selections } = JSON.parse(fs.readFileSync('tasks/discovery/kochi-official-coverage-001-selections.json','utf8'));
const outBase='tasks/discovery/kochi-official-coverage-001';
...
fs.writeFileSync(outBase+'-ts-snippet.ts',`const kochiOfficial001Grants: Array<{
  slug: string;
  title: string;
  organization: string;
  maxAmount: string;
