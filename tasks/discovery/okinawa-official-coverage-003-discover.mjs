...
const batch = 'okinawa-official-coverage-003';

const orgs = [
  {
    org: '宮古島市',
    base: 'https://www.city.miyakojima.lg.jp',
    sitemaps: ['https://www.city.miyakojima.lg.jp/sitemap.xml'],
    seeds: ['/', '/kurashi/index.html', '/jigyousya/index.html', '/kurashi/kenkou/index.html', '/kurashi/kenkou/syougaihukushi/index.html', '/kurashi/kodomo/index.html', '/kurashi/kodomo/kosodate/index.html', '/kurashi/kodomo/jidou/index.html', '/kurashi/kodomo/kyouiku/index.html', '/kurashi/download/index.html'],
    keep: /\/(?:kurashi|jigyousya|soshiki|kenkou|kodomo|kokumin|zeikin|download|oshirase|files|documents)[^"'<> ]*(?:\.html|\.php|\.pdf|\/)(?:$|\?)|sitemap(?:\.dir)?\.xml/i,
    crawl: /\/(?:kurashi|jigyousya|soshiki|kenkou|kodomo|kokumin|zeikin|download|oshirase)[^"'<> ]*(?:\/|\.html|\.xml)|sitemap(?:\.dir)?\.xml/i,
    limit: 650,
  },
  {
    org: '南城市',
    base: 'https://www.city.nanjo.okinawa.jp',
    sitemaps: [],
    seeds: ['/', '/sitemap/', '/kurashi/', '/kurashi/kenkou_fukushi/', '/kurashi/jyosei_hojyokin/', '/kosodate/', '/kosodate/kosodate/', '/kosodate/kosodate/jyosei/', '/kosodate/gakkou_kyouiku/', '/jigyosha/', '/jigyosha/shinsei/'],
    keep: /\/(?:kurashi|kosodate|jigyosha|lifestage|shinsei|jyosei_hojyokin|kenkou_fukushi|zei_hoken_nenkin|sumai|files|documents)[^"'<> ]*(?:\.html|\.php|\.pdf|\/)(?:$|\?)/i,
    crawl: /\/(?:kurashi|kosodate|jigyosha|lifestage|shinsei|jyosei_hojyokin|kenkou_fukushi|zei_hoken_nenkin|sumai)[^"'<> ]*(?:\/|\.html|\.xml)|sitemap\//i,
    limit: 650,
  },
  {
    org: '国頭村',
    base: 'https://www.vill.kunigami.okinawa.jp',
    sitemaps: [],
    seeds: ['/', '/living/', '/jyuminfukushi/', '/kosodate_kyouiku/', '/teijyuusien/', '/permanent_residence/', '/emigration/', '/yousiki/'],
    keep: /\/(?:living|jyuminfukushi|kosodate_kyouiku|teijyuusien|permanent_residence|emigration|yousiki|k_[^\/]+|i_[^\/]+|koubo_boshu|wp-content|files|documents)[^"'<> ]*(?:\.html|\.php|\.pdf|\/)(?:$|\?)/i,
    crawl: /\/(?:living|jyuminfukushi|kosodate_kyouiku|teijyuusien|permanent_residence|emigration|yousiki|k_[^\/]+|i_[^\/]+|koubo_boshu)[^"'<> ]*(?:\/|\.html|\.xml)/i,
    limit: 650,
  },
  {
    org: '大宜味村',
    base: 'https://www.vill.ogimi.okinawa.jp',
    sitemaps: ['https://www.vill.ogimi.okinawa.jp/sitemap.xml'],
    seeds: ['/', '/sitemap.html', '/kurashi/index.html', '/iryo_kenko_fukushi/index.html', '/kosodate_kyoiku/index.html', '/shigoto_sangyo/index.html', '/soshiki/fukusihoken/gyomu/seikatsu_fukushi/211.html', '/soshiki/kikaku_kanko/gyomu/sumai/ijyuuteijyuu/index.html', '/sitekanri/210.html'],
    keep: /\/(?:kurashi|iryo_kenko_fukushi|kosodate_kyoiku|shigoto_sangyo|soshiki|sitekanri|files|documents)[^"'<> ]*(?:\.html|\.php|\.pdf|\/)(?:$|\?)|sitemap(?:\.dir)?\.xml/i,
    crawl: /\/(?:kurashi|iryo_kenko_fukushi|kosodate_kyoiku|shigoto_sangyo|soshiki|sitekanri)[^"'<> ]*(?:\/|\.html|\.xml)|sitemap(?:\.dir)?\.xml|sitemap\.html/i,
    limit: 650,
  },
  {
    org: '東村',
    base: 'https://www.vill.higashi.okinawa.jp',
    sitemaps: ['https://www.vill.higashi.okinawa.jp/sitemap.xml'],
    seeds: ['/', '/sitemap.html', '/kurashi_tetsuzuki/index.html', '/kosodate_kyoiku/index.html', '/iryo_kenko_fukushi/index.html', '/sangyo_shigoto/index.html', '/higashison_life/index.html', '/kosodate_kyoiku/kosodate/index.html', '/shinseishodownload/index.html', '/boshuu/index.html'],
    keep: /\/(?:kurashi_tetsuzuki|kosodate_kyoiku|iryo_kenko_fukushi|sangyo_shigoto|higashison_life|shinseishodownload|boshuu|oshirase|soshikikarasagasu|lifescene|files|documents)[^"'<> ]*(?:\.html|\.php|\.pdf|\/)(?:$|\?)|sitemap(?:\.dir)?\.xml/i,
    crawl: /\/(?:kurashi_tetsuzuki|kosodate_kyoiku|iryo_kenko_fukushi|sangyo_shigoto|higashison_life|shinseishodownload|boshuu|oshirase|soshikikarasagasu|lifescene)[^"'<> ]*(?:\/|\.html|\.xml)|sitemap(?:\.dir)?\.xml|sitemap\.html/i,
    limit: 650,
  },
];
