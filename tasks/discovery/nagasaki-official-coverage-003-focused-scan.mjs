...
const municipalities = [
  { org: '西海市', base: 'https://www.city.saikai.nagasaki.jp', seeds: ['/', '/index.html', '/soshiki/', '/kurashi/', '/kurashi/kosodate/', '/kurashi/kenko_fukushi/', '/kurashi/sumai/', '/shigoto_sangyo/', '/kanko_bunka_sports/'], max: 300 },
  { org: '雲仙市', base: 'https://www.city.unzen.nagasaki.jp', seeds: ['/', '/index.html', '/list00136.html', '/list00137.html', '/list00138.html', '/list00139.html', '/list00140.html', '/list00141.html', '/list00142.html', '/list00143.html'], max: 300 },
  { org: '南島原市', base: 'https://www.city.minamishimabara.lg.jp', seeds: ['/', '/index.html', '/list00001.html', '/list00002.html', '/list00003.html', '/list00004.html', '/list00005.html', '/list00006.html', '/list00007.html', '/kiji003/index.html'], max: 300 },
  { org: '長与町', base: 'https://webtown.nagayo.jp', seeds: ['/', '/index.html', '/list00001.html', '/list00002.html', '/list00003.html', '/list00004.html', '/list00005.html', '/list00006.html', '/soshiki/'], max: 300 },
  { org: '時津町', base: 'https://www.town.togitsu.nagasaki.jp', seeds: ['/', '/index.html', '/kurashi/', '/kosodate/', '/kenko_fukushi/', '/sangyo/', '/sumai/', '/soshiki/'], max: 300 },
];
