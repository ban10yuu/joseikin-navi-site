...
const { selections } = JSON.parse(fs.readFileSync('tasks/discovery/kumamoto-official-coverage-003-selections.json','utf8'));
const outBase='tasks/discovery/kumamoto-official-coverage-003';
...
fs.writeFileSync(outBase+'-ts-snippet.ts',`const kumamotoOfficial003Grants: Array<{
  slug: string;
  title: string;
  organization: string;
  maxAmount: string;
