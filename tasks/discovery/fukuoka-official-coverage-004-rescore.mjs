...
const batch = 'fukuoka-official-coverage-004';
const outFile = `tasks/discovery/${batch}-rescored-candidates.json`;

const municipalities = [
  { org: '筑紫野市', base: 'https://www.city.chikushino.fukuoka.jp', seeds: ['/', '/soshiki/', '/kurashi/', '/kosodate/', '/kenko/', '/sangyo/', '/kyoiku/', '/shisei/', '/life/'], mode: 'cms', max: 260 },
  { org: '春日市', base: 'https://www.city.kasuga.fukuoka.jp', seeds: ['/', '/kurashi/', '/kosodate/', '/kenko/', '/sangyo/', '/kyoiku/', '/shisei/', '/soshiki/'], mode: 'cms', max: 260 },
  { org: '大野城市', base: 'https://www.city.onojo.fukuoka.jp', seeds: ['/', '/soshiki/', '/kurashi/', '/kosodate/', '/kenko/', '/sangyo/', '/kyoiku/', '/shisei/'], mode: 'cms', max: 260 },
  { org: '宗像市', base: 'https://www.city.munakata.lg.jp', seeds: ['/', '/kurashi/', '/kosodate/', '/kenko/', '/sangyo/', '/kyoiku/', '/shisei/', '/soshiki/'], mode: 'cms', max: 260 },
  { org: '太宰府市', base: 'https://www.city.dazaifu.lg.jp', seeds: ['/', '/soshiki/', '/kurashi/', '/kosodate/', '/kenko/', '/sangyo/', '/kyoiku/', '/shisei/'], mode: 'cms', max: 260 },
];
