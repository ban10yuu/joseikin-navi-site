...
const batch = 'kumamoto-official-coverage-001';
const keywords = ['補助金', '助成金', '給付金', '支援金', '手当', '医療費助成', '就学援助', '奨学金', '貸付', '減免', '移住', '空き家', '耐震'];
const orgs = [
  {
    org: '熊本市',
    base: 'https://www.city.kumamoto.jp',
    search: (q) => `https://www.city.kumamoto.jp/dynamic/search/pub/Default.aspx?c_id=2&q=${encodeURIComponent(q)}`,
    keep: /\/kiji\d+\/index\.html|\/dynamic\/hpkiji\/pub\/Detail\.aspx/i,
  },
  {
    org: '八代市',
    base: 'https://www.city.yatsushiro.lg.jp',
    search: (q) => `https://www.city.yatsushiro.lg.jp/dynamic/search/pub/default.aspx?c_id=2&q=${encodeURIComponent(q)}`,
    keep: /\/kiji\d+\/index\.html|\/ijyu\/kiji\d+\/index\.html|\/reiki\/reiki_honbun\//i,
  },
  {
    org: '人吉市',
    base: 'https://www.city.hitoyoshi.lg.jp',
    search: (q) => `https://www.city.hitoyoshi.lg.jp/search?q=${encodeURIComponent(q)}`,
    keep: /\/(?:kurashi|kosodate_kyoiku|fukushi_kaigo|jigyosha|shisei)\/.+\/\d+|\/\d{4,}/i,
  },
  {
    org: '荒尾市',
    base: 'https://www.city.arao.lg.jp',
    search: null,
    seeds: ['/', '/kurashi/', '/kenko/', '/kosodate/', '/sangyo/', '/shigoto/', '/ijuteiju-tokusetsu/', '/riyoshabetsu/kodomo.html', '/riyoshabetsu/jigyosha.html'],
    keep: /\/(?:kurashi|kenko|kosodate|sangyo|shigoto|oshirase|ijuteiju-tokusetsu|0)\/.*(?:\.html|\/$)|\/\d+\.html/i,
  },
  {
    org: '水俣市',
    base: 'https://www.city.minamata.lg.jp',
    search: (q) => `https://www.city.minamata.lg.jp/dynamic/search/pub/default.aspx?c_id=2&q=${encodeURIComponent(q)}`,
    keep: /\/kiji\d+\/index\.html|\/dynamic\/hpkiji\/pub\/Detail\.aspx/i,
  },
];
