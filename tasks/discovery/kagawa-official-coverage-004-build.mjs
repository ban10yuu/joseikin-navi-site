...
const { selections } = JSON.parse(fs.readFileSync('tasks/discovery/kagawa-official-coverage-004-selections.json','utf8'));
const outBase='tasks/discovery/kagawa-official-coverage-004';
...
fs.writeFileSync(outBase+'-ts-snippet.ts',`const kagawaOfficial004Grants: Array<{
  slug: string;
  title: string;
  organization: string;
  maxAmount: string;
