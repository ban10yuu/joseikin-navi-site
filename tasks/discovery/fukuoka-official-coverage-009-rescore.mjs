...
const batch = 'fukuoka-official-coverage-009';
const outFile = `tasks/discovery/${batch}-rescored-candidates.json`;

const municipalities = [
  { org: '小竹町', base: 'https://town.kotake.lg.jp', seeds: ['/', '/soshiki/', '/kurashi/', '/kosodate/', '/kenko/', '/fukushi/', '/sangyo/', '/kyoiku/', '/sumai/'], mode: 'cms', max: 140 },
  { org: '鞍手町', base: 'https://www.town.kurate.lg.jp', seeds: ['/', '/kurashi/', '/kosodate/', '/kenko/', '/fukushi/', '/sangyo/', '/kyoiku/', '/sumai/', '/soshiki/'], mode: 'cms', max: 140 },
  { org: '桂川町', base: 'https://www.town.keisen.fukuoka.jp', seeds: ['/', '/soshiki/', '/life/', '/kurashi/', '/kosodate/', '/kenko/', '/fukushi/', '/sangyo/', '/kyoiku/'], mode: 'cms', max: 140 },
  { org: '筑前町', base: 'https://www.town.chikuzen.fukuoka.jp', seeds: ['/', '/soshiki/', '/life/', '/kurashi/', '/kosodate/', '/kenko/', '/fukushi/', '/sangyo/', '/kyoiku/'], mode: 'cms', max: 140 },
  { org: '東峰村', base: 'https://vill.toho-info.com', seeds: ['/', '/administration/', '/life/', '/kurashi/', '/kosodate/', '/kenko/', '/fukushi/', '/sangyo/', '/kyoiku/'], mode: 'cms', max: 140 },
];
