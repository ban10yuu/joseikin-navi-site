...
const { selections } = JSON.parse(fs.readFileSync('tasks/discovery/hiroshima-official-coverage-001-selections.json','utf8'));
const outBase='tasks/discovery/hiroshima-official-coverage-001';
...
fs.writeFileSync(outBase+'-ts-snippet.ts',`const hiroshimaOfficial001Grants: Array<{
  slug: string;
  title: string;
  organization: string;
  maxAmount: string;
