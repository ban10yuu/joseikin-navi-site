...
const batch = 'kagoshima-official-coverage-007';

const orgs = [
  {
    org: '中種子町',
    base: 'https://town.nakatane.kagoshima.jp',
    sitemaps: [],
    seeds: ['/', '/koho/sitemap.html', '/koho/kurashi/index.html', '/koho/kenko-fukushi/index.html', '/koho/kyoiku-bunka/index.html', '/koho/shussan-ikuji.html', '/koho/iryo-fukushi.html', '/koho/kyoiku.html', '/koho/shushoku.html', '/koho/shinsesho.html', '/koho/chumoku.html', '/koho/boshu.html'],
    keep: /\/(?:koho|koseki|kodomo|senter|kyouiku|kankyou|kikaku|gyousei|syoubou|tiiki|gikai|documents)[^"'<> ]*(?:\.html|\.php|\.pdf|\/)(?:$|\?)|\/(?:chumoku|boshu|shinchaku)\.xml/i,
    crawl: /\/(?:koho|koseki|kodomo|senter|kyouiku|kankyou|kikaku|gyousei|syoubou|tiiki|gikai)[^"'<> ]*(?:\/|\.html|\.xml)|sitemap\.html|(?:chumoku|boshu|shinchaku)\.xml/i,
    limit: 650,
  },
  {
    org: '南種子町',
    base: 'http://www.town.minamitane.kagoshima.jp',
    sitemaps: [],
    seeds: ['/', '/index/sitemap.html', '/life.html', '/healthcare.html', '/education.html', '/industry.html', '/life/lifestyle/marriage.html', '/life/lifestyle/ninshin.html', '/healthcare/iryouhijyosei.html', '/education/kyuusyokumusyouka.html', '/industry/etc/ijyuuteijyuusokushinnjyuutaku.html', '/industry/etc/70th-jigyohojyokin.html'],
    keep: /\/(?:life|healthcare|education|industry|disaster|publicize|townofficeinfo|institution|sightseeing|outline)[^"'<> ]*(?:\.html|\.php|\.pdf|\/)(?:$|\?)|\/rss\.xml/i,
    crawl: /\/(?:life|healthcare|education|industry|disaster|publicize|townofficeinfo|institution|sightseeing|outline)[^"'<> ]*(?:\/|\.html)|sitemap\.html|rss\.xml/i,
    limit: 650,
  },
  {
    org: '屋久島町',
    base: 'https://www.town.yakushima.kagoshima.jp',
    sitemaps: ['https://www.town.yakushima.kagoshima.jp/sitemap.xml'],
    seeds: ['/', '/sitemap.html', '/kurashi_tetsuzuki/index.html', '/iryo_kenko_fukushi/index.html', '/kosodate_kyoiku/index.html', '/jigyo/index.html', '/iju_teiju/index.html', '/kurashinobamen/kosodate/index.html', '/kurashinobamen/fukushi_kaigo/index.html', '/jigyo/shien_hojokin/index.html'],
    keep: /\/(?:kurashi_tetsuzuki|iryo_kenko_fukushi|kosodate_kyoiku|jigyo|iju_teiju|kurashinobamen|soshiki|gyosei|boshu|files|uploads)[^"'<> ]*(?:\.html|\.php|\.pdf|\/)(?:$|\?)|\/\d+\.html/i,
    crawl: /\/(?:kurashi_tetsuzuki|iryo_kenko_fukushi|kosodate_kyoiku|jigyo|iju_teiju|kurashinobamen|soshiki|gyosei)(?:\/|$)|sitemap(?:\.dir)?\.xml|sitemap\.html/i,
    limit: 650,
  },
  {
    org: '大和村',
    base: 'https://www.vill.yamato.lg.jp',
    sitemaps: [],
    seeds: ['/', '/sitemap.html', '/hpkanri/kurashi/index.html', '/hpkanri/kurashi/iju/index.html', '/kikaku/ninshin.html', '/kikaku/kekkon.html', '/kikaku/iryo.html', '/kikaku/download.html', '/kikaku/chumoku.html', '/kikaku/shinchaku.html'],
    keep: /\/(?:hpkanri|kikaku|jumin|sono|somu|kensetsu|kyoiku|kourei|hoken|kankyo|shinchaku|chumoku)[^"'<> ]*(?:\.html|\.php|\.pdf|\/)(?:$|\?)|\/(?:chumoku|shinchaku)\.xml/i,
    crawl: /\/(?:hpkanri|kikaku|jumin|sono|somu|kensetsu|kyoiku|kourei|hoken|kankyo)[^"'<> ]*(?:\/|\.html|\.xml)|sitemap\.html|(?:chumoku|shinchaku)\.xml/i,
    limit: 650,
  },
  {
    org: '宇検村',
    base: 'https://www.uken.net',
    sitemaps: ['https://www.uken.net/sitemap.xml'],
    seeds: ['/', '/home.html', '/kouhoutoukei/shinchaku.xml', '/kouhoutoukei/chumoku.xml', '/kouhoutoukei/shinsesho.html', '/kouhoutoukei/koreisha.html', '/kikakuchousei/kurashi/todokede/ritokuko/waribiki-card.html', '/kikakuchousei/muranogaiyo/furusato/murazukuri/kifukin.html'],
    keep: /\/(?:kouhoutoukei|kikakuchousei|kankyoueisei|hokenfukushi|jukyo|shokousuisan|nousei|shougaigakushu|kyouiku|files|documents)[^"'<> ]*(?:\.html|\.php|\.pdf|\/)(?:$|\?)|\/(?:chumoku|shinchaku)\.xml/i,
    crawl: /\/(?:kouhoutoukei|kikakuchousei|kankyoueisei|hokenfukushi|jukyo|shokousuisan|nousei|shougaigakushu|kyouiku)[^"'<> ]*(?:\/|\.html|\.xml)|sitemap\.xml|(?:chumoku|shinchaku)\.xml/i,
    limit: 650,
  },
];
