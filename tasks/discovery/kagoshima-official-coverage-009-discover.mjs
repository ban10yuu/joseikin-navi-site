...
const batch = 'kagoshima-official-coverage-009';

const orgs = [
  {
    org: '伊仙町',
    base: 'https://www.town.isen.kagoshima.jp',
    sitemaps: ['https://www.town.isen.kagoshima.jp/sitemap.xml'],
    seeds: ['/', '/sitemap.html', '/mirai/kenko-fukushi/index.html', '/mirai/kosodate-kyoiku/index.html', '/mirai/sangyou-sigoto/index.html', '/mirai/kurashi/tetsuzuki/index.html', '/mirai/kurashi/zekin/index.html', '/mirai/kurashi/hoken/index.html', '/mirai/kenko-fukushi/fukushi/index.html', '/mirai/kenko-fukushi/chiikiho-katsu/index.html', '/kenko/kenkouzousin.html', '/mirai/kosodate-kyoiku/ninshin-shussan/index.html', '/mirai/kosodate-kyoiku/kosodate/index.html', '/mirai/kosodate-kyoiku/kyoiku/index.html', '/mirai/sangyou-sigoto/sangyo/index.html', '/mirai/sangyou-sigoto/nogyo/index.html', '/mirai/sangyou-sigoto/suisangyo/index.html'],
    keep: /\/(?:mirai|kenko|fukushi|keizai|soumu|kikaku|cho|files|documents)[^"'<> ]*(?:\.html|\.php|\.pdf|\/)(?:$|\?)|sitemap(?:\.dir)?\.xml/i,
    crawl: /\/(?:mirai|kenko|fukushi|keizai|soumu|kikaku|cho)[^"'<> ]*(?:\/|\.html|\.xml)|sitemap(?:\.dir)?\.xml|sitemap\.html/i,
    limit: 650,
  },
  {
    org: '和泊町',
    base: 'https://www.town.wadomari.lg.jp',
    sitemaps: [],
    seeds: ['/', '/soumu/kanko/index.html', '/soumu/kurashi/shinsesho.html', '/soumu/shinchaku.html', '/hukusi/kurashi/kenko/fukushi/koresha/fukushi.html', '/kikaku/kurashi/nitiikikyojuu/tokuteikyojuusienhoujin.html'],
    keep: /\/(?:soumu|hukusi|hoken|kikaku|zeimu|kyoiku|keizai|sangyo|nougyo|kurashi|files|documents)[^"'<> ]*(?:\.html|\.php|\.pdf|\/)(?:$|\?)|\/(?:shinchaku|chumoku)\.html/i,
    crawl: /\/(?:soumu|hukusi|hoken|kikaku|zeimu|kyoiku|keizai|sangyo|nougyo|kurashi)[^"'<> ]*(?:\/|\.html|\.xml)|(?:shinchaku|chumoku)\.html/i,
    limit: 650,
  },
  {
    org: '知名町',
    base: 'https://www.town.china.lg.jp',
    sitemaps: ['https://www.town.china.lg.jp/sitemap.xml'],
    seeds: ['/', '/sitemap.html', '/kurashi/', '/kosodate-kyoiku/index.html', '/kenko-fukushi/index.html', '/shigoto-sangyo/index.html', '/guide/ninshin-shussan-kosodate/index.html', '/guide/fukushi-shogai-kaigo/index.html', '/guide/hikkoshi-sumai/index.html', '/guide/hoken-nenkin/index.html', '/event_bosyu/index.html', '/news.html'],
    keep: /\/(?:kurashi|kosodate-kyoiku|kenko-fukushi|shigoto-sangyo|guide|soshiki|event_bosyu|news|files|documents)[^"'<> ]*(?:\.html|\.php|\.pdf|\/)(?:$|\?)|sitemap(?:\.dir)?\.xml/i,
    crawl: /\/(?:kurashi|kosodate-kyoiku|kenko-fukushi|shigoto-sangyo|guide|soshiki|event_bosyu|news)[^"'<> ]*(?:\/|\.html|\.xml)|sitemap(?:\.dir)?\.xml|sitemap\.html/i,
    limit: 650,
  },
  {
    org: '与論町',
    base: 'https://www.yoron.jp',
    sitemaps: [],
    seeds: ['/', '/sitemap.html', '/list00102.html', '/list00103.html', '/list00104.html', '/list00107.html', '/list00108.html', '/list00113.html', '/list00114.html', '/list00115.html', '/list00116.html', '/list00117.html', '/list00122.html', '/list00123.html', '/list00124.html', '/list00154.html', '/list00155.html', '/list00167.html', '/list00184.html', '/list00192.html', '/kosodate/default.html', '/kyouiku/default.html'],
    keep: /\/(?:list\d+|kosodate|kyouiku|article|kiji|dynamic)[^"'<> ]*(?:\.html|\.aspx|\.php|\.pdf|\/)(?:$|\?)|sitemap\.html/i,
    crawl: /\/(?:list\d+|kosodate|kyouiku|article|kiji|dynamic)[^"'<> ]*(?:\/|\.html|\.aspx)|sitemap\.html/i,
    limit: 650,
  },
];
