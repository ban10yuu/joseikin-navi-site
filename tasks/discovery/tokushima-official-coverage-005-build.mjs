...
const { selections } = JSON.parse(fs.readFileSync('tasks/discovery/tokushima-official-coverage-005-selections.json','utf8'));
const outBase='tasks/discovery/tokushima-official-coverage-005';
...
fs.writeFileSync(outBase+'-ts-snippet.ts',`const tokushimaOfficial005Grants: Array<{
  slug: string;
  title: string;
  organization: string;
  maxAmount: string;
