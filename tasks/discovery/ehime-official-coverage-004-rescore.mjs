...
const batch = 'ehime-official-coverage-004';
const outFile = `tasks/discovery/${batch}-rescored-candidates.json`;

const municipalities = [
  { org: '久万高原町', base: 'https://www.kumakogen.jp', seeds: ['/', '/site/', '/soshiki/', '/kurashi/', '/kosodate/', '/business/', '/life/'], mode: 'cms', max: 800 },
  { org: '松前町', base: 'https://www.town.masaki.ehime.jp', seeds: ['/', '/soshiki/', '/site/', '/kurashi/', '/kosodate/', '/business/', '/life/'], mode: 'cms', max: 800 },
  { org: '砥部町', base: 'https://www.town.tobe.ehime.jp', seeds: ['/', '/soshiki/', '/site/', '/kurashi/', '/kosodate/', '/business/', '/life/'], mode: 'cms', max: 800 },
  { org: '内子町', base: 'https://www.town.uchiko.ehime.jp', seeds: ['/', '/soshiki/', '/site/', '/kurashi/', '/kosodate/', '/business/', '/life/'], mode: 'cms', max: 800 },
  { org: '伊方町', base: 'https://www.town.ikata.ehime.jp', seeds: ['/', '/soshiki/', '/site/', '/kurashi/', '/kosodate/', '/business/', '/life/'], mode: 'cms', max: 800 },
];
