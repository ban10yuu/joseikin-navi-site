...
const batch = 'kagoshima-official-coverage-003';

const orgs = [
  {
    org: '日置市',
    base: 'https://www.city.hioki.kagoshima.jp',
    sitemaps: [],
    seeds: ['/', '/kurashi/', '/kenko/', '/kosodate/', '/sangyo/', '/kyoiku/', '/ijyu/', '/shisei/'],
    keep: /\/(?:kurashi|kenko|kosodate|sangyo|kyoiku|ijyu|shisei|download|files|uploads|article)[^"'<> ]*(?:\.html|\.php|\.pdf|\/)(?:$|\?)/i,
    crawl: /\/(?:kurashi|kenko|kosodate|sangyo|kyoiku|ijyu|shisei|article)(?:\/|$)/i,
    limit: 1200,
  },
  {
    org: '曽於市',
    base: 'https://www.city.soo.kagoshima.jp',
    sitemaps: ['https://www.city.soo.kagoshima.jp/sitemap.xml'],
    seeds: ['/', '/kurashi/', '/kenko/', '/kosodate/', '/sangyo/', '/kyoiku/', '/iju/'],
    keep: /\/(?:kurashi|kenko|kosodate|sangyo|kyoiku|iju|download|files|uploads)[^"'<> ]*(?:\.html|\.php|\.pdf|\/)(?:$|\?)/i,
    crawl: /\/(?:kurashi|kenko|kosodate|sangyo|kyoiku|iju)(?:\/|$)|sitemap\.xml/i,
    limit: 1000,
  },
  {
    org: '霧島市',
    base: 'https://www.city-kirishima.jp',
    sitemaps: [],
    seeds: ['/', '/kurashi/', '/kenko/', '/kosodate/', '/sangyo/', '/kyoiku/', '/ijyu/', '/shise/'],
    keep: /\/(?:kurashi|kenko|kosodate|sangyo|kyoiku|ijyu|shise|download|files|uploads)[^"'<> ]*(?:\.html|\.php|\.pdf|\/)(?:$|\?)/i,
    crawl: /\/(?:kurashi|kenko|kosodate|sangyo|kyoiku|ijyu|shise)(?:\/|$)/i,
    limit: 1300,
  },
  {
    org: 'いちき串木野市',
    base: 'https://www.city.ichikikushikino.lg.jp',
    sitemaps: ['https://www.city.ichikikushikino.lg.jp/sitemap.xml'],
    seeds: ['/', '/kurashi/', '/kenko/', '/kosodate/', '/sangyo/', '/kyoiku/', '/ijyu/', '/shisei/'],
    keep: /\/(?:kurashi|kenko|kosodate|sangyo|kyoiku|ijyu|shisei|download|files|uploads)[^"'<> ]*(?:\.html|\.php|\.pdf|\/)(?:$|\?)/i,
    crawl: /\/(?:kurashi|kenko|kosodate|sangyo|kyoiku|ijyu|shisei)(?:\/|$)|sitemap\.xml/i,
    limit: 1000,
  },
  {
    org: '南さつま市',
    base: 'https://www.city.minamisatsuma.lg.jp',
    sitemaps: ['https://www.city.minamisatsuma.lg.jp/sitemap.xml'],
