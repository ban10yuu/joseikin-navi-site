...
const batch = 'saga-official-coverage-004';
const municipalities = [
  { org: '有田町', base: 'https://www.town.arita.lg.jp', seeds: ['/', '/main/', '/kurashi/', '/kosodate/', '/kenko/', '/shigoto/', '/kanko/'], max: 260 },
  { org: '大町町', base: 'https://www.town.omachi.lg.jp', seeds: ['/', '/kurashi/', '/kosodate/', '/kenko/', '/sangyo/', '/kanko/', '/soshiki/'], max: 260 },
  { org: '江北町', base: 'https://www.town.kouhoku.saga.jp', seeds: ['/', '/kiji0031/index.html', '/life/', '/kurashi/', '/kosodate/', '/kenko/', '/sangyo/'], max: 260 },
  { org: '白石町', base: 'https://www.town.shiroishi.lg.jp', seeds: ['/', '/jyuumin/', '/kosodate/', '/kenkou/', '/sangyou/', '/machizukuri/', '/kurashi/'], max: 260 },
  { org: '太良町', base: 'https://www.town.tara.lg.jp', seeds: ['/', '/kurashi/', '/kosodate/', '/kenko/', '/sangyo/', '/kanko/', '/soshiki/'], max: 260 },
];
