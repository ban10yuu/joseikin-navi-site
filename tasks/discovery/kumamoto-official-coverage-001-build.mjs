...
const { selections } = JSON.parse(fs.readFileSync('tasks/discovery/kumamoto-official-coverage-001-selections.json','utf8'));
const outBase='tasks/discovery/kumamoto-official-coverage-001';
...
fs.writeFileSync(outBase+'-ts-snippet.ts',`const kumamotoOfficial001Grants: Array<{
  slug: string;
  title: string;
  organization: string;
  maxAmount: string;
