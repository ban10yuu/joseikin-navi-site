...
const batch = 'kagawa-official-coverage-003';
const outFile = `tasks/discovery/${batch}-rescored-candidates.json`;

const municipalities = [
  { org: '三木町', base: 'https://www.town.miki.lg.jp', seeds: ['/', '/life/', '/soshiki/', '/kurashi/', '/kosodate/'], mode: 'cms', max: 650 },
  { org: '直島町', base: 'https://www.town.naoshima.lg.jp', seeds: ['/', '/life/', '/kurashi/', '/soshiki/', '/government/'], mode: 'cms', max: 650 },
  { org: '宇多津町', base: 'https://www.town.utazu.lg.jp', seeds: ['/', '/life/', '/kurashi/', '/soshiki/'], mode: 'cms', max: 650 },
  { org: '綾川町', base: 'https://www.town.ayagawa.lg.jp', seeds: ['/', '/life/', '/kurashi/', '/soshiki/'], mode: 'cms', max: 650 },
  { org: '琴平町', base: 'https://www.town.kotohira.kagawa.jp', seeds: ['/', '/life/', '/kurashi/', '/soshiki/'], mode: 'cms', max: 650 },
];
