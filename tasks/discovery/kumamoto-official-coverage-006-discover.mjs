...
const batch = 'kumamoto-official-coverage-006';
const keywords = ['補助金', '助成金', '給付金', '支援金', '手当', '医療費助成', '就学援助', '奨学金', '貸付', '減免', '移住', '空き家', '耐震'];
const orgs = [
  {
    org: '西原村',
    base: 'https://www.vill.nishihara.kumamoto.jp',
    sitemaps: [],
    searches: keywords.map((q) => `https://www.vill.nishihara.kumamoto.jp/dynamic/search/pub/Default.aspx?c_id=3&q=${encodeURIComponent(q)}`),
    seeds: ['/', '/default.html', '/index.html', '/ijyu/default.html', '/classset002.html', '/classset001.html', '/bousai/default.html'],
  ...
  {
    org: '南阿蘇村',
    base: 'https://www.vill.minamiaso.lg.jp',
    sitemaps: [],
    searches: keywords.map((q) => `https://www.vill.minamiaso.lg.jp/dynamic/search/pub/Default.aspx?c_id=3&q=${encodeURIComponent(q)}`),
    seeds: ['/', '/default.html', '/index.html', '/list00107.html', '/classset002.html', '/classset001.html', '/bousai/default.html'],
    keep: /\/(?:kiji\d+\/index\.html|list\d+\.html|classset\d+\.html|default\.html|index\.html)/i,
    crawl: /\/(?:list\d+\.html|classset\d+\.html|default\.html|index\.html)/i,
  },
  {
    org: '御船町',
    base: 'https://www.town.mifune.kumamoto.jp',
    sitemaps: [],
    searches: keywords.map((q) => `https://www.town.mifune.kumamoto.jp/hpkiji/pub/Search.aspx?c_id=3&q=${encodeURIComponent(q)}`),
    seeds: ['/', '/default.aspx', '/hpkiji/pub/default.aspx?c_id=3&class_set_id=1', '/hpkiji/pub/default.aspx?c_id=3&class_set_id=2', '/hpkiji/pub/shinsei.aspx?c_id=3'],
    keep: /\/(?:page\d+\.html|hpkiji\/pub\/(?:Detail|List|default|shinsei)\.aspx\?[^"'<> ]+)/i,
    crawl: /\/hpkiji\/pub\/(?:List|default|shinsei)\.aspx\?[^"'<> ]+/i,
  },
  {
    org: '嘉島町',
    base: 'https://www.town.kumamoto-kashima.lg.jp',
    sitemaps: ['https://www.town.kumamoto-kashima.lg.jp/sitemap.xml'],
    searches: keywords.map((q) => `https://www.town.kumamoto-kashima.lg.jp/q/search.html?keyword=${encodeURIComponent(q)}`),
    seeds: ['/', '/q/new.html', '/q/list/1.html', '/q/list/55.html', '/q/list/114.html', '/q/list/124.html', '/q/list/130.html', '/q/list/135.html', '/q/list/147.html', '/q/list/168.html', '/q/list/176.html', '/q/list/179.html', '/q/list/199.html', '/q/list/200.html'],
    keep: /\/q\/(?:aview|list)\/\d+(?:\/\d+)?\.html|\/q\/new\.html/i,
    crawl: /\/q\/(?:list|new)\/?\d*\.html|\/q\/new\.html/i,
  },
  {
    org: '益城町',
    base: 'https://www.town.mashiki.lg.jp',
    sitemaps: [],
    searches: keywords.map((q) => `https://www.town.mashiki.lg.jp/dynamic/search/pub/Default.aspx?c_id=3&q=${encodeURIComponent(q)}`),
    seeds: ['/', '/default.html', '/list00501.html', '/list00502.html', '/list00503.html', '/list00504.html', '/list00505.html', '/list00506.html', '/classset003.html', '/classset002.html', '/classset001.html', '/dynamic/hpkiji/pub/shinsei.aspx?c_id=3'],
    keep: /\/(?:kiji\d+\/index\.html|list\d+\.html|classset\d+\.html|default\.html|dynamic\/hpkiji\/pub\/shinsei\.aspx\?c_id=3)/i,
    crawl: /\/(?:list\d+\.html|classset\d+\.html|default\.html|dynamic\/hpkiji\/pub\/shinsei\.aspx\?c_id=3)/i,
  },
];
...
async function fetchPage(url, timeoutMs = 4500) {
  ...
  try {
    ...
    const encoding = charset || (/town\.kumamoto-kashima\.lg\.jp/.test(res.url || url) ? 'euc-jp' : 'utf-8');
