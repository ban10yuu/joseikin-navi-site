...
const batch = 'kagoshima-official-coverage-001';

const orgs = [
  {
    org: '鹿児島県',
    base: 'https://www.pref.kagoshima.jp',
    sitemaps: ['https://www.pref.kagoshima.jp/sitemap.xml'],
    seeds: ['/', '/kurashi-kankyo/', '/kenko-fukushi/', '/sangyo-rodo/', '/kyoiku/', '/seisaku/', '/af01/'],
    keep: /\/(?:kurashi-kankyo|kenko-fukushi|sangyo-rodo|kyoiku|seisaku|af01|ac06|ab10|ag01|ae05|download|files|uploads)[^"'<> ]*(?:\.html|\.pdf|\/)(?:$|\?)/i,
    crawl: /\/(?:kurashi-kankyo|kenko-fukushi|sangyo-rodo|kyoiku|seisaku|af01|ac06|ab10|ag01|ae05)(?:\/|$)|sitemap\.xml/i,
    limit: 1300,
  },
  {
    org: '鹿児島市',
    base: 'https://www.city.kagoshima.lg.jp',
    sitemaps: ['https://www.city.kagoshima.lg.jp/sitemap.xml'],
    seeds: ['/', '/kurashi/', '/kenkofukushi/', '/kosodate/', '/sangyo/', '/kyoiku/', '/ijuteiju/'],
    keep: /\/(?:kurashi|kenkofukushi|kosodate|sangyo|kyoiku|ijuteiju|download|files|uploads)[^"'<> ]*(?:\.html|\.pdf|\/)(?:$|\?)/i,
    crawl: /\/(?:kurashi|kenkofukushi|kosodate|sangyo|kyoiku|ijuteiju)(?:\/|$)|sitemap\.xml/i,
    limit: 1300,
  },
  {
    org: '鹿屋市',
    base: 'https://www.city.kanoya.lg.jp',
    sitemaps: ['https://www.city.kanoya.lg.jp/sitemap.xml'],
  ...
  {
    org: '枕崎市',
    base: 'https://www.city.makurazaki.lg.jp',
    sitemaps: [],
    seeds: ['/', '/soshiki/', '/site/', '/life/', '/kurashi/', '/kenko/', '/kosodate/', '/sangyo/', '/kanko/', '/upload/'],
    keep: /\/(?:soshiki|site|life|kurashi|kenko|kosodate|sangyo|kanko|upload|download|files)[^"'<> ]*(?:\.html|\.pdf|\/)(?:$|\?)/i,
    crawl: /\/(?:soshiki|site|life|kurashi|kenko|kosodate|sangyo|kanko)(?:\/|$)/i,
    limit: 900,
  },
  {
    org: '阿久根市',
    base: 'https://www.city.akune.lg.jp',
    sitemaps: ['https://www.city.akune.lg.jp/sitemap.xml'],
    seeds: ['/', '/soshikikarasagasu/', '/kurashi/', '/kenko_fukushi/', '/kosodate_kyoiku/', '/sangyo_shigoto/', '/iju_teiju/'],
    keep: /\/(?:soshikikarasagasu|kurashi|kenko_fukushi|kosodate_kyoiku|sangyo_shigoto|iju_teiju|download|files|uploads)[^"'<> ]*(?:\.html|\.pdf|\/)(?:$|\?)/i,
    crawl: /\/(?:soshikikarasagasu|kurashi|kenko_fukushi|kosodate_kyoiku|sangyo_shigoto|iju_teiju)(?:\/|$)|sitemap\.xml/i,
    limit: 1000,
  },
];
