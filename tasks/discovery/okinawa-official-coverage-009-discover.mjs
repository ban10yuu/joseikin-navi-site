...
const batch = 'okinawa-official-coverage-009';

const orgs = [
  {
    org: '竹富町',
    base: 'https://www.town.taketomi.lg.jp',
    sitemaps: ['https://www.town.taketomi.lg.jp/sitemap.xml'],
    seeds: ['/', '/sitemap/', '/guide/', '/business/', '/administration/', '/lifeevent/ninshin/', '/lifeevent/kosodate/', '/lifeevent/job_info/', '/lifeevent/shushoku/', '/lifeevent/marriage/', '/lifeevent/shintiku/', '/lifeevent/fukushi/', '/topics/', '/info/', '/info/rss/', '/topics/rss/', '/soshiki/'],
    keep: new RegExp(String.raw`/(?:guide|business|administration|lifeevent|topics|info|soshiki|userfiles|files|download|documents|rikka-tabigift|furusato)[^"'<> ]*(?:\.html|\.php|\.pdf|/)(?:$|\?)|sitemap(?:\.dir)?\.xml|(?:info|topics)/rss`, 'i'),
    crawl: new RegExp(String.raw`/(?:guide|business|administration|lifeevent|topics|info|soshiki|userfiles|files|download|rikka-tabigift|furusato)[^"'<> ]*(?:/|\.html|\.xml)|sitemap(?:\.dir)?\.xml|sitemap/|(?:info|topics)/rss`, 'i'),
    limit: 900,
  },
  {
    org: '与那国町',
    base: 'https://www.town.yonaguni.okinawa.jp',
    sitemaps: ['https://www.town.yonaguni.okinawa.jp/sitemap.xml'],
    seeds: ['/', '/sitemap.html', '/category/bunya/machi/', '/category/bunya/kyoiku/', '/category/bunya/sangyo/', '/category/bunya/chosei/kofukin/', '/category/mokuteki/kosodate/', '/category/mokuteki/nyugaku/', '/category/mokuteki/shigoto/', '/category/mokuteki/kekkon/', '/category/mokuteki/kaigo/', '/category/kubun/', '/category/kubun/info/', '/category/kubun/boshu/', '/category/kubun/index.rss', '/category/kubun/boshu/index.rss'],
    keep: new RegExp(String.raw`/(?:docs|category|_files|file_contents|download|files|documents|furusato)[^"'<> ]*(?:\.html|\.php|\.pdf|/)(?:$|\?)|sitemap(?:\.dir)?\.xml|index\.(?:rss|atom)`, 'i'),
    crawl: new RegExp(String.raw`/(?:docs|category|_files|file_contents|download|furusato)[^"'<> ]*(?:/|\.html|\.xml)|sitemap(?:\.dir)?\.xml|sitemap\.html|index\.(?:rss|atom)`, 'i'),
    limit: 900,
  },
];
