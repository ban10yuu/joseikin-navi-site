...
const batch = 'ehime-official-coverage-003';
const outFile = `tasks/discovery/${batch}-rescored-candidates.json`;

const municipalities = [
  { org: '伊予市', base: 'https://www.city.iyo.lg.jp', seeds: ['/', '/kurashi/', '/soshiki/', '/kosodate/', '/kenko/', '/shigoto/', '/iju/'], mode: 'cms', max: 850 },
  { org: '四国中央市', base: 'https://www.city.shikokuchuo.ehime.jp', seeds: ['/', '/soshiki/', '/site/', '/kurashi/', '/kosodate/', '/business/', '/life/'], mode: 'cms', max: 850 },
  { org: '西予市', base: 'https://www.city.seiyo.ehime.jp', seeds: ['/', '/soshiki/', '/kurashi/', '/kosodate/', '/business/', '/life/', '/site/'], mode: 'cms', max: 850 },
  { org: '東温市', base: 'https://www.city.toon.ehime.jp', seeds: ['/', '/soshiki/', '/kurashi/', '/kosodate/', '/business/', '/life/', '/site/'], mode: 'cms', max: 850 },
  { org: '上島町', base: 'https://www.town.kamijima.lg.jp', seeds: ['/', '/soshiki/', '/kurashi/', '/kosodate/', '/business/', '/life/', '/site/'], mode: 'cms', max: 800 },
];
