...
const batch = 'fukuoka-official-coverage-007';
const outFile = `tasks/discovery/${batch}-rescored-candidates.json`;

const municipalities = [
  { org: '篠栗町', base: 'https://www.town.sasaguri.fukuoka.jp', seeds: ['/', '/soshiki/', '/life/', '/kurashi/', '/kosodate/', '/kenko/', '/sangyo/', '/kyoiku/', '/shisei/'], mode: 'cms', max: 280 },
  { org: '志免町', base: 'https://www.town.shime.lg.jp', seeds: ['/', '/soshiki/', '/life/', '/kurashi/', '/kosodate/', '/kenko/', '/sangyo/', '/kyoiku/', '/shisei/'], mode: 'cms', max: 280 },
  { org: '須恵町', base: 'https://www.town.sue.fukuoka.jp', seeds: ['/', '/soshiki/', '/life/', '/kurashi/', '/kosodate/', '/kenko/', '/sangyo/', '/kyoiku/', '/shisei/'], mode: 'cms', max: 280 },
  { org: '新宮町', base: 'https://www.town.shingu.fukuoka.jp', seeds: ['/', '/soshiki/', '/life/', '/kurashi/', '/kosodate/', '/kenko/', '/sangyo/', '/kyoiku/', '/shisei/'], mode: 'cms', max: 280 },
  { org: '久山町', base: 'https://www.town.hisayama.fukuoka.jp', seeds: ['/', '/soshiki/', '/life/', '/kurashi/', '/kosodate/', '/kenko/', '/sangyo/', '/kyoiku/', '/shisei/'], mode: 'cms', max: 280 },
];
