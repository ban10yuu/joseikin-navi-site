...
const batch = 'kochi-official-coverage-006';
const outFile = `tasks/discovery/${batch}-rescored-candidates.json`;

const municipalities = [
  { org: '佐川町', base: 'https://www.town.sakawa.lg.jp', seeds: ['/', '/life/', '/kurashi/', '/soshiki/', '/kosodate/', '/business/', '/iju/', '/category/'], mode: 'cms', max: 240 },
  { org: '越知町', base: 'https://www.town.ochi.kochi.jp', seeds: ['/', '/life/', '/kurashi/', '/soshiki/', '/kosodate/', '/business/', '/iju/', '/category/'], mode: 'cms', max: 240 },
  { org: '檮原町', base: 'https://www.town.yusuhara.lg.jp', seeds: ['/', '/life/', '/kurashi/', '/soshiki/', '/kosodate/', '/business/', '/iju/', '/category/'], mode: 'cms', max: 240 },
  { org: '日高村', base: 'https://www.vill.hidaka.kochi.jp', seeds: ['/', '/life/', '/kurashi/', '/soshiki/', '/kosodate/', '/business/', '/iju/', '/category/'], mode: 'cms', max: 240 },
  { org: '津野町', base: 'https://town.kochi-tsuno.lg.jp', seeds: ['/', '/life/', '/kurashi/', '/soshiki/', '/kosodate/', '/business/', '/iju/', '/category/'], mode: 'cms', max: 240 },
];
