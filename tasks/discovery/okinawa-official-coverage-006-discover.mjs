...
const batch = 'okinawa-official-coverage-006';

const orgs = [
  {
    org: '中城村',
    base: 'https://www.vill.nakagusuku.okinawa.jp',
    sitemaps: ['https://www.vill.nakagusuku.okinawa.jp/sitemap.xml'],
    seeds: ['/', '/sitemap/', '/kurashi/', '/kosodate/', '/sangyo/', '/kankou/', '/jigyosha/', '/gyosei/'],
    keep: new RegExp(String.raw`/(?:kurashi|kosodate|sangyo|kankou|jigyosha|gyosei|news|topics|download|files|documents|kakuka)[^"'<> ]*(?:\.html|\.php|\.pdf|/)(?:$|\?)|sitemap(?:\.dir)?\.xml`, 'i'),
    crawl: new RegExp(String.raw`/(?:kurashi|kosodate|sangyo|kankou|jigyosha|gyosei|news|topics|download|kakuka)[^"'<> ]*(?:/|\.html|\.xml)|sitemap(?:\.dir)?\.xml|sitemap/`, 'i'),
    limit: 850,
  },
  {
    org: '西原町',
    base: 'https://www.town.nishihara.okinawa.jp',
    sitemaps: ['https://www.town.nishihara.okinawa.jp/sitemap_index.xml'],
    seeds: ['/', '/index.html', '/sitemap.html', '/life/', '/life/1/', '/life/2/', '/life/3/', '/life/4/', '/life/5/', '/soshiki/', '/life/sub/1/'],
  ...
  {
    org: '与那原町',
    base: 'https://www.town.yonabaru.okinawa.jp',
    sitemaps: ['https://www.town.yonabaru.okinawa.jp/sitemap_index.xml'],
    seeds: ['/', '/index.html', '/sitemap.html', '/life/', '/life/1/', '/life/2/', '/life/3/', '/life/4/', '/life/5/', '/soshiki/', '/life/sub/1/'],
    keep: new RegExp(String.raw`/(?:life|soshiki|site|news|pickup|boshu|oshirase|download|files|documents)[^"'<> ]*(?:\.html|\.php|\.pdf|/)(?:$|\?)|sitemap(?:_index|[0-9]+|\.dir)?\.xml`, 'i'),
    crawl: new RegExp(String.raw`/(?:life|soshiki|site|news|pickup|boshu|oshirase|download)[^"'<> ]*(?:/|\.html|\.xml)|sitemap(?:_index|[0-9]+|\.dir)?\.xml|sitemap\.html`, 'i'),
    limit: 750,
  ...
  {
    org: '南風原町',
    base: 'https://www.town.haebaru.lg.jp',
    sitemaps: ['https://www.town.haebaru.lg.jp/sitemap_index.xml'],
    seeds: ['/', '/index.html', '/sitemap.html', '/life/', '/life/1/', '/life/2/', '/life/3/', '/life/4/', '/life/5/', '/life/7/', '/soshiki/', '/life/sub/1/'],
    keep: new RegExp(String.raw`/(?:life|soshiki|site|news|pickup|boshu|oshirase|download|files|documents)[^"'<> ]*(?:\.html|\.php|\.pdf|/)(?:$|\?)|sitemap(?:_index|[0-9]+|\.dir)?\.xml`, 'i'),
    crawl: new RegExp(String.raw`/(?:life|soshiki|site|news|pickup|boshu|oshirase|download)[^"'<> ]*(?:/|\.html|\.xml)|sitemap(?:_index|[0-9]+|\.dir)?\.xml|sitemap\.html`, 'i'),
    limit: 750,
  },
  {
    org: '渡嘉敷村',
    base: 'https://www.vill.tokashiki.okinawa.jp',
    sitemaps: ['https://www.vill.tokashiki.okinawa.jp/sitemap.xml'],
    seeds: ['/', '/index.html', '/sitemap.html', '/kurashi_tetsuzuki/', '/kosodate_kyoiku/', '/kenko_fukushi/', '/sangyo_shigoto/', '/gyoseijoho/', '/download/'],
    keep: new RegExp(String.raw`/(?:kurashi_tetsuzuki|kosodate_kyoiku|kenko_fukushi|sangyo_shigoto|gyoseijoho|oshirase|gyoji_event|download|files|documents)[^"'<> ]*(?:\.html|\.php|\.pdf|/)(?:$|\?)|sitemap(?:\.dir)?\.xml`, 'i'),
    crawl: new RegExp(String.raw`/(?:kurashi_tetsuzuki|kosodate_kyoiku|kenko_fukushi|sangyo_shigoto|gyoseijoho|oshirase|download)[^"'<> ]*(?:/|\.html|\.xml)|sitemap(?:\.dir)?\.xml|sitemap\.html`, 'i'),
    limit: 750,
  },
];
