...
const { selections } = JSON.parse(fs.readFileSync('tasks/discovery/fukuoka-official-coverage-011-selections.json','utf8'));
const outBase='tasks/discovery/fukuoka-official-coverage-011';
...
fs.writeFileSync(outBase+'-ts-snippet.ts',`const fukuokaOfficial011Grants: Array<{
  slug: string;
  title: string;
  organization: string;
  maxAmount: string;
