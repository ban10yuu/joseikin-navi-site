...
const batch = 'fukuoka-official-coverage-006';
const outFile = `tasks/discovery/${batch}-rescored-candidates.json`;

const municipalities = [
  { org: '朝倉市', base: 'https://www.city.asakura.lg.jp', seeds: ['/', '/www/', '/kurashi/', '/kosodate/', '/kenko/', '/sangyo/', '/kyoiku/', '/shisei/', '/soshiki/'], mode: 'cms', max: 280 },
  { org: 'みやま市', base: 'https://www.city.miyama.lg.jp', seeds: ['/', '/soshiki/', '/kurashi/', '/kosodate/', '/kenko/', '/sangyo/', '/kyoiku/', '/shisei/', '/life/'], mode: 'cms', max: 280 },
  { org: '糸島市', base: 'https://www.city.itoshima.lg.jp', seeds: ['/', '/soshiki/', '/kurashi/', '/kosodate/', '/kenko/', '/sangyo/', '/kyoiku/', '/shisei/', '/site/'], mode: 'cms', max: 280 },
  { org: '那珂川市', base: 'https://www.city.nakagawa.lg.jp', seeds: ['/', '/soshiki/', '/life/', '/kurashi/', '/kosodate/', '/kenko/', '/sangyo/', '/kyoiku/', '/shisei/'], mode: 'cms', max: 280 },
  { org: '宇美町', base: 'https://www.town.umi.lg.jp', seeds: ['/', '/soshiki/', '/life/', '/kurashi/', '/kosodate/', '/kenko/', '/sangyo/', '/kyoiku/', '/shisei/'], mode: 'cms', max: 280 },
];
