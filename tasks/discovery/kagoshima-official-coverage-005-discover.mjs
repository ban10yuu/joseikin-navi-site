...
const batch = 'kagoshima-official-coverage-005';

const orgs = [
  {
    org: '三島村',
    base: 'https://mishimamura.com',
    sitemaps: ['https://mishimamura.com/sitemap.xml'],
    seeds: ['/', '/toumin/', '/gyousei/', '/sangyou/', '/teijuiju/', '/education-culture-history/', '/category/news/', '/category/news/recruit/'],
    keep: /\/(?:toumin|gyousei|sangyou|teijuiju|education-culture-history|category|system\/wp-content\/uploads)[^"'<> ]*(?:\.html|\.php|\.pdf|\/?)(?:$|\?)|\/\?p=\d+/i,
    crawl: /\/(?:toumin|gyousei|sangyou|teijuiju|education-culture-history|category)(?:\/|$)|sitemap\.xml/i,
    limit: 500,
  },
  {
    org: '十島村',
    base: 'https://www.tokara.jp',
    sitemaps: ['https://www.tokara.jp/sitemap.xml'],
    seeds: ['/', '/life/', '/health/', '/education/', '/tourism/', '/jigyo/', '/profile/kosodate/', '/cat_recruit/job/'],
    keep: /\/(?:life|health|education|tourism|jigyo|profile|cat_recruit|wp\/wp-content\/uploads)[^"'<> ]*(?:\.html|\.php|\.pdf|\/?)(?:$|\?)/i,
    crawl: /\/(?:life|health|education|tourism|jigyo|profile|cat_recruit)(?:\/|$)|sitemap\.xml/i,
    limit: 450,
  },
  {
    org: 'さつま町',
    base: 'https://www.satsuma-net.jp',
    sitemaps: ['https://www.satsuma-net.jp/sitemap.xml'],
    seeds: ['/', '/kurashi_tetsuzuki/index.html', '/kenko_fukushi/index.html', '/kosodate_manabi/index.html', '/shigoto_sangyo/index.html', '/teiju/index.html', '/kosodate/index.html', '/life_guide/ninshin_shussan/index.html', '/life_guide/kosodate/index.html', '/life_guide/sumai_hikkoshi/index.html'],
    keep: /\/(?:kurashi_tetsuzuki|kenko_fukushi|kosodate_manabi|shigoto_sangyo|machinosugata|teiju|kosodate|life_guide|event_boshu|info_taisetu|soshiki|upload|files)[^"'<> ]*(?:\.html|\.php|\.pdf|\/)(?:$|\?)/i,
    crawl: /\/(?:kurashi_tetsuzuki|kenko_fukushi|kosodate_manabi|shigoto_sangyo|machinosugata|teiju|kosodate|life_guide|soshiki)(?:\/|$)|sitemap\.xml/i,
    limit: 650,
  },
  {
    org: '長島町',
    base: 'https://www.town.nagashima.lg.jp',
    sitemaps: ['https://www.town.nagashima.lg.jp/wp-sitemap.xml'],
    seeds: ['/', '/livelihood/', '/administration/', '/industrial/', '/town/', '/education/', '/download/application_docs/', '/hotnewslist/'],
    keep: /\/(?:livelihood|administration|industrial|town|education|download|topinfo|event|wp-content\/uploads)[^"'<> ]*(?:\.html|\.php|\.pdf|\/?)(?:$|\?)/i,
    crawl: /\/(?:livelihood|administration|industrial|town|education|download|topinfo|event)(?:\/|$)|sitemap\.xml/i,
    limit: 450,
  },
  {
    org: '湧水町',
    base: 'https://www.town.yusui.kagoshima.jp',
    sitemaps: [],
    seeds: ['/', '/sitemap.html', '/life/1/1/', '/life/1/2/', '/life/1/4/', '/site/yusuilife/', '/site/kanko/', '/site/shinsei/', '/soshiki/', '/life/sub/1/', '/life/sub/2/', '/life/sub/5/', '/life/sub/9/'],
    keep: /\/(?:life|site|soshiki|map|rss|upload|files)[^"'<> ]*(?:\.html|\.php|\.pdf|\/)(?:$|\?)/i,
    crawl: /\/(?:life|site|soshiki)(?:\/|$)|sitemap\.html/i,
    limit: 650,
  },
];
