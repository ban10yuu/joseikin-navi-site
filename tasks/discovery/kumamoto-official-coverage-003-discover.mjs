...
const batch = 'kumamoto-official-coverage-003';
const keywords = ['補助金', '助成金', '給付金', '支援金', '手当', '医療費助成', '就学援助', '奨学金', '貸付', '減免', '移住', '空き家', '耐震'];
const orgs = [
  {
    org: '宇城市',
    base: 'https://www.city.uki.kumamoto.jp',
    sitemaps: ['https://www.city.uki.kumamoto.jp/sitemap.xml'],
    searches: keywords.map((q) => `https://www.city.uki.kumamoto.jp/search?q=${encodeURIComponent(q)}`),
    seeds: ['/', '/ukinisum/', '/sitemap/'],
    keep: /\/(?:toppage|ukinisum|kurashi|kosodate|kenko|sangyo|kanko|bousai|soshiki|article|news|pages?)\//i,
    crawl: /\/(?:sitemap|toppage|ukinisum|kurashi|kosodate|kenko|sangyo|kanko|bousai|soshiki)\//i,
  },
  {
    org: '阿蘇市',
    base: 'https://www.city.aso.kumamoto.jp',
    sitemaps: ['https://www.city.aso.kumamoto.jp/sitemap.xml'],
    searches: keywords.map((q) => `https://www.city.aso.kumamoto.jp/?s=${encodeURIComponent(q)}`),
    seeds: ['/citizens/', '/business/', '/education/', '/scene/child_rearing/', '/scene/moving/', '/scene/elderly_welfare/', '/scene/medical_care/'],
    keep: /\/(?:citizens|business|education|scene|municipal|asokikin|20\d{2})\//i,
    crawl: /\/(?:citizens|business|education|scene|municipal)\//i,
  },
  {
    org: '天草市',
    base: 'https://www.city.amakusa.kumamoto.jp',
    sitemaps: [],
    searches: keywords.map((q) => `https://www.city.amakusa.kumamoto.jp/dynamic/search/pub/Default.aspx?c_id=2&q=${encodeURIComponent(q)}`),
    seeds: ['/list00718.html', '/list00715.html', '/list00608.html', '/list00601.html', '/default.html', '/dynamic/search/pub/Default.aspx?c_id=2', '/list00000.html'],
    keep: /\/(?:kiji\d+\/index\.html|list\d+\.html|default\.html)/i,
    crawl: /\/(?:list\d+\.html|default\.html)/i,
  },
  {
    org: '合志市',
    base: 'https://www.city.koshi.lg.jp',
    sitemaps: [],
    searches: keywords.map((q) => `https://www.city.koshi.lg.jp/dynamic/word_l/pub/default.aspx?c_id=45&keyword=${encodeURIComponent(q)}`),
    seeds: ['/list00983.html', '/list00306.html', '/list00307.html', '/list00221.html', '/list00261.html', '/default.html', '/list00200.html', '/list00201.html', '/list00202.html', '/list00204.html', '/list00205.html', '/dynamic/word_l/pub/default.aspx?c_id=45'],
    keep: /\/(?:kiji\d+\/index\.html|list\d+\.html|default\.html)/i,
    crawl: /\/(?:list\d+\.html|default\.html)/i,
  },
  {
    org: '美里町',
    base: 'https://www.town.kumamoto-misato.lg.jp',
    sitemaps: ['https://www.town.kumamoto-misato.lg.jp/sitemap.xml'],
    searches: [],
    seeds: ['/', '/kurashi_tetsuzuki/index.html', '/iryo_kenko_fukushi/index.html', '/kosodate_kyoiku/index.html', '/shigoto_sangyo/index.html', '/scene/hikkosi_sumai/index.html', '/town_news/index.html'],
    keep: /\/(?:kurashi_tetsuzuki|iryo_kenko_fukushi|kosodate_kyoiku|shigoto_sangyo|kanko_bunka_sports|scene|town_news)\/.*(?:\.html|\/$)|\/town_news\/\d+\.html|\/\d+\.html/i,
    crawl: /\/(?:kurashi_tetsuzuki|iryo_kenko_fukushi|kosodate_kyoiku|shigoto_sangyo|kanko_bunka_sports|scene|town_news)\//i,
  },
];
