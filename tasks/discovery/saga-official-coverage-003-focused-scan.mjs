...
const municipalities = [
  { org: '吉野ヶ里町', base: 'https://www.town.yoshinogari.lg.jp', seeds: ['/', '/life/', '/kosodate/', '/kenko/', '/kurashi/', '/sangyo/', '/kankou/'], max: 260 },
  { org: '基山町', base: 'https://www.town.kiyama.lg.jp', seeds: ['/', '/list00001.html', '/list00002.html', '/list00003.html', '/list00004.html', '/kosodate/', '/site/'], max: 260 },
  { org: '上峰町', base: 'https://www.town.kamimine.lg.jp', seeds: ['/', '/list00100.html', '/list00101.html', '/list00102.html', '/list00103.html', '/list00104.html', '/kurashi/'], max: 260 },
  { org: 'みやき町', base: 'https://www.town.miyaki.lg.jp', seeds: ['/', '/kurashi/', '/kosodate/', '/kenko/', '/sangyo/', '/kankou/'], max: 260 },
  { org: '玄海町', base: 'https://www.town.genkai.lg.jp', seeds: ['/', '/site/kosodate/', '/site/iju/', '/soshiki/', '/kurashi/', '/life/'], max: 260 },
];
