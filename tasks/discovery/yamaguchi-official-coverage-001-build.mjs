...
const { selections } = JSON.parse(fs.readFileSync('tasks/discovery/yamaguchi-official-coverage-001-selections.json','utf8'));
...
fs.writeFileSync(outBase+'-ts-snippet.ts',`const yamaguchiOfficial001Grants: Array<{
  slug: string;
  title: string;
  organization: string;
  maxAmount: string;
