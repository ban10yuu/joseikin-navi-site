...
const { selections } = JSON.parse(fs.readFileSync('tasks/discovery/okayama-official-coverage-006-selections.json','utf8'));
const outBase='tasks/discovery/okayama-official-coverage-006';
...
fs.writeFileSync(outBase+'-ts-snippet.ts',`const okayamaOfficial006Grants: Array<{
  slug: string;
  title: string;
  organization: string;
  maxAmount: string;
