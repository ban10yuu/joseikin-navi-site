...
const { selections } = JSON.parse(fs.readFileSync('tasks/discovery/fukuoka-official-coverage-007-selections.json','utf8'));
const outBase='tasks/discovery/fukuoka-official-coverage-007';
...
fs.writeFileSync(outBase+'-ts-snippet.ts',`const fukuokaOfficial007Grants: Array<{
  slug: string;
  title: string;
  organization: string;
  maxAmount: string;
