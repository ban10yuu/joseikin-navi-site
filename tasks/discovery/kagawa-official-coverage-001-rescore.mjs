...
const batch = 'kagawa-official-coverage-001';
const outFile = `tasks/discovery/${batch}-rescored-candidates.json`;

const municipalities = [
  { org: '高松市', base: 'https://www.city.takamatsu.kagawa.jp', seeds: ['https://www.city.takamatsu.kagawa.jp/sitemap.xml'], mode: 'sitemap', max: 850 },
  { org: '丸亀市', base: 'https://www.city.marugame.lg.jp', seeds: ['/life/', '/soshiki/'], mode: 'cms', max: 520 },
  { org: '坂出市', base: 'https://www.city.sakaide.lg.jp', seeds: ['/life/', '/soshiki/'], mode: 'cms', max: 520 },
  { org: '善通寺市', base: 'https://www.city.zentsuji.kagawa.jp', seeds: ['/life/', '/soshiki/'], mode: 'cms', max: 520 },
  { org: '観音寺市', base: 'https://www.city.kanonji.kagawa.jp', seeds: ['/life/', '/soshiki/'], mode: 'cms', max: 520 },
];
