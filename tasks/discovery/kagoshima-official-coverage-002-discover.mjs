...
const batch = 'kagoshima-official-coverage-002';

const orgs = [
  {
    org: '出水市',
    base: 'https://www.city.kagoshima-izumi.lg.jp',
    sitemaps: ['https://www.city.kagoshima-izumi.lg.jp/sitemap.xml'],
    seeds: ['/welcome/', '/kurashi/', '/kenko_fukushi/', '/kosodate_kyoiku/', '/sangyo_business/', '/iju_teiju/'],
    keep: /\/(?:welcome|kurashi|kenko_fukushi|kosodate_kyoiku|sangyo_business|iju_teiju|download|files|uploads|article)[^"'<> ]*(?:\.html|\.php|\.pdf|\/)(?:$|\?)/i,
    crawl: /\/(?:welcome|kurashi|kenko_fukushi|kosodate_kyoiku|sangyo_business|iju_teiju|article)(?:\/|$)|sitemap\.xml/i,
    limit: 1100,
  },
  {
    org: '指宿市',
    base: 'https://www.city.ibusuki.lg.jp',
    sitemaps: [],
    seeds: ['/', '/main/', '/kurashi/', '/kenko/', '/kosodate/', '/sangyo/', '/kyoiku/', '/ijyu/'],
    keep: /\/(?:main|kurashi|kenko|kosodate|sangyo|kyoiku|ijyu|download|files|uploads|article)[^"'<> ]*(?:\.html|\.php|\.pdf|\/)(?:$|\?)/i,
    crawl: /\/(?:main|kurashi|kenko|kosodate|sangyo|kyoiku|ijyu|article)(?:\/|$)/i,
    limit: 950,
  },
  {
    org: '西之表市',
    base: 'https://www.city.nishinoomote.lg.jp',
    sitemaps: ['https://www.city.nishinoomote.lg.jp/sitemap.xml'],
    seeds: ['/', '/admin/', '/kurashi/', '/kosodate/', '/sangyo/', '/kyoiku/', '/ijyu/'],
    keep: /\/(?:admin|kurashi|kosodate|sangyo|kyoiku|ijyu|download|files|uploads)[^"'<> ]*(?:\.html|\.pdf|\/)(?:$|\?)/i,
    crawl: /\/(?:admin|kurashi|kosodate|sangyo|kyoiku|ijyu)(?:\/|$)|sitemap\.xml/i,
    limit: 950,
  },
  {
    org: '垂水市',
    base: 'https://www.city.tarumizu.lg.jp',
    sitemaps: ['https://www.city.tarumizu.lg.jp/sitemap.xml'],
    seeds: ['/', '/kurashi/', '/kenko/', '/kosodate/', '/sangyo/', '/kyoiku/', '/ijyu/'],
    keep: /\/(?:kurashi|kenko|kosodate|sangyo|kyoiku|ijyu|download|files|uploads)[^"'<> ]*(?:\.html|\.pdf|\/)(?:$|\?)/i,
    crawl: /\/(?:kurashi|kenko|kosodate|sangyo|kyoiku|ijyu)(?:\/|$)|sitemap\.xml/i,
    limit: 950,
  },
  {
    org: '薩摩川内市',
    base: 'https://www.city.satsumasendai.lg.jp',
    sitemaps: ['https://www.city.satsumasendai.lg.jp/sitemap.xml'],
    seeds: ['/', '/kurashi_tetsuzuki/', '/kenko_fukushi/', '/kosodate_kyoiku/', '/sangyo_business/', '/ijyu_teiju/'],
    keep: /\/(?:kurashi_tetsuzuki|kenko_fukushi|kosodate_kyoiku|sangyo_business|ijyu_teiju|download|files|uploads)[^"'<> ]*(?:\.html|\.pdf|\/)(?:$|\?)/i,
    crawl: /\/(?:kurashi_tetsuzuki|kenko_fukushi|kosodate_kyoiku|sangyo_business|ijyu_teiju)(?:\/|$)|sitemap\.xml/i,
    limit: 1200,
  },
];
