...
- [ ] 次回候補: 千葉県の未公式確認slugから、浦安市の就学援助・保育/放課後系、船橋市/市川市/松戸市/柏市の高齢者・福祉系、雨水貯留・浸水防止・防災用品系、または埼玉県の未確認生活者向け制度など、公式ページと一致しやすい制度を小バッチで確認する。事業者向け・奨学金返還支援系・不妊治療系は生成名の誤りが多い可能性があるため、公式制度名を確認できるものだけ追加する
- [ ] push / 公開反映は明示確認後に実行
