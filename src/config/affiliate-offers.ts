...
export const AFFILIATE_OFFERS: AffiliateOffer[] = [
  ...
  // A8.netで提携完了。広告リンクと公式素材を取得し、訴求を確認するまでは非公開。
  {
    id: 'a8-plement-seishei-sheet', enabled: false, network: 'A8.net', advertiserName: 'プレメント',
    offerName: 'プレメント採精シート', destinationUrl: null,
    ...
    validFrom: null, validUntil: null, verifiedAt: '2026-07-19',
    disclosureText: '以下にはアフィリエイトリンクが含まれます。申込みが発生した場合、当サイトが紹介料を受け取ることがあります。',
    buttonText: '商品の内容を見る', trackingId: null, externalProgramId: 's00000004439069',
    creativeImageUrl: null, creativeAlt: null, creativeWidth: null, creativeHeight: null, impressionPixelUrl: null,
    creativeId: null, creativeSourceUrl: null, creativeVerifiedAt: null, destinationHost: null,
    claimReviewStatus: 'pending', partnershipStatus: 'partnered', priority: 80,
  },
  {
    id: 'a8-plement-syringe', enabled: false, network: 'A8.net', advertiserName: 'プレメント',
    offerName: 'プレメントシリンジ', destinationUrl: null,
    audiences: ['individual', 'family'], intents: ['fertilityCare'], allowedPurposes: ['medical'],
    blockedPurposes: ['welfare', 'disaster', 'livingSupport'], allowSensitiveContexts: true, allowedPageTypes: ['grant'],
    validFrom: null, validUntil: null, verifiedAt: '2026-07-19',
    disclosureText: '以下にはアフィリエイトリンクが含まれます。申込みが発生した場合、当サイトが紹介料を受け取ることがあります。',
    buttonText: '商品の内容を見る', trackingId: null, externalProgramId: 's00000004439060',
    creativeImageUrl: null, creativeAlt: null, creativeWidth: null, creativeHeight: null, impressionPixelUrl: null,
    creativeId: null, creativeSourceUrl: null, creativeVerifiedAt: null, destinationHost: null,
    claimReviewStatus: 'pending', partnershipStatus: 'partnered', priority: 79,
  },
