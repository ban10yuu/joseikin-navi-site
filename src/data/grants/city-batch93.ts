...
const cities = [
  { name: '宮崎市', pref: '宮崎県', prefix: 'miyazaki-', desc: '宮崎市は宮崎県の県庁所在地で、青島や日南海岸の美しい景観と温暖な気候が魅力です。プロ野球やサッカーのキャンプ地としても有名で、チキン南蛮発祥の地でもあります。' },
  { name: '都城市', pref: '宮崎県', prefix: 'miyakonojo-', desc: '都城市は宮崎県第2の都市で、肉と焼酎のまちとして知られています。都城盆地に位置し、畜産業が盛んで、ふるさと納税寄付額日本一を記録したこともあります。' },
  { name: '延岡市', pref: '宮崎県', prefix: 'nobeoka-', desc: '延岡市は宮崎県北部の中心都市で、旭化成の企業城下町として発展しました。五ヶ瀬川や大崩山など豊かな自然に恵まれ、チキン南蛮やめひかりが名物です。' },
  { name: '日向市', pref: '宮崎県', prefix: 'hyuga-', desc: '日向市は日向灘に面した港町で、お倉ヶ浜はサーフィンの聖地として世界的に知られています。馬ヶ背の柱状節理は国の名勝に指定された絶景スポットです。' },
  { name: '小林市', pref: '宮崎県', prefix: 'kobayashi-', desc: '小林市は宮崎県南西部に位置し、霧島連山のふもとに広がる高原のまちです。出の山湧水はホタルの名所で、チョウザメの養殖でも知られています。' },
  { name: '西都市', pref: '宮崎県', prefix: 'saito-', desc: '西都市は宮崎県中央部に位置し、西都原古墳群は300余基の古墳が点在する日本最大級の古墳群です。マンゴーやピーマンなどの施設園芸が盛んなまちです。' },
];
...
function genGrants(c: typeof cities[0]): Grant[] {
  ...
  return cats.map(g => ({
    ...
    officialUrl: '', publishedAt: '2026-03-11',
  }));
}

export const cityGrantsBatch93: Grant[] = cities.flatMap(c => genGrants(c));
