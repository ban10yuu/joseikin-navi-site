...
const cities = [
  { name: '佐賀市', pref: '佐賀県', prefix: 'saga-', desc: '佐賀市は佐賀県の県庁所在地で、佐賀城跡や佐賀バルーンフェスタで有名です。有明海ののりや佐賀牛など食の魅力も豊かなまちです。' },
  { name: '唐津市', pref: '佐賀県', prefix: 'karatsu-', desc: '唐津市は唐津焼と唐津くんちで知られる歴史ある城下町です。虹の松原や呼子のイカなど、文化と自然と食が揃ったまちです。' },
  { name: '鳥栖市', pref: '佐賀県', prefix: 'tosu-', desc: '鳥栖市は九州の交通の要衝で、高速道路と鉄道の結節点です。鳥栖プレミアム・アウトレットやサガン鳥栖の本拠地としても知られています。' },
  { name: '長崎市', pref: '長崎県', prefix: 'nagasaki-', desc: '長崎市は長崎県の県庁所在地で、世界遺産の教会群やグラバー園など異国情緒あふれるまちです。ちゃんぽんやカステラなど独自の食文化も魅力です。' },
  { name: '佐世保市', pref: '長崎県', prefix: 'sasebo-', desc: '佐世保市はハウステンボスや九十九島の絶景で有名な観光都市です。佐世保バーガーや海軍カレーなどグルメも充実しています。' },
  { name: '諫早市', pref: '長崎県', prefix: 'isahaya-', desc: '諫早市は長崎県の中央に位置する交通の要衝で、諫早公園の眼鏡橋が名所です。有明海と大村湾に挟まれた自然豊かなまちです。' },
];
...
function genGrants(c: typeof cities[0]): Grant[] {
  ...
  return cats.map(g => ({
    ...
    officialUrl: '', publishedAt: '2026-03-09',
  }));
}

export const cityGrantsBatch90: Grant[] = cities.flatMap(c => genGrants(c));
