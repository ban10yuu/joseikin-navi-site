...
const cities = [
  { name: '徳島市', pref: '徳島県', prefix: 'tokushima-', desc: '徳島市は徳島県の県庁所在地で、阿波おどりの本場として毎年夏に全国から観光客が訪れます。眉山からの市街地の眺望も人気です。' },
  { name: '鳴門市', pref: '徳島県', prefix: 'naruto-', desc: '鳴門市は渦潮で世界的に有名な鳴門海峡に面し、大塚国際美術館や鳴門金時（さつまいも）の産地としても知られています。' },
  { name: '阿南市', pref: '徳島県', prefix: 'anan-', desc: '阿南市は徳島県南東部に位置し、LEDの世界的メーカー発祥の地として「光のまち」と呼ばれます。太龍寺や蒲生田岬など自然も豊かです。' },
  { name: '高松市', pref: '香川県', prefix: 'takamatsu-', desc: '高松市は香川県の県庁所在地で、栗林公園や高松城跡（玉藻公園）が名所です。讃岐うどんの聖地として全国的に知られています。' },
  { name: '丸亀市', pref: '香川県', prefix: 'marugame-', desc: '丸亀市は石垣の名城・丸亀城で知られ、うちわの生産量日本一の「うちわのまち」です。瀬戸内海の島々を望む風光明媚な都市です。' },
  { name: '坂出市', pref: '香川県', prefix: 'sakaide-', desc: '坂出市は瀬戸大橋の四国側の玄関口として知られます。塩田の歴史と瀬戸内海の多島美が魅力で、五色台からの眺望は絶景です。' },
];
...
function genGrants(c: typeof cities[0]): Grant[] {
  ...
  return cats.map(g => ({
    ...
    officialUrl: '', publishedAt: '2026-03-06',
  }));
}

export const cityGrantsBatch87: Grant[] = cities.flatMap(c => genGrants(c));
