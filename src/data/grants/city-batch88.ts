...
const cities = [
  { name: '松山市', pref: '愛媛県', prefix: 'matsuyama-', desc: '松山市は愛媛県の県庁所在地で、道後温泉や松山城など歴史的名所が多い「いで湯と城と文学のまち」です。夏目漱石「坊っちゃん」の舞台でもあります。' },
  { name: '今治市', pref: '愛媛県', prefix: 'imabari-', desc: '今治市はしまなみ海道の愛媛側の玄関口で、今治タオルの産地として世界的に有名です。造船業も盛んな瀬戸内海の海事都市です。' },
  { name: '新居浜市', pref: '愛媛県', prefix: 'niihama-', desc: '新居浜市は別子銅山の歴史を持つ工業都市で、太鼓祭りは四国三大祭りの一つに数えられます。住友グループ発祥の地でもあります。' },
  { name: '西条市', pref: '愛媛県', prefix: 'saijo-', desc: '西条市は石鎚山のふもとに広がるまちで、「うちぬき」と呼ばれる地下水が自噴する名水のまちです。西条まつりのだんじりも有名です。' },
  { name: '高知市', pref: '高知県', prefix: 'kochi-', desc: '高知市は高知県の県庁所在地で、坂本龍馬のゆかりの地として有名です。日曜市やひろめ市場、よさこい祭りなど活気あふれるまちです。' },
  { name: '南国市', pref: '高知県', prefix: 'nankoku-', desc: '南国市は高知龍馬空港がある交通の要衝で、古くは土佐国の国府が置かれた歴史あるまちです。温暖な気候で農業が盛んです。' },
];
...
function genGrants(c: typeof cities[0]): Grant[] {
  ...
  return cats.map(g => ({
    ...
    officialUrl: '', publishedAt: '2026-03-07',
  }));
}

export const cityGrantsBatch88: Grant[] = cities.flatMap(c => genGrants(c));
