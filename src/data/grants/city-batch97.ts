...
const cities = [
  { name: '秋田市', pref: '秋田県', prefix: 'akita-', desc: '秋田市は秋田県の県庁所在地で、竿燈まつりはユネスコ無形文化遺産に登録された伝統行事です。きりたんぽ鍋や稲庭うどんなど独自の食文化でも知られています。' },
  { name: '横手市', pref: '秋田県', prefix: 'yokote-', desc: '横手市は秋田県南東部に位置し、横手のかまくらは約450年の歴史を持つ冬の風物詩です。横手やきそばはB-1グランプリで優勝した全国的なご当地グルメです。' },
  { name: '大仙市', pref: '秋田県', prefix: 'daisen-', desc: '大仙市は秋田県南部に位置し、大曲の花火（全国花火競技大会）は日本三大花火の一つとして有名です。角館の武家屋敷通りとともに観光客を集めています。' },
  { name: '山形市', pref: '山形県', prefix: 'yamagata-', desc: '山形市は山形県の県庁所在地で、蔵王温泉スキー場の樹氷が冬の名物です。芋煮会は秋の風物詩で、日本一の芋煮会フェスティバルは直径6mの大鍋で有名です。' },
  { name: '鶴岡市', pref: '山形県', prefix: 'tsuruoka-', desc: '鶴岡市は山形県庄内地方の中心都市で、出羽三山の精神文化とユネスコ食文化創造都市に認定された豊かな食が魅力です。加茂水族館のクラゲ展示は世界一です。' },
  { name: '酒田市', pref: '山形県', prefix: 'sakata-', desc: '酒田市は山形県庄内平野の港町で、山居倉庫は庄内米の集積地として明治から続く歴史的建造物です。本間美術館や土門拳記念館など文化施設も充実しています。' },
];
...
export const cityGrantsBatch97: Grant[] = cities.flatMap(c => genGrants(c));
