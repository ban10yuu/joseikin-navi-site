...
const cities = [
  { name: '青森市', pref: '青森県', prefix: 'aomori-', desc: '青森市は青森県の県庁所在地で、ねぶた祭りは日本を代表する火祭りとして毎年300万人以上が訪れます。青函連絡船の歴史や三内丸山遺跡など文化遺産も豊富です。' },
  { name: '弘前市', pref: '青森県', prefix: 'hirosaki-', desc: '弘前市は津軽地方の中心都市で、弘前城と弘前公園の桜まつりは日本有数の花見名所です。りんごの生産量日本一を誇り、洋館巡りも人気の観光地です。' },
  { name: '八戸市', pref: '青森県', prefix: 'hachinohe-', desc: '八戸市は青森県南東部の港町で、八戸港は全国有数の漁港として知られています。八戸三社大祭は豪華絢爛な山車が繰り出すユネスコ無形文化遺産です。' },
  { name: '盛岡市', pref: '岩手県', prefix: 'morioka-', desc: '盛岡市は岩手県の県庁所在地で、わんこそば・冷麺・じゃじゃ麺の三大麺が有名です。石割桜や盛岡城跡公園など歴史と自然が調和する城下町です。' },
  { name: '一関市', pref: '岩手県', prefix: 'ichinoseki-', desc: '一関市は岩手県南部に位置し、猊鼻渓の舟下りや厳美渓の景勝地で知られています。もち食文化が300年以上続く「もちのまち」としても有名です。' },
  { name: '花巻市', pref: '岩手県', prefix: 'hanamaki-', desc: '花巻市は宮沢賢治の故郷として知られ、花巻温泉郷や宮沢賢治記念館が人気スポットです。大谷翔平選手の出身地としても注目を集めています。' },
];
...
export const cityGrantsBatch96: Grant[] = cities.flatMap(c => genGrants(c));
