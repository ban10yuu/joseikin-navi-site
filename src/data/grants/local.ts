...
export const localGrants: Grant[] = [
  ...
  },
  {
    ...
    organization: '東京都',
    type: 'local',
    maxAmount: '割引券方式（1時間あたり最大2,500円）',
    maxAmountNum: 0,
    category: 'childcare',
    prefecture: '東京都',
  ...
  // ────────────────────────────────────────────────
  // 追加 8 grants（under-represented prefectures & categories）
  // ────────────────────────────────────────────────
  {
    slug: 'nagano-disaster-mudslide-support',
    title: '長野県 土砂災害被災者住宅再建支援事業',
    organization: '長野県',
    type: 'local',
    maxAmount: '最大200万円',
    maxAmountNum: 200,
    category: 'disaster',
    prefecture: '長野県',
    tags: ['長野県関連', '災害関連', '住宅再建'],
    eligibility: '長野県内で土砂災害により住宅に被害を受けた方が対象です。り災証明書の交付を受けていることが要件となります。',
    applicationPeriod: '災害発生後随時（予算の範囲内）',
    description: '長野県が独自に実施する土砂災害被災者向けの住宅再建支援事業です。国の被災者生活再建支援金に上乗せする形で、最大200万円の補助金を交付します。山間部が多い長野県特有の地形リスクに対応した制度です。',
    sections: [
      {
        heading: '制度の概要と背景',
        content: '<p>長野県は山間部が多く、<span class="marker">毎年のように土砂災害が発生</span>しています。2019年の台風19号では千曲川流域を中心に甚大な被害が生じ、その教訓を踏まえて住宅再建支援が拡充されました。</p><p>この制度は、国の被災者生活再建支援金だけではカバーしきれない住宅再建費用を県独自に補助するものです。土砂災害特別警戒区域からの移転を促進する目的も含まれています。</p><p>県と市町村が連携して運営しており、被災者の負担を最小限に抑える仕組みが整えられています。</p><div class="highlight-box">長野県内の市町村が独自に実施する上乗せ制度もあります。県の補助金と合わせて利用できる場合がありますので、お住まいの市町村にもご確認ください。</div>'
      },
      {
        heading: '補助金額と対象',
        content: '<div class="summary-box" data-title="補助金額"><p>住宅全壊・大規模半壊で建替え：最大200万円</p><p>住宅全壊・大規模半壊で補修：最大100万円</p><p>半壊で補修：最大50万円</p><p>土砂災害特別警戒区域からの移転：加算50万円</p></div><p>補助対象経費は住宅の建替え、購入、補修に要する費用です。<span class="marker-green">家財の購入費や引越し費用は対象外</span>ですが、これらは国の被災者生活再建支援金でカバーできます。</p><p>土砂災害特別警戒区域（レッドゾーン）からの移転を伴う場合は、50万円の加算があります。これは将来の災害リスクを低減するための政策的な加算です。</p>'
      },
      {
        heading: '申請方法',
        content: '<p>申請はお住まいの<strong>市町村の窓口</strong>で行います。り災証明書の取得が前提となりますので、被災後はまず市町村にり災証明書の発行を依頼してください。</p><p>必要書類は、補助金交付申請書、り災証明書、住民票、工事見積書または売買契約書の写し、被災状況の写真などです。</p><div class="highlight-box">被災直後は混乱しますが、住宅の被害状況を写真で記録しておくことが非常に重要です。り災証明の調査にも役立ちます。</div><p>審査期間は概ね1〜2ヶ月程度です。交付決定後に工事に着手し、完了報告を経て補助金が支給されます。</p>'
      },
      {
        heading: '土砂災害への日頃の備え',
        content: '<p>長野県では<span class="marker">土砂災害警戒区域が約3万箇所</span>指定されています。自宅がどのような災害リスクのある場所にあるか、ハザードマップで確認しておくことが重要です。</p><p>長野県の「信州くらしのマップ」や国土交通省の「重ねるハザードマップ」で、土砂災害警戒区域を確認できます。</p><p>豪雨時には早めの避難が命を守ります。土砂災害警戒情報が発表されたら、躊躇なく避難行動をとりましょう。</p><p>火災保険に「水災」補償を付帯しておくことも、経済的な備えとして有効です。</p>'
      },
      {
        heading: '関連する支援制度',
        content: '<p>土砂災害からの復旧・復興には複数の支援制度を組み合わせることが重要です。</p><p><span class="marker-green">国の被災者生活再建支援金（最大300万円）、災害援護資金（最大350万円）、住宅金融支援機構の災害復興住宅融資</span>などと本制度を併用できます。</p><blockquote>「どの制度がいくら使えるのか分からない」という方は、市町村に設置される被災者支援相談窓口にご相談ください。まとめて案内してもらえます。</blockquote><p>長野県社会福祉協議会による生活福祉資金の特例貸付や、日本赤十字社の義援金なども、被災状況に応じて利用できます。</p>'
      }
    ],
    officialUrl: 'https://www.pref.nagano.lg.jp/kensetsu/kurashi/sumai/saigai-shien.html',
    publishedAt: '2026-03-13',
  },
  {
    slug: 'kumamoto-nursing-care-robot',
    title: '熊本県 介護ロボット等導入支援事業',
    organization: '熊本県',
    type: 'local',
    maxAmount: '最大100万円',
    maxAmountNum: 100,
    category: 'nursing',
    prefecture: '熊本県',
    tags: ['熊本県関連', '介護関連', 'ICT活用'],
    eligibility: '熊本県内の介護サービス事業所で、介護ロボットやICT機器を導入する事業者が対象です。',
    targetOccupation: '介護事業者',
    applicationPeriod: '毎年4月〜6月（予算枠に達し次第終了）',
    description: '熊本県が介護現場の負担軽減と生産性向上を目的に実施する補助事業です。移乗支援ロボット、見守りセンサー、介護記録ソフトなどの導入費用を最大100万円まで補助します。介護人材不足に対応するテクノロジー活用を推進しています。',
    sections: [
      {
        heading: '事業の目的と背景',
        content: '<p>熊本県では高齢化の進展に伴い、介護人材の確保が大きな課題となっています。<span class="marker">介護ロボットやICT機器の導入</span>により、介護職員の身体的負担を軽減し、業務効率化を図ることで、介護サービスの質の向上と人材の定着を目指しています。</p><p>2016年の熊本地震の経験も踏まえ、ICTを活用した遠隔見守りや情報共有の重要性が再認識されたことも、本事業の推進力となっています。</p><p>国の「介護ロボット導入支援事業」と連携した県独自の上乗せ補助であり、事業者の自己負担を大幅に軽減します。</p><div class="highlight-box">熊本県は「くまもとスマート介護」を掲げ、テクノロジー活用による介護現場の変革を積極的に推進しています。</div>'
      },
      {
        heading: '補助対象となるロボット・機器',
        content: '<div class="summary-box" data-title="主な補助対象"><p>移乗支援ロボット（装着型・非装着型）</p><p>見守りセンサー・通知システム</p><p>排泄支援機器</p><p>介護記録ソフト（タブレット含む）</p><p>コミュニケーションロボット</p></div><p>厚生労働省が定める<span class="marker-green">介護ロボットの重点分野</span>（移乗介助、移動支援、排泄支援、見守り・コミュニケーション、入浴支援、介護業務支援）に該当する機器が対象です。</p><p>ICT機器については、介護記録の電子化やケアプラン作成支援ソフトなども含まれます。タブレット端末の購入費も補助対象となる場合があります。</p>'
      },
      {
        heading: '補助金額と補助率',
        content: '<p>補助金額は<strong>1事業所あたり最大100万円</strong>です。補助率は導入費用の3/4（一部機器は1/2）となっています。</p><p><span class="marker">見守りセンサーの導入は1台あたり上限30万円</span>、移乗支援ロボットは1台あたり上限100万円など、機器の種類によって個別の上限額が設定されています。</p><p>複数種類の機器を同時に導入することも可能ですが、1事業所あたりの合計上限は100万円です。</p><p>導入にあたっては、職員への操作研修や活用計画の策定も求められます。ハードの導入だけでなく、現場での定着を重視しています。</p>'
      },
      {
        heading: '申請手続き',
        content: '<p>申請は熊本県の<strong>長寿社会局</strong>に対して行います。公募期間は毎年4月〜6月頃ですが、予算枠に達し次第終了となります。</p><p>必要書類は、補助金交付申請書、事業計画書、導入機器の見積書・カタログ、介護サービス事業所の指定通知書の写しなどです。</p><div class="highlight-box">事前に導入機器のデモンストレーションを受けたり、すでに導入している事業所を見学したりして、自施設に合った機器を選定することが重要です。</div><p>交付決定後に機器を購入・導入し、完了報告書を提出して補助金を受け取ります。後払い方式のため、一時的な立替えが必要です。</p>'
      },
      {
        heading: '導入効果と活用のポイント',
        content: '<p>介護ロボットの導入効果として、<span class="marker-green">移乗介助時の腰痛リスクの低減、夜間見守りの効率化、記録業務の時間短縮</span>などが報告されています。</p><p>ただし、「導入したが使われていない」というケースも少なくありません。成功のポイントは、現場職員の意見を取り入れた機器選定と、継続的な研修・サポート体制の構築です。</p><blockquote>熊本県では「介護ロボット等相談窓口」を設置しており、機器選定から導入後のフォローアップまで、専門のアドバイザーが無料で支援しています。</blockquote><p>導入後の効果測定も重要です。業務時間の変化、職員の負担感、利用者の満足度などを定期的に検証し、活用方法を改善していきましょう。</p>'
      }
    ],
    officialUrl: 'https://www.pref.kumamoto.jp/soshiki/30/kaigo-robot.html',
    publishedAt: '2026-03-16',
  },
  {
    slug: 'iwate-education-scholarship-returnee',
    title: '岩手県 Uターン就職奨学金返還支援事業',
    organization: '岩手県',
    type: 'local',
    maxAmount: '最大150万円',
    maxAmountNum: 150,
    category: 'education',
    prefecture: '岩手県',
    tags: ['岩手県関連', '教育関連', '奨学金返還支援'],
    eligibility: '大学等を卒業後、岩手県内にUターン就職し、正社員として就業する方で、奨学金の返還義務がある方が対象です。',
    targetOccupation: 'Uターン就職者',
    applicationPeriod: '毎年4月〜7月',
    description: '岩手県へのUターン就職を促進するため、奨学金の返還を支援する制度です。岩手県出身者が県外の大学等を卒業後に県内に戻って就職した場合、奨学金返還額の一部（最大150万円）を県が補助します。若者の地元定着と人口流出の歯止めを目的としています。',
    sections: [
      {
        heading: '制度の趣旨と概要',
        content: '<p>岩手県では若年層の県外流出が深刻な課題となっています。この制度は、<span class="marker">奨学金返還の負担を軽減することで、県出身の若者のUターン就職を促進</span>するものです。</p><p>対象となるのは、岩手県出身で県外の大学・大学院・短大・専門学校を卒業し、岩手県内の企業等に正社員として就職した方です。日本学生支援機構（JASSO）等の奨学金の返還義務があることが条件です。</p><p>県と市町村、さらに県内企業が連携して運営しており、地域全体で若者のUターンを支援する仕組みとなっています。</p><div class="highlight-box">東日本大震災からの復興が進む中、地域の将来を担う若い人材の確保は岩手県にとって最重要課題のひとつです。</div>'
      },
      {
        heading: '補助金額と支援期間',
        content: '<div class="summary-box" data-title="支援内容"><p>奨学金返還額の1/2を補助（上限：年間30万円）</p><p>支援期間：最長5年間</p><p>最大補助額：150万円</p></div><p>奨学金の月々の返還額の半額を、<span class="marker-green">最長5年間にわたって県が補助</span>します。例えば月額2万円の返還をしている場合、毎月1万円（年間12万円）が補助されます。</p><p>補助対象となる奨学金は、日本学生支援機構（JASSO）、都道府県・市区町村の奨学金、学校独自の奨学金など、公的な貸与型奨学金全般です。</p><p>なお、岩手県内の特定の産業分野（IT、建設、医療福祉など）に就職した場合は、補助率が引き上げられる優遇措置もあります。</p>'
      },
      {
        heading: '対象者の要件',
        content: '<p>以下のすべてを満たす方が対象です。<strong>1.</strong> 岩手県出身者（県内高校卒業者等）であること。<strong>2.</strong> 県外の大学等を卒業していること。<strong>3.</strong> 卒業後3年以内に岩手県内の企業等に<span class="marker">正社員として就職</span>していること。</p><p><strong>4.</strong> 公的な貸与型奨学金の返還義務があること。<strong>5.</strong> 就職後、岩手県内に住所を有していること。<strong>6.</strong> 県税の滞納がないこと。</p><div class="note-box">「Uターン」だけでなく、岩手県にゆかりのある方の「Iターン」就職にも一部対応している場合があります。詳細は県の担当窓口にお問い合わせください。</div><p>公務員としての就職は対象外となる場合があります。事前に確認が必要です。</p>'
      },
      {
        heading: '申請手続き',
        content: '<p>申請は岩手県の<strong>定住推進課</strong>または市町村の移住定住相談窓口で行います。毎年4月〜7月頃に募集が行われますが、定員に限りがあるため早めの申請をおすすめします。</p><p>必要書類は、申請書、奨学金の貸与証明書、奨学金返還の証明書、在職証明書、住民票、所得証明書などです。</p><p>審査は書類審査で行われ、8月頃に結果が通知されます。<span class="marker-green">採択後は毎年の継続申請</span>が必要で、在職状況や県内居住の確認が行われます。</p><p>補助金は年度末にまとめて支給されるため、奨学金の返還自体は通常通り続ける必要があります。</p>'
      },
      {
        heading: '岩手県で働くメリット',
        content: '<p>岩手県は豊かな自然環境と温かい人間関係が魅力です。<span class="marker">住居費や生活費が都市部と比べて格段に安く</span>、奨学金の返還負担を考慮しても、生活の質は高いと言えます。</p><p>IT企業のサテライトオフィスや地元の製造業、医療福祉分野など、多様な就職先があります。特にIT分野では、リモートワークを併用しながら岩手で暮らすという選択肢も広がっています。</p><blockquote>「地元に戻りたいが、奨学金の返済が不安」という声に応えるための制度です。Uターンを検討している方は、まず岩手県の移住相談窓口に気軽に相談してみてください。</blockquote><p>岩手県では「いわてで暮らそう」キャンペーンも展開しており、住宅支援や子育て支援など、移住者向けの制度が充実しています。</p>'
      }
    ],
    officialUrl: 'https://www.pref.iwate.jp/kurashikankyou/ijuu/1006612/index.html',
    publishedAt: '2026-03-22',
  },
  {
    slug: 'mie-employment-workcation',
    title: '三重県 ワーケーション推進補助金',
    organization: '三重県',
    type: 'local',
    maxAmount: '最大50万円',
    maxAmountNum: 50,
    category: 'employment',
    prefecture: '三重県',
    tags: ['三重県関連', '雇用関連', 'テレワーク'],
    eligibility: '三重県内でワーケーションプログラムを企画・実施する事業者、または三重県へのワーケーション誘致に取り組む宿泊施設等が対象です。',
    targetOccupation: '宿泊事業者・コワーキングスペース運営者',
    applicationPeriod: '毎年4月〜8月',
    description: '三重県がワーケーション（Work+Vacation）の推進を目的に実施する補助金制度です。県内のワーケーション環境整備やプログラム開発に要する費用を最大50万円まで補助します。関係人口の創出と地域経済の活性化を目指しています。',
    sections: [
      {
        heading: '制度の概要',
        content: '<p>三重県ワーケーション推進補助金は、<span class="marker">三重県への関係人口創出と地域活性化</span>を目的とした制度です。コロナ禍をきっかけに広がったリモートワークの潮流を活かし、「働きながら三重の魅力を体験する」ワーケーションスタイルの普及を推進しています。</p><p>伊勢志摩や熊野古道など、三重県が誇る豊かな観光資源とテレワーク環境を組み合わせた新しい滞在スタイルの確立を目指しています。</p><p>宿泊施設のワーケーション対応改修、コワーキングスペースの整備、体験プログラムの開発など、幅広い取り組みが補助対象です。</p><div class="highlight-box">三重県は2022年に「みえワーケーション協議会」を設立し、官民一体でワーケーション環境の整備を進めています。</div>'
      },
      {
        heading: '補助対象事業',
        content: '<div class="summary-box" data-title="対象事業の例"><p>宿泊施設のWi-Fi整備・ワークスペース設置</p><p>ワーケーション体験プログラムの開発・実施</p><p>コワーキングスペースの新設・改修</p><p>ワーケーション誘致のためのプロモーション活動</p></div><p>ハード整備（通信環境、デスク・椅子等の設備）とソフト事業（プログラム開発、モニターツアー、情報発信）の両方が対象です。</p><p><span class="marker-green">地域の特色を活かした体験プログラム</span>（海女体験、真珠養殖見学、茶摘み体験など）とテレワークを組み合わせた企画が特に歓迎されます。</p><p>既存の観光事業者がワーケーション対応に転換するケースも多く、新規参入のハードルは比較的低い制度です。</p>'
      },
      {
        heading: '補助金額と補助率',
        content: '<p>補助金額は<strong>1事業者あたり最大50万円</strong>で、補助率は対象経費の2/3以内です。つまり、75万円の事業を行った場合に50万円の補助を受けられる計算です。</p><p>ハード整備とソフト事業を組み合わせた申請も可能です。ただし、<span class="marker">通常の宿泊施設改修（ワーケーションと関係のない改修）は対象外</span>です。</p><p>補助金は後払い方式で、事業完了後に実績報告書を提出し、確定検査を経て交付されます。</p><p>なお、国や他の自治体の補助金と併用できる場合がありますが、補助対象経費の重複は認められません。</p>'
      },
      {
        heading: '申請手続き',
        content: '<p>申請は三重県の<strong>雇用経済部 観光局</strong>に対して行います。公募期間は毎年4月〜8月頃で、審査を経て9月頃に採択結果が通知されます。</p><p>必要書類は、補助金交付申請書、事業計画書、収支予算書、見積書、事業者の概要がわかる資料などです。</p><div class="highlight-box">審査では、事業の実現可能性、地域への波及効果、持続可能性などが評価されます。単発のイベントではなく、継続的な取り組みにつながる計画が高く評価される傾向があります。</div><p>採択後は、事業実施→実績報告→確定検査→補助金交付という流れになります。事業期間は年度内（翌年3月末まで）です。</p>'
      },
      {
        heading: 'ワーケーション推進の意義',
        content: '<p>ワーケーションは、<span class="marker-green">地方と都市部をつなぐ新しい交流の形</span>として注目されています。一時的な観光ではなく、ある程度の期間滞在することで、地域への理解と愛着が深まり、将来的な移住や二拠点居住につながることも期待されます。</p><p>三重県にとっては、平日の宿泊需要の創出、地域の魅力発信、関係人口の拡大など、多面的なメリットがあります。</p><blockquote>「伊勢志摩の海を見ながらリモートワーク」「熊野古道を歩いた後にオンライン会議」など、三重ならではのワーケーション体験が多くのリモートワーカーに支持されています。</blockquote><p>企業側にとっても、社員のリフレッシュや創造性の向上、福利厚生の充実といった効果が報告されています。</p>'
      }
    ],
    officialUrl: 'https://www.pref.mie.lg.jp/KANKO/HP/workation.htm',
    publishedAt: '2026-03-27',
  },
  {
    slug: 'kagoshima-childcare-third-child',
    title: '鹿児島県 第3子以降子育て支援金',
    organization: '鹿児島県',
    type: 'local',
    maxAmount: '30万円',
    maxAmountNum: 30,
    category: 'childcare',
    prefecture: '鹿児島県',
    tags: ['鹿児島県関連', '子育て関連', '第3子以降'],
    eligibility: '鹿児島県内に住所を有し、第3子以降の子どもが出生した方が対象です。上の子2人が18歳未満であることが条件です。',
    applicationPeriod: '出生届出後〜6ヶ月以内',
    description: '鹿児島県が少子化対策として実施する第3子以降の出生を祝う支援金制度です。第3子以降の子どもが生まれた家庭に30万円を支給します。多子世帯の経済的負担を軽減し、安心して子育てできる環境づくりを目指しています。',
    sections: [
      {
        heading: '制度の概要',
        content: '<p>鹿児島県 第3子以降子育て支援金は、<span class="marker">第3子以降の子どもの出生を祝い</span>、多子世帯の子育てを応援するための支援金です。少子化が進む鹿児島県において、安心して子どもを産み育てられる環境づくりの一環として実施されています。</p><p>支給額は子ども1人あたり30万円で、返済の必要はありません。第4子、第5子と出生するたびに申請できます。</p><p>鹿児島県と市町村が連携して運営しており、申請はお住まいの市町村の窓口で行います。</p><div class="highlight-box">鹿児島県内の市町村が独自に実施している出産祝い金と併せて受給できる場合があります。お住まいの市町村にもご確認ください。</div>'
      },
      {
        heading: '対象者の要件',
        content: '<div class="summary-box" data-title="要件"><p>鹿児島県内に住所を有すること</p><p>第3子以降の子どもが出生したこと</p><p>上の子2人（第1子・第2子）が18歳未満であること</p><p>出生した子どもを養育していること</p></div><p>「第3子以降」のカウント方法は、<span class="marker-green">18歳未満の子どもの中で3番目以降</span>という計算になります。例えば、第1子が20歳、第2子が15歳の場合、新たに生まれた子は「第2子」としてカウントされ、対象外となります。</p><p>双子・三つ子の場合は、それぞれの子どもについて支給判定が行われます。第2子と第3子が双子で生まれた場合、第3子分の1人分が対象となります。</p>'
      },
      {
        heading: '申請方法',
        content: '<p>申請は<span class="marker">出生届出後6ヶ月以内</span>に、お住まいの市町村の窓口で行います。出生届の提出時にあわせて手続きするのがスムーズです。</p><p>必要書類は、支援金支給申請書、母子健康手帳の写し（出生の記録）、世帯全員の住民票、振込先口座の通帳の写しなどです。</p><p>審査は市町村で行われ、通常2〜4週間程度で支給が決定されます。決定後、指定口座に振り込まれます。</p><p>申請期限を過ぎると受給できなくなりますので、忘れずに手続きしましょう。</p>'
      },
      {
        heading: '鹿児島県の子育て支援制度',
        content: '<p>鹿児島県では、第3子以降支援金のほかにも多くの子育て支援制度が整備されています。</p><p><strong>子ども医療費助成</strong>（中学校卒業まで医療費無料）、<strong>保育料の軽減</strong>（第2子半額、第3子以降無料の自治体も）、<strong>放課後児童クラブの充実</strong>など、出産から子育てまで切れ目のない支援が受けられます。</p><div class="note-box">市町村によって独自の上乗せ制度があります。例えば、一部の市町村では第1子から出産祝い金を支給しているところもあります。</div><p>鹿児島県の「かごしま子育て支援パスポート」を取得すると、県内の協賛店舗で割引やサービスを受けられます。</p>'
      },
      {
        heading: '多子世帯への経済的支援の重要性',
        content: '<p>子どもが3人以上いる世帯では、<span class="marker-green">教育費、食費、衣服費などの出費が大きく</span>、経済的な負担が子どもの数に応じて増加します。こうした多子世帯の負担を軽減することは、少子化対策の観点からも重要です。</p><p>国の制度（児童手当の第3子加算、高校授業料の多子世帯優遇など）と県の制度を組み合わせることで、トータルでの支援額は相当なものになります。</p><blockquote>「3人目は経済的に不安」という声に応えるため、鹿児島県では出産から教育まで、多子世帯に対する多層的な支援体制を整えています。</blockquote><p>将来的な教育費に備えて、支援金を学資保険や教育資金の積み立てに活用するのも賢い使い方です。</p>'
      }
    ],
    officialUrl: 'https://www.pref.kagoshima.jp/ab15/kenko-fukushi/kodomo/kosodate/dai3shi.html',
    publishedAt: '2026-03-30',
  },
  {
    slug: 'nara-housing-akiya-renovation',
    title: '奈良県 空き家リノベーション補助金',
    organization: '奈良県',
    type: 'local',
    maxAmount: '最大150万円',
    maxAmountNum: 150,
    category: 'housing',
    prefecture: '奈良県',
    tags: ['奈良県関連', '住宅関連', '空き家活用'],
    eligibility: '奈良県内の空き家を購入またはリノベーションして居住する個人、または空き家を地域活性化のために活用する事業者が対象です。',
    applicationPeriod: '毎年4月〜9月（先着順）',
    description: '奈良県が深刻化する空き家問題の解消と移住促進を目的に実施する補助金制度です。空き家のリノベーション費用を最大150万円まで補助し、空き家の利活用を推進します。古民家再生による地域活性化にも対応しています。',
    sections: [
      {
        heading: '制度の背景と目的',
        content: '<p>奈良県では空き家率が全国平均を上回る水準で推移しており、<span class="marker">防犯・防災・景観の面で深刻な問題</span>となっています。特に、歴史的な町並みが残る地域での空き家増加は、文化財保護の観点からも課題です。</p><p>この補助金は、空き家をリノベーションして居住用または地域活性化のために活用することを促進し、空き家問題の解消と地域の魅力向上を同時に実現することを目指しています。</p><p>奈良県ならではの古民家や町家をリノベーションして、カフェやゲストハウス、シェアオフィスとして活用する事例も増えており、地域経済への波及効果も期待されています。</p><div class="highlight-box">奈良県空き家バンクに登録されている物件を活用する場合は、補助率が優遇されます。</div>'
      },
      {
        heading: '補助金額と補助対象',
        content: '<div class="summary-box" data-title="補助内容"><p>居住用リノベーション：工事費の1/2（上限100万円）</p><p>地域活性化用途（カフェ・宿泊施設等）：工事費の2/3（上限150万円）</p><p>耐震改修を伴う場合：加算50万円</p></div><p>補助対象となる工事は、屋根・外壁・内装の改修、水回りの更新、耐震補強、断熱改修、バリアフリー改修などです。</p><p><span class="marker-green">家具の購入や外構工事は対象外</span>です。ただし、造り付けの収納やキッチンなど、建物と一体となる設備は対象に含まれます。</p><p>古民家や町家の場合、歴史的な意匠を残したリノベーションが推奨されており、伝統工法を用いた改修には加点評価があります。</p>'
      },
      {
        heading: '申請の流れ',
        content: '<p>申請は奈良県の<strong>地域デザイン推進局</strong>に対して行います。先着順での受付となるため、年度の早い時期に申請するのが有利です。</p><p>手続きの流れは、事前相談→申請書提出→審査・交付決定→工事着手→完了報告→補助金交付です。<span class="marker">必ず交付決定を受けてから工事に着手</span>してください。</p><p>必要書類は、補助金交付申請書、リノベーション計画書、工事見積書、空き家の登記簿謄本、現況写真、活用計画書（地域活性化用途の場合）などです。</p><div class="note-box">奈良県空き家相談窓口では、物件探しから補助金申請、施工業者の紹介まで、ワンストップで相談できます。まずは相談からスタートしましょう。</div>'
      },
      {
        heading: '活用事例',
        content: '<p>奈良県内では、空き家リノベーションの成功事例が多数生まれています。<strong>奈良町</strong>の古い町家をカフェ兼ギャラリーに改修したケースや、<strong>吉野</strong>の林業集落の空き家をシェアハウスに転用したケースなどが代表的です。</p><p><span class="marker-green">移住者が空き家を購入してリノベーション</span>し、自宅兼テレワークオフィスとして活用する事例も増加しています。都市部からの移住需要と空き家の有効活用が結びついた好事例です。</p><p>地域のコミュニティスペースや子育て支援施設として空き家を活用するNPOの事例もあり、多様な活用方法が広がっています。</p><p>こうした事例は奈良県の空き家活用ポータルサイトで紹介されていますので、検討中の方はぜひ参考にしてください。</p>'
      },
      {
        heading: '注意点と関連制度',
        content: '<p>補助金を受けた物件は、<span class="marker">補助金交付後5年間は用途変更や転売が制限</span>されます。やむを得ない事情がある場合は県に相談してください。</p><p>耐震改修については、奈良県の「木造住宅耐震改修補助事業」と併用できる場合があります。空き家の耐震性に不安がある場合は、まず耐震診断（無料または低額で受けられる自治体が多い）を受けることをおすすめします。</p><blockquote>奈良県での暮らしを検討している方は、「奈良で暮らす」移住支援サイトもご覧ください。住居、仕事、子育て環境など、移住に必要な情報がまとまっています。</blockquote><p>固定資産税の減免措置や、移住支援金（最大100万円）など、他の支援制度と組み合わせることで、移住のハードルを大幅に下げることができます。</p>'
      }
    ],
    officialUrl: 'https://www.pref.nara.jp/53371.htm',
    publishedAt: '2026-04-03',
  },
  {
    ...
    category: 'medical',
    prefecture: '栃木県',
    tags: ['栃木県関連', '医療関連', '不妊治療'],
    eligibility: '栃木県内に住所を有する夫婦で、不妊治療を受けている方が対象です。所得制限はありません（2022年度から撤廃）。',
    applicationPeriod: '通年（治療終了日から60日以内）',
    description: '栃木県が実施する不妊治療費の助成制度です。2022年4月の不妊治療保険適用化以降も、保険適用外の先進医療や自費診療分について最大30万円の助成を行っています。不妊に悩むカップルの経済的負担を軽減します。',
    sections: [
      {
        heading: '制度の概要',
        content: '<p>栃木県の不妊治療費助成事業は、<span class="marker">子どもを望むカップルの不妊治療にかかる経済的負担を軽減</span>するための制度です。2022年4月から不妊治療に健康保険が適用されるようになりましたが、保険適用外の治療も多く、依然として高額な費用がかかるケースがあります。</p><p>この制度では、保険適用外の先進医療や自費診療の費用を対象に助成を行います。2022年度からは所得制限が撤廃され、より多くの方が利用できるようになりました。</p><p>栃木県と市町村が連携して運営しており、市町村独自の上乗せ制度がある場合もあります。</p><div class="highlight-box">不妊治療は身体的にも精神的にも負担の大きい治療です。経済面の不安を少しでも軽減し、安心して治療に臨めるよう支援します。</div>'
      },
      {
        heading: '助成金額と対象治療',
        content: '<div class="summary-box" data-title="助成内容"><p>保険適用外の先進医療：1回あたり最大15万円</p><p>保険適用外の自費診療：1回あたり最大30万円</p><p>男性不妊治療：1回あたり最大15万円（加算）</p><p>年間回数制限：なし（通算回数制限あり）</p></div><p>対象となる治療は、体外受精、顕微授精およびこれに付随する治療です。<span class="marker-green">人工授精は保険適用となったため、原則として本制度の対象外</span>です。</p><p>先進医療として認められている治療（タイムラプス、PICSI、ERA検査等）で保険診療と併用しているものが主な対象となります。</p><p>男性不妊治療（精巣内精子採取術等）を併せて行った場合は、最大15万円が加算されます。</p>'
      },
      {
        heading: '対象者と申請要件',
        content: '<p>以下の要件を満たす方が対象です。<strong>1.</strong> 法律上の婚姻をしている夫婦であること（事実婚も対象）。<strong>2.</strong> 夫婦の少なくとも一方が栃木県内に住所を有すること。<strong>3.</strong> 指定医療機関で治療を受けていること。</p><p><span class="marker">所得制限は2022年度から撤廃</span>されていますので、所得に関係なく申請できます。</p><p>年齢制限については、治療開始時点で妻の年齢が43歳未満であることが条件です。これは医学的な観点からの制限となっています。</p><div class="note-box">事実婚のカップルも2021年度から対象に加わりました。申請時に「事実婚関係に関する申立書」の提出が必要です。</div>'
      },
      {
        heading: '申請手続き',
        content: '<p>申請は栃木県の<strong>保健福祉部こども政策課</strong>または各健康福祉センター（保健所）で行います。<span class="marker-green">治療が終了した日（妊娠が確認された日、または医師が終了と判断した日）から60日以内</span>に申請してください。</p><p>必要書類は、助成金支給申請書、不妊治療費助成事業受診等証明書（医療機関が記入）、医療機関の領収書の写し、住民票（夫婦の記載があるもの）、戸籍謄本（事実婚の場合は申立書）などです。</p><p>審査期間は概ね1〜2ヶ月程度で、承認後に指定口座に振り込まれます。</p><p>申請期限を過ぎると受付できない場合がありますので、治療が終了したら早めに手続きを進めましょう。</p>'
      },
      {
        heading: '不妊治療に関する相談窓口',
        content: '<p>栃木県では<strong>「とちぎ不妊・不育相談センター」</strong>を設置しており、不妊に関する相談を無料で受け付けています。</p><p><span class="marker">治療の進め方、病院の選び方、費用の相談、メンタルヘルス</span>など、幅広い相談に専門のスタッフが対応します。電話相談のほか、面接相談も予約制で利用できます。</p><blockquote>「治療を続けるか悩んでいる」「周囲に相談できる人がいない」という方も、一人で抱え込まず、まずは相談窓口を利用してみてください。同じ悩みを持つ方々の自助グループの紹介も行っています。</blockquote><p>不妊治療は夫婦だけの問題ではなく、職場の理解も重要です。栃木県では企業向けに「不妊治療と仕事の両立支援」の啓発も行っています。</p>'
      }
    ],
    officialUrl: 'https://www.pref.tochigi.lg.jp/e04/welfare/kodomo/funin/funin-josei.html',
    publishedAt: '2026-04-08',
  },
  {
    slug: 'nagasaki-living-island-life-support',
    title: '長崎県 離島生活支援補助金',
    organization: '長崎県',
    type: 'local',
    maxAmount: '最大60万円',
    ...
    category: 'living',
    prefecture: '長崎県',
    tags: ['長崎県関連', '生活支援関連', '離島振興'],
    eligibility: '長崎県内の離島に移住し、1年以上の居住を予定している方が対象です。18歳以上60歳未満の方で、就業または起業する意思があることが条件です。',
    applicationPeriod: '通年（移住前または移住後3ヶ月以内に申請）',
    description: '長崎県が離島地域への移住を促進するために実施する生活支援補助金です。引越し費用、家賃補助、生活立ち上げ費用を合わせて最大60万円を補助します。日本有数の離島県である長崎の離島地域を次の世代に引き継ぐための取り組みです。',
    sections: [
      {
        heading: '制度の概要と背景',
        content: '<p>長崎県は<span class="marker">日本で最も離島の数が多い県</span>（51の有人離島）であり、壱岐、対馬、五島列島をはじめとする離島地域は県の面積の約4割を占めています。しかし、人口減少と高齢化が急速に進み、地域の存続が危ぶまれる島も少なくありません。</p><p>この補助金は、離島への移住者を増やし、地域の活力を維持・向上させることを目的としています。移住に伴う初期費用の負担を軽減することで、「離島で暮らす」という選択肢を身近なものにします。</p><p>近年はテレワークの普及により、都市部の仕事を続けながら離島で暮らすという新しいライフスタイルも可能になっています。</p><div class="highlight-box">五島列島への移住者数は2020年以降急増しており、2025年には年間200名を超えるペースで推移しています。</div>'
      },
      {
        heading: '補助金額の内訳',
        content: '<div class="summary-box" data-title="補助内容"><p>引越し費用補助：最大20万円（実費の2/3）</p><p>家賃補助：月額最大2万円×12ヶ月＝最大24万円</p><p>生活立ち上げ費用：最大16万円</p><p>合計最大：60万円</p></div><p>引越し費用には船舶・航空便の輸送費も含まれます。離島への引越しは本土間の引越しよりも割高になるため、<span class="marker-green">輸送費の実費の2/3を補助</span>することで負担を軽減します。</p><p>家賃補助は月額最大2万円を1年間支給します。離島の家賃は本土に比べて安いものの、移住初期の負担を軽減する効果があります。</p><p>生活立ち上げ費用は、家具・家電の購入、自動車の島への輸送費用などに充てることができます。</p>'
      },
      {
        heading: '対象者の要件',
        content: '<p>以下の要件を満たす方が対象です。<strong>1.</strong> 長崎県の離島に新たに住所を移すこと（県外からの移住またはの離島以外からの転居）。<strong>2.</strong> 18歳以上60歳未満であること。<strong>3.</strong> 1年以上の居住を予定していること。</p><p><strong>4.</strong> <span class="marker">離島で就業または起業する意思</span>があること（テレワークも可）。<strong>5.</strong> 過去にこの補助金を受給していないこと。</p><p>家族での移住の場合は、世帯主が代表して申請します。子どもがいる世帯は加算がある場合もあります。</p><div class="note-box">Uターン（離島出身者が戻る場合）も対象です。ただし、直近3年以内に当該離島に住所があった方は対象外となる場合があります。</div>'
      },
      {
        heading: '申請手続き',
        content: '<p>申請は長崎県の<strong>地域づくり推進課</strong>または移住先の市町の担当窓口で行います。移住前の事前申請が推奨されていますが、<span class="marker-green">移住後3ヶ月以内の申請も受け付けています</span>。</p><p>必要書類は、補助金交付申請書、移住計画書、就業予定証明書または起業計画書、住民票（移住後の場合）、引越し費用の見積書・領収書などです。</p><p>テレワークで現在の仕事を継続する場合は、勤務先からの在宅勤務承認書等の提出が求められます。</p><p>審査後、交付決定通知が届きます。補助金は引越し費用と生活立ち上げ費用は一括、家賃補助は四半期ごとの支給となります。</p>'
      },
      {
        heading: '離島暮らしの魅力と注意点',
        content: '<p>長崎の離島は<span class="marker">美しい海と豊かな自然、独自の文化、新鮮な海産物</span>が魅力です。五島列島は世界遺産「長崎と天草地方の潜伏キリシタン関連遺産」の構成資産がある歴史的にも価値の高い地域です。</p><p>一方で、台風の影響による交通の乱れ、医療機関の限られた選択肢、買い物の不便さなど、離島特有の課題もあります。移住前に「お試し滞在」を経験することを強くおすすめします。</p><blockquote>長崎県では「ながさき移住倶楽部」を運営しており、移住体験ツアーや先輩移住者との交流会など、移住前に情報収集できる機会を豊富に提供しています。</blockquote><p>離島での生活は、コミュニティとの関わりが都市部よりも密になります。地域の行事やお付き合いを楽しめる方に向いている暮らし方です。</p>'
      }
    ],
    officialUrl: 'https://www.pref.nagasaki.jp/bunrui/kurashi-kankyo/ijyu-teijyu/ritou-support/',
    publishedAt: '2026-04-12',
  },
];
