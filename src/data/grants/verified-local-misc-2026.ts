...
export const verifiedLocalMiscGrants2026: Grant[] = [
  ...
  },
  {
    ...
    relatedCategories: ['disaster', 'living'],
    prefecture: '宮崎県',
    tags: ['宮崎市', '木造住宅', '耐震診断', '建替え', '令和8年度'],
    eligibility: '宮崎市内の対象木造住宅について、耐震診断、除却、建替えなどの公式要件を満たす所有者、管理者、占有者が対象です。',
    applicationPeriod: '耐震診断・除却・建替えは2026年5月11日から2026年6月30日16時30分まで。耐震改修は2026年6月12日に受付終了',
    deadlineDate: '2026-06-30',
    description: '宮崎市が、木造住宅の耐震化を進めるため、耐震診断士派遣、長屋・共同住宅の耐震診断、除却、建替えなどを支援する制度です。',
    sections: [
      { heading: '制度の概要', content: '<p>宮崎市の木造住宅耐震化支援は、昭和56年5月31日以前に着工された木造住宅などを対象に、耐震診断や耐震化関連工事を支援する制度です。既存の生成データでは住宅省エネリフォーム補助金としていましたが、公式ページで確認できる現行の耐震化支援へ修正しています。</p>' },
      { heading: '補助内容', content: '<p>公式ページでは、長屋・共同住宅の耐震診断は費用の3分の2・上限33.6万円、建替えは建替え工事費等の23%・上限38万円と案内されています。耐震改修は費用の80%・上限115万円ですが、2026年6月12日16時30分で令和8年度の受付が終了しています。</p>' },
      { heading: '申請の注意点', content: '<p>令和8年度は先着順ではなく抽選で対象者を決定します。耐震診断、除却、建替えの申込期間は2026年6月30日16時30分までです。オンラインの宮崎市スマート申請にも対応しています。</p>' }
    ],
    officialUrl: 'https://www.city.miyazaki.miyazaki.jp/business/architecture/earthquake_resistant/148080.html',
    sourceName: '宮崎市 木造住宅の耐震化を支援します',
    sourceUrls: ['https://www.city.miyazaki.miyazaki.jp/business/architecture/earthquake_resistant/148080.html'],
    sourceNote: '宮崎市公式ページで、令和8年度の木造住宅耐震化支援、耐震診断・除却・建替えの申込期限2026年6月30日、長屋・共同住宅の耐震診断上限33.6万円、建替え上限38万円、耐震改修上限115万円は2026年6月12日受付終了済みを確認。旧生成データの省エネリフォーム補助金最大30万円から現行制度へ修正。',
    verifiedAt,
    publishedAt: '2026-06-27',
  },
  {
    slug: 'kagoshima-city-sme-support',
    title: '鹿児島市 メイドインかごしま支援事業',
    organization: '鹿児島市',
    type: 'local',
    maxAmount: '最大30万円',
    maxAmountNum: 30,
    ...
    relatedCategories: ['living'],
    prefecture: '鹿児島県',
    tags: ['鹿児島市', '製造業', '販路拡大', '設備導入', '令和8年度'],
    eligibility: '鹿児島市税を滞納していない中小企業者（製造業者）等で、補助金等交付決定日以降に事業へ着手し、当該年度末までに完了できるなど公式要件を満たす方が対象です。',
    applicationPeriod: '受付中。受付は先着順',
    description: '鹿児島市が、市内中小企業者（製造業者）等の経営基盤強化や競争力向上を促進するため、設備導入、新商品開発、販路開拓などの取組を支援する制度です。',
    sections: [
      { heading: '制度の概要', content: '<p>メイドインかごしま支援事業は、鹿児島市内の中小企業者（製造業者）等を対象に、製品開発、事業承継・人材育成、新商品販路開拓、商談会等出展などを支援する制度です。既存の生成データでは汎用的な中小企業振興補助金としていましたが、公式ページの現行制度へ修正しています。</p>' },
      { heading: '補助内容', content: '<p>公式ページでは、製品開発促進設備導入事業は個別企業30万円、事業承継・人材育成支援事業は20万円、商談会等出展事業は10万円などの限度額が案内されています。いずれも補助対象経費の2分の1以内を補助します。</p>' },
      { heading: '申請の注意点', content: '<p>受付は先着順です。交付決定日以降に応募する計画へ着手し、当該年度末までに事業を完了できることが必要です。国、県、市等の他事業から補助金等を受けている事業は補助対象外です。</p>' }
    ],
    officialUrl: 'https://www.city.kagoshima.lg.jp/san-shien/sangyo/shokogyo/sezogyonado/meidoin2019.html',
    sourceName: '鹿児島市 メイドインかごしま支援事業',
    sourceUrls: ['https://www.city.kagoshima.lg.jp/san-shien/sangyo/shokogyo/sezogyonado/meidoin2019.html'],
    sourceNote: '鹿児島市公式ページで、令和8年度メイドインかごしま支援事業、受付先着順、製品開発促進設備導入上限30万円、事業承継・人材育成上限20万円、商談会等出展上限10万円、補助率2分の1以内を確認。旧生成データの中小企業振興補助金最大50万円から現行制度へ修正。',
    verifiedAt,
    publishedAt: '2026-06-27',
  },
  {
    slug: 'kagoshima-regional-business-support-2026',
    title: '鹿児島市 地域課題解決ビジネス支援事業補助金',
    organization: '鹿児島市',
    type: 'local',
    maxAmount: '最大750万円',
    maxAmountNum: 750,
    ...
    relatedCategories: ['living'],
    prefecture: '鹿児島県',
    tags: ['鹿児島市', '地域課題解決', 'ふるさと納税', '起業家支援', '令和8年度'],
    eligibility: '鹿児島市内外の人々から広く共感を得られる地域課題解決を目指す事業者、または起業家の成長を支援する団体で、公式要件を満たす事業者・団体が対象です。',
    applicationPeriod: '二次公募は2026年6月15日から2026年7月3日まで',
    deadlineDate: '2026-07-03',
    description: '鹿児島市が、ふるさと納税を活用した資金調達の機会を提供し、調達資金を原資とした補助金により地域課題解決型ビジネスを支援する制度です。',
    sections: [
      { heading: '制度の概要', content: '<p>鹿児島市地域課題解決ビジネス支援事業補助金は、ビジネスによる地域課題解決や起業家支援団体の成長を支援する制度です。クラウドファンディング型ふるさと納税制度または企業版ふるさと納税制度を活用し、集まった寄附額を原資として補助金交付申請を行います。</p>' },
      { heading: '補助内容', content: '<p>公式ページでは、クラウドファンディング型ふるさと納税制度は最大300万円または集まった調達資金相当額の低い額、企業版ふるさと納税制度は最大750万円または集まった調達資金相当額の低い額が補助限度額です。補助率はいずれも補助対象経費の10分の10です。</p>' },
      { heading: '申請の注意点', content: '<p>二次公募の募集期間は2026年6月15日から7月3日までです。補助対象期間は交付決定日から2027年3月31日までで、補助金は補助対象事業が終了し、所定の実績報告が完了した日以降に交付されます。</p>' }
    ],
    officialUrl: 'https://www.city.kagoshima.lg.jp/san-sousyutu/sougyou-startupshien/chiikikadaikaiketubusinesshojyokinr8-2.html',
    sourceName: '鹿児島市 令和8年度地域課題解決ビジネス支援事業補助金',
    sourceUrls: ['https://www.city.kagoshima.lg.jp/san-sousyutu/sougyou-startupshien/chiikikadaikaiketubusinesshojyokinr8-2.html'],
    sourceNote: '鹿児島市公式ページで、2026年6月15日更新、二次公募2026年6月15日から7月3日、クラウドファンディング型上限300万円、企業版ふるさと納税型上限750万円、補助率10分の10、補助対象期間は交付決定日から2027年3月31日までを確認。新規の公式確認済み地域課題解決ビジネス支援として追加。',
    verifiedAt,
    publishedAt: '2026-06-27',
  },
  {
    slug: 'takamatsu-sme-support',
    title: '高松市 特産品・伝統的ものづくり販売促進事業補助金',
    organization: '高松市',
    type: 'local',
    maxAmount: '最大15万円',
    maxAmountNum: 15,
    ...
    relatedCategories: ['living'],
    prefecture: '香川県',
    tags: ['高松市', '特産品', '伝統的ものづくり', '販路開拓', '令和8年度'],
    eligibility: '高松市内に住所を有する個人事業主、市内に主たる事業所を有する会社、市内に主たる事務所を有する商工団体などで、特産品や伝統的ものづくりに関する公式要件を満たす事業者が対象です。',
    applicationPeriod: '2026年4月17日から2027年1月29日まで。窓口受付のみ、先着順',
    deadlineDate: '2027-01-29',
    description: '高松市が、市内の特産品や伝統的ものづくり製品の販売促進に取り組む事業者等を支援する補助金です。',
    sections: [
      { heading: '制度の概要', content: '<p>高松市の特産品・伝統的ものづくり販売促進事業補助金は、販路開拓、広告宣伝、パッケージ等のデザイン活用、ECサイト開設・改良など、販売促進に必要な経費の一部を補助する制度です。既存の生成データでは汎用的な中小企業支援としていましたが、公式ページで確認できる現行制度へ修正しています。</p>' },
      { heading: '補助内容', content: '<p>補助上限額は15万円です。補助率は、特産品に関する事業が2分の1、伝統的ものづくり製品に関する事業が4分の3です。予定件数は伝統的ものづくり枠、特産品枠それぞれ5件程度です。</p>' },
      { heading: '申請の注意点', content: '<p>申請期間は2026年4月17日から2027年1月29日までで、申請方法は高松市産業振興課窓口での受付のみです。申請は1年度に1事業者1回限りで、予算上限に達した場合は受付終了となります。</p>' }
    ],
    officialUrl: 'https://www.city.takamatsu.kagawa.jp/jigyosha/sangyou/shoukougyou/tokusan/tenjikaihojyo.html',
    sourceName: '高松市 特産品・伝統的ものづくり販売促進事業補助金',
    sourceUrls: ['https://www.city.takamatsu.kagawa.jp/jigyosha/sangyou/shoukougyou/tokusan/tenjikaihojyo.html'],
    sourceNote: '高松市公式ページで、2026年5月27日更新、申請期間2026年4月17日から2027年1月29日、補助上限15万円、特産品枠補助率2分の1、伝統的ものづくり枠補助率4分の3、窓口受付のみ、先着順を確認。旧生成データの中小企業振興補助金から現行制度へ修正。',
    verifiedAt,
    publishedAt: '2026-06-27',
  },
  {
    ...
    relatedCategories: ['disaster', 'living'],
    prefecture: '愛媛県',
    tags: ['松山市', '木造住宅', '耐震改修', '耐風改修', '令和8年度'],
    eligibility: '昭和56年5月31日以前に着工された松山市内の対象木造住宅で、耐震診断の結果補強が必要と判断され、市税等の滞納がない所有者等が対象です。',
    applicationPeriod: '2026年4月15日から2027年1月29日まで。予算内で先着順',
    deadlineDate: '2027-01-29',
    description: '松山市が、南海地震などに備えた木造住宅の耐震改修設計、耐震改修工事、瓦屋根の耐風改修工事を支援する補助事業です。',
    sections: [
      { heading: '制度の概要', content: '<p>松山市木造住宅耐震改修等補助事業は、耐震診断で補強が必要と判断された昭和56年5月31日以前着工の一戸建て木造住宅などを対象に、耐震改修設計・工事と、あわせて行う瓦屋根の耐風改修を支援する制度です。既存の生成データでは住宅リフォーム助成としていましたが、公式ページで確認できる現行の耐震改修支援へ修正しています。</p>' },
      { heading: '補助内容', content: '<p>耐震改修設計費は補助対象経費の3分の2・上限20万円、耐震改修工事費は80%・上限115万円、耐風改修工事費は23%・上限69万円です。耐震改修設計、耐震改修工事、耐風改修工事を組み合わせると最大204万円の補助となります。</p>' },
      { heading: '申請の注意点', content: '<p>受付期間は2026年4月15日から2027年1月29日までで、予算内で先着順です。改修設計者、工事監理者、工事業者には愛媛県の登録など公式要件があるため、着手前に建築指導課での事前相談が必要です。</p>' }
    ],
    officialUrl: 'https://www.city.matsuyama.ehime.jp/kurashi/kurashi/hojokin/taishin_kaisyu2.html',
    sourceName: '松山市 木造住宅耐震改修等補助事業',
    sourceUrls: ['https://www.city.matsuyama.ehime.jp/kurashi/kurashi/hojokin/taishin_kaisyu2.html'],
    sourceNote: '松山市公式ページで、2026年4月1日更新、令和8年度受付2026年4月15日から2027年1月29日、耐震改修設計上限20万円、耐震改修工事上限115万円、耐風改修工事上限69万円、最大204万円を確認。旧生成データの住宅リフォーム助成から現行の耐震改修等補助へ修正。',
    verifiedAt,
    publishedAt: '2026-06-27',
  },
  {
    ...
    relatedCategories: ['housing', 'living'],
    prefecture: '愛媛県',
    tags: ['松山市', '木造住宅', '耐震診断', '派遣制度', '令和8年度'],
    eligibility: '昭和56年5月31日以前に着工された松山市内の一戸建て木造住宅など、公式の対象住宅要件を満たす住宅の所有者等が対象です。',
    applicationPeriod: '2026年4月15日から2027年1月29日まで。先着順',
    deadlineDate: '2027-01-29',
    description: '松山市が、木造住宅の耐震診断について、無料の派遣制度と、申請者が診断事務所を選ぶ補助制度を用意して支援する事業です。',
    sections: [
      { heading: '制度の概要', content: '<p>松山市木造住宅耐震診断事業は、昭和56年5月31日以前に着工された対象木造住宅の耐震診断を支援する制度です。診断業者の選定や診断費用を気にせず申し込める派遣制度と、申請者が登録診断事務所を選ぶ補助制度があります。</p>' },
      { heading: '補助内容', content: '<p>派遣制度は、令和7年度から無料で耐震診断を受けられると案内されています。補助制度では、補助対象経費の3分の1に2万円を加えた額、上限4万円が補助されます。</p>' },
      { heading: '申請の注意点', content: '<p>受付期間は2026年4月15日から2027年1月29日までで、先着順です。対象住宅は昭和56年5月31日以前に着工された階数2階以下、延べ床面積500平方メートル以下の一戸建て木造住宅などに限られます。</p>' }
    ],
    officialUrl: 'https://www.city.matsuyama.ehime.jp/kurashi/kurashi/hojokin/taishin_shindan.html',
    sourceName: '松山市 木造住宅耐震診断事業',
    sourceUrls: ['https://www.city.matsuyama.ehime.jp/kurashi/kurashi/hojokin/taishin_shindan.html'],
    sourceNote: '松山市公式ページで、2026年4月1日更新、令和8年度受付2026年4月15日から2027年1月29日、派遣制度は無料、補助制度は補助対象経費の3分の1+2万円・上限4万円を確認。既存生成データを公式確認済み耐震診断支援として上書き。',
    verifiedAt,
    publishedAt: '2026-06-27',
  },
  {
    slug: 'matsuyama-wage-increase-support-2026',
    title: '松山市 賃上げ応援奨励金',
    organization: '松山市',
    type: 'local',
    maxAmount: '最大100万円',
    ...
    relatedCategories: ['living'],
    prefecture: '愛媛県',
    tags: ['松山市', '賃上げ', '中小企業', '奨励金', '令和8年度'],
    eligibility: '松山市内に本社または本店を有する中小企業、市内に事業所と住所を有する個人事業主、市内に主たる事務所を有するNPO法人・公益法人・協同組合などで、公式の賃上げ要件を満たす事業者が対象です。',
    applicationPeriod: '第1回は2026年4月24日から2026年7月31日まで。第2回は2026年9月1日から2027年1月31日まで',
    deadlineDate: '2027-01-31',
    description: '松山市が、市内中小企業などの持続的な賃上げを後押しするため、対象従業員1人当たり5万円を給付する奨励金です。',
    sections: [
      { heading: '制度の概要', content: '<p>松山市賃上げ応援奨励金は、市内の中小企業などが従業員の賃金引上げを行った場合に給付される制度です。令和8年度は常時雇用する従業員数が51人以上の事業者の上限額が100万円に引き上げられ、医療・介護事業者の申請要件も緩和されています。</p>' },
      { heading: '給付内容', content: '<p>対象従業員1人当たり5万円が給付されます。従業員数が51人以上の事業者は1事業者当たり最大100万円、50人以下の事業者は最大50万円です。賃上げ対象期間は2026年1月1日から2026年12月31日までです。</p>' },
      { heading: '申請の注意点', content: '<p>申請期間は第1回が2026年4月24日から7月31日、第2回が2026年9月1日から2027年1月31日までです。オンライン申請が基本で、難しい場合は郵送申請も案内されています。</p>' }
    ],
    officialUrl: 'https://www.city.matsuyama.ehime.jp/hodo/202604/chinageouenHP.html',
    sourceName: '松山市 令和8年度 松山市賃上げ応援奨励金の申請受付を開始します',
    sourceUrls: ['https://www.city.matsuyama.ehime.jp/hodo/202604/chinageouenHP.html'],
    sourceNote: '松山市公式ページで、2026年4月21日更新、第1回申請2026年4月24日から7月31日、第2回2026年9月1日から2027年1月31日、対象従業員1人当たり5万円、従業員数51人以上は最大100万円、50人以下は最大50万円を確認。新規の公式確認済み賃上げ支援として追加。',
    verifiedAt,
    publishedAt: '2026-06-27',
  },
  {
    ...
    relatedCategories: ['disaster', 'living'],
    prefecture: '徳島県',
    tags: ['徳島市', '木造住宅', '耐震改修', '耐震診断', '令和8年度'],
    eligibility: '徳島市内の平成12年5月31日以前に着工された木造住宅で、耐震診断、耐震改修、耐震シェルター、住替え支援など各事業の公式要件を満たす所有者・居住予定者等が対象です。',
    applicationPeriod: '2026年4月14日から受付開始',
    description: '徳島市が、木造住宅の耐震診断、耐震改修、耐震シェルター設置、県内住替えに伴う除却、減災化対策を支援する制度です。',
    sections: [
      { heading: '制度の概要', content: '<p>徳島市既存木造住宅耐震化促進事業は、南海トラフ地震などに備え、旧耐震基準等の木造住宅の耐震化を進めるための支援制度です。既存の生成データでは住宅耐震補助としていましたが、公式ページの令和8年度制度へ修正しています。</p>' },
      { heading: '補助内容', content: '<p>耐震診断は無料です。耐震改修支援事業は補助対象工事費用の5分の4・最大120万円で、感震ブレーカー設置費用として10万円を上乗せできます。耐震シェルターは最大80万円、耐震ベッドは最大40万円で、感震ブレーカー設置費用の上乗せも案内されています。</p>' },
      { heading: '申請の注意点', content: '<p>令和8年度は2026年4月14日から受付開始です。耐震改修、耐震シェルター、住替え支援事業は、本事業の耐震診断実施後に申し込む必要があります。工事請負契約や工事実施は補助金交付決定後です。</p>' }
    ],
    ...
    sourceUrls: ['https://www.city.tokushima.tokushima.jp/smph/kurashi/house/house_keikaku/taishin_house.html'],
    sourceNote: '徳島市公式ページで、2026年4月14日更新、令和8年度受付2026年4月14日開始、耐震診断無料、耐震改修最大120万円+感震ブレーカー10万円、耐震シェルター最大80万円、住替え支援最大30万円を確認。既存生成データを公式確認済み木造住宅耐震化促進事業として上書き。',
    verifiedAt,
    publishedAt: '2026-06-27',
  },
  {
    slug: 'tokushima-city-newlywed-rent',
    title: '徳島市 住宅リフォーム支援事業',
    organization: '徳島市',
    type: 'local',
    maxAmount: '最大30万円',
    maxAmountNum: 30,
    category: 'housing',
    relatedCategories: ['living', 'employment'],
    prefecture: '徳島県',
    tags: ['徳島市', '住宅リフォーム', '中古住宅', '定住', '令和8年度'],
    eligibility: '令和8年度の事前申込みを済ませ、公開抽選等により補助金交付対象となった方で、徳島市内施工業者に依頼して自ら居住する住宅の対象リフォーム工事を行うなど公式要件を満たす方が対象です。',
    applicationPeriod: '事前申込みは受付終了。本申請は2026年6月8日から2026年7月24日まで',
    deadlineDate: '2026-07-24',
    description: '徳島市が、市内施工業者による住宅リフォーム工事費の一部を支援する補助事業です。区分により長寿命化リフォーム、中古住宅購入後の定住リフォーム、中心市街地定住リフォームが対象になります。',
    sections: [
      { heading: '制度の概要', content: '<p>徳島市住宅リフォーム支援事業は、市民の消費活動や地域経済の活性化、住環境向上、住宅長寿命化を目的に、自ら居住する住宅のリフォーム工事費を補助する制度です。既存の生成データでは新婚世帯家賃補助としていましたが、公式確認できる現行の住宅リフォーム支援へ修正しています。</p>' },
      { heading: '補助内容', content: '<p>区分Aは補助対象工事費の12%・上限12万円、区分Bは20%・上限20万円、区分Cは30%・上限30万円です。補助対象工事費は税抜50万円以上で、徳島市内施工業者に依頼して行う工事が対象です。</p>' },
      { heading: '申請の注意点', content: '<p>令和8年度の事前申込み受付は終了しています。事前申込み済みで本申請に進む方の受付期間は2026年6月8日から7月24日まで、実績報告は2027年3月1日までです。交付決定前に着工した工事は対象外です。</p>' }
    ],
    officialUrl: 'https://www.city.tokushima.tokushima.jp/kurashi/house/house_keikaku/jyutaku_reform.html',
    sourceName: '徳島市 住宅リフォーム支援事業',
    sourceUrls: ['https://www.city.tokushima.tokushima.jp/kurashi/house/house_keikaku/jyutaku_reform.html'],
    sourceNote: '徳島市公式ページで、2026年6月11日更新、事前申込み受付終了、本申請2026年6月8日から7月24日、区分A上限12万円、区分B上限20万円、区分C上限30万円、補助対象工事費50万円以上、市内施工業者要件を確認。旧生成データの新婚世帯家賃補助から現行制度へ修正。',
    verifiedAt,
    publishedAt: '2026-06-27',
  },
  {
  ...
  },
  {
    ...
    organization: '高松市',
    type: 'local',
    maxAmount: '体外受精・顕微授精 最大30万円',
    maxAmountNum: 30,
    category: 'medical',
    relatedCategories: ['childcare'],
    prefecture: '香川県',
    tags: ['高松市', '不妊治療', '体外受精', '顕微授精', '令和8年度'],
    eligibility: '体外受精・顕微授精等の生殖補助医療を受け、夫婦の一方または双方が高松市に住民登録しているなど、公式要件を満たす夫婦が対象です。',
    applicationPeriod: '治療終了日の翌日から1年以内に申請',
    description: '高松市が、体外受精・顕微授精などの生殖補助医療を受けた夫婦の経済的負担を軽減するため、治療費の一部を助成する制度です。',
    sections: [
      { heading: '制度の概要', content: '<p>高松市こうのとり応援事業は、体外受精・顕微授精などの生殖補助医療に要した費用の一部を助成する制度です。既存の生成データでは最大10万円としていましたが、公式ページで確認できる保険外診療枠を含む現行制度へ修正しています。</p>' },
      { heading: '助成内容', content: '<p>公式ページでは、保険適用の生殖補助医療と併せて実施する先進医療等は1回の治療につき上限10万円と案内されています。また、保険外診療となった体外受精・顕微授精のうち、旧特定不妊治療費助成制度の治療ステージA・B・D・Eに該当する治療は30万円まで、C・Fに該当する治療は10万円まで助成されます。</p>' },
      { heading: '申請の注意点', content: '<p>申請期限は治療終了日の翌日から1年以内です。保険適用・保険外診療の区分、治療ステージ、治療開始時の年齢による助成回数などの要件があるため、申請前に公式ページと必要書類を確認してください。</p>' }
    ],
    officialUrl: 'https://www.city.takamatsu.kagawa.jp/kurashi/kurashi/josei/kosodate/seisyokuhojyoiryou1.html',
    sourceName: '高松市 こうのとり応援事業（体外受精・顕微授精への助成制度）',
    sourceUrls: ['https://www.city.takamatsu.kagawa.jp/kurashi/kurashi/josei/kosodate/seisyokuhojyoiryou1.html'],
    sourceNote: '高松市公式ページで、保険適用の生殖補助医療と併用する先進医療等は上限10万円、保険外診療となった体外受精・顕微授精は治療ステージA/B/D/E上限30万円・C/F上限10万円、申請期限は治療終了日の翌日から1年以内を確認。旧生成データの最大10万円から現行制度へ修正。',
    verifiedAt,
    publishedAt: '2026-06-27',
  },
];
