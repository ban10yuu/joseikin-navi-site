...
const cities = [
  { name: '鹿児島市', pref: '鹿児島県', prefix: 'kagoshima-', desc: '鹿児島市は鹿児島県の県庁所在地で、桜島を望む錦江湾沿いに広がる南九州最大の都市です。西郷隆盛ゆかりの地であり、黒豚やさつま揚げなど食文化も豊かです。' },
  { name: '霧島市', pref: '鹿児島県', prefix: 'kirishima-', desc: '霧島市は鹿児島県中央部に位置し、霧島連山の雄大な自然と豊富な温泉が魅力です。霧島神宮は坂本龍馬の新婚旅行先としても知られています。' },
  { name: '鹿屋市', pref: '鹿児島県', prefix: 'kanoya-', desc: '鹿屋市は大隅半島の中心都市で、鹿屋バラ園や鹿屋航空基地史料館が有名です。畜産業が盛んで、黒毛和牛や黒豚の一大産地です。' },
  { name: '薩摩川内市', pref: '鹿児島県', prefix: 'satsumasendai-', desc: '薩摩川内市は鹿児島県北西部に位置し、川内川流域に広がる自然豊かなまちです。甑島列島の美しい海や藺牟田池の湿原など自然景観に恵まれています。' },
  { name: '姶良市', pref: '鹿児島県', prefix: 'aira-', desc: '姶良市は鹿児島市に隣接するベッドタウンで、人口増加が続く活力あるまちです。蒲生の大楠は日本一の巨樹として国の特別天然記念物に指定されています。' },
  { name: '奄美市', pref: '鹿児島県', prefix: 'amami-', desc: '奄美市は奄美大島の中心都市で、世界自然遺産に登録された亜熱帯の森やマングローブ原生林が魅力です。大島紬や黒糖焼酎など独自の文化が息づいています。' },
];
...
export const cityGrantsBatch92: Grant[] = cities.flatMap(c => genGrants(c));
