...
const cities = [
  { name: '富山市', pref: '富山県', prefix: 'toyama-', desc: '富山市は富山県の県庁所在地で、立山連峰の絶景と富山湾の海の幸が魅力です。路面電車が走る環境先進都市であり、ガラス美術館など文化施設も充実しています。' },
  { name: '高岡市', pref: '富山県', prefix: 'takaoka-', desc: '高岡市は加賀藩前田家ゆかりの城下町で、高岡大仏や瑞龍寺が有名です。銅器や漆器などの伝統工芸が今も息づく「ものづくりのまち」です。' },
  { name: '射水市', pref: '富山県', prefix: 'imizu-', desc: '射水市は富山県中央部に位置し、海王丸パークの帆船や新湊大橋の美しい景観が魅力です。白えびやベニズワイガニなど富山湾の新鮮な海の幸が楽しめます。' },
  { name: '金沢市', pref: '石川県', prefix: 'kanazawa-', desc: '金沢市は石川県の県庁所在地で、兼六園・金沢城・ひがし茶屋街など加賀百万石の歴史と文化が息づくまちです。金箔や九谷焼など伝統工芸の宝庫でもあります。' },
  { name: '白山市', pref: '石川県', prefix: 'hakusan-', desc: '白山市は石川県南部に位置し、白山国立公園の雄大な自然と白山比め神社の信仰で知られています。手取峡谷や白峰温泉など山間の観光資源が豊富です。' },
  { name: '小松市', pref: '石川県', prefix: 'komatsu-', desc: '小松市は石川県南部の都市で、小松空港や建設機械メーカーのコマツ発祥の地です。安宅の関は勧進帳の舞台として有名で、歌舞伎のまちとしても知られています。' },
];
...
export const cityGrantsBatch98: Grant[] = cities.flatMap(c => genGrants(c));
