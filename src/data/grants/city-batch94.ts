...
const cities = [
  { name: '那覇市', pref: '沖縄県', prefix: 'naha-', desc: '那覇市は沖縄県の県庁所在地で、首里城や国際通りが有名な南国の都市です。琉球王国の歴史と文化が色濃く残り、独自の食文化や芸能が魅力です。' },
  { name: '沖縄市', pref: '沖縄県', prefix: 'okinawa-', desc: '沖縄市は沖縄県中部に位置し、コザの名で親しまれるエイサーのまちです。多文化が共存する独特の雰囲気があり、音楽やアートの発信地としても知られています。' },
  { name: 'うるま市', pref: '沖縄県', prefix: 'uruma-', desc: 'うるま市は沖縄県中部東海岸に位置し、海中道路で結ばれた島々が美しいまちです。闘牛文化が残り、エイサーや獅子舞など伝統行事が盛んです。' },
  { name: '浦添市', pref: '沖縄県', prefix: 'urasoe-', desc: '浦添市は那覇市に隣接する住宅都市で、琉球王国発祥の地として知られています。浦添城跡や浦添ようどれなど歴史遺産が点在し、近年は商業施設も充実しています。' },
  { name: '宜野湾市', pref: '沖縄県', prefix: 'ginowan-', desc: '宜野湾市は沖縄県中部に位置し、コンベンションセンターやトロピカルビーチが有名です。普天間宮は琉球八社の一つとして信仰を集めています。' },
  { name: '名護市', pref: '沖縄県', prefix: 'nago-', desc: '名護市は沖縄県北部の中心都市で、やんばるの玄関口として自然豊かなまちです。名護桜まつりやオリオンビール工場見学など観光スポットが多彩です。' },
];
...
export const cityGrantsBatch94: Grant[] = cities.flatMap(c => genGrants(c));
