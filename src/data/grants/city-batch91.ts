...
const cities = [
  { name: '熊本市', pref: '熊本県', prefix: 'kumamoto-', desc: '熊本市は熊本県の県庁所在地で、熊本城やくまモンで全国的に有名です。馬刺しやからし蓮根など独自の食文化も魅力の政令指定都市です。' },
  { name: '八代市', pref: '熊本県', prefix: 'yatsushiro-', desc: '八代市は熊本県南部の中核都市で、八代花火大会は全国花火競技大会として有名です。い草の生産量日本一を誇る畳のまちでもあります。' },
  { name: '天草市', pref: '熊本県', prefix: 'amakusa-', desc: '天草市は天草諸島の中心都市で、世界遺産の崎津集落やイルカウォッチングが人気です。天草四郎ゆかりのキリシタン文化が残るまちです。' },
  { name: '大分市', pref: '大分県', prefix: 'oita-', desc: '大分市は大分県の県庁所在地で、高崎山自然動物園や大友宗麟の城下町として知られます。とり天や関あじ・関さばなど海の幸も豊富です。' },
  { name: '別府市', pref: '大分県', prefix: 'beppu-', desc: '別府市は源泉数・湧出量ともに日本一の温泉都市です。地獄めぐりや別府八湯など多彩な温泉文化があり、国際観光温泉文化都市に指定されています。' },
  { name: '中津市', pref: '大分県', prefix: 'nakatsu-', desc: '中津市は福沢諭吉の故郷として知られ、中津城や耶馬渓の紅葉が名所です。中津からあげは全国的なご当地グルメとして有名です。' },
];
...
function genGrants(c: typeof cities[0]): Grant[] {
  ...
  return cats.map(g => ({
    ...
    officialUrl: '', publishedAt: '2026-03-10',
  }));
}

export const cityGrantsBatch91: Grant[] = cities.flatMap(c => genGrants(c));
