...
const cities = [
  { name: '山口市', pref: '山口県', prefix: 'yamaguchi-', desc: '山口市は山口県の県庁所在地で、室町時代の大内文化が息づく「西の京」です。瑠璃光寺五重塔や湯田温泉が人気の歴史文化都市です。' },
  { name: '下関市', pref: '山口県', prefix: 'shimonoseki-', desc: '下関市は関門海峡に面した山口県最大の都市で、ふぐ（ふく）の本場として全国的に有名です。巌流島や赤間神宮など歴史スポットも豊富です。' },
  { name: '宇部市', pref: '山口県', prefix: 'ube-', desc: '宇部市は「緑と花と彫刻のまち」として知られ、UBEビエンナーレ（野外彫刻展）が有名です。かつての炭鉱都市から環境都市へ転換したまちです。' },
  { name: '周南市', pref: '山口県', prefix: 'shunan-', desc: '周南市は瀬戸内海沿岸のコンビナート都市で、石油化学産業が盛んです。徳山動物園や夜のコンビナートの工場夜景でも知られています。' },
  { name: '岩国市', pref: '山口県', prefix: 'iwakuni-', desc: '岩国市は錦帯橋で全国的に有名な城下町です。岩国城や白蛇の生息地としても知られ、米軍基地もある国際色豊かなまちです。' },
  { name: '防府市', pref: '山口県', prefix: 'hofu-', desc: '防府市は日本最初の天満宮・防府天満宮が鎮座する学問のまちです。毛利氏庭園や佐波川の清流など、歴史と自然が調和した都市です。' },
];
...
function genGrants(c: typeof cities[0]): Grant[] {
  const cats: Array<{cat: Grant['category'], slug: string, title: string, amount: string, amountNum: number, elig: string, period: string, descr: string, s1: string, s2: string, s3: string, tags: string[]}> = [
    { cat: 'childcare', slug: `${c.prefix}child-medical-aid`, title: `${c.name} こども医療費助成`, amount: '自己負担なし（全額助成）', amountNum: 0, elig: `${c.name}に住所を有する18歳までの子どもの保護者`, period: '通年', descr: `${c.name}が実施するこども医療費助成制度です。18歳年度末まで医療費の自己負担を全額助成します。`, tags: [c.name, 'こども医療費', '山口県'],
      s1: `<p>${c.name}こども医療費助成は、<span class="marker">18歳に達した年度末まで</span>の子どもの医療費自己負担を全額助成する制度です。</p><p>${c.desc}</p><p><span class="marker-green">所得制限なし</span>で、通院・入院ともに自己負担ゼロです。山口県の助成制度に${c.name}が上乗せしています。</p>`,
      ...
      s3: `<p>通院・入院ともに<strong>自己負担なし</strong>。保険適用分の自己負担額が全額助成されます。</p><p><span class="marker">県内医療機関は受給資格証提示で窓口無料</span>。県外は後日申請で償還。</p><div class="note-box">山口県は子育て支援に積極的で、医療費助成が充実しています。入院時の食事代は助成対象外です。</div>` },
    { cat: 'housing', slug: `${c.prefix}juutaku-reform`, title: `${c.name} 住宅リフォーム助成金`, amount: '最大30万円', amountNum: 30, elig: `${c.name}内に住宅を所有し居住している方`, period: '毎年4月〜12月（先着順）', descr: `${c.name}が実施する住宅リフォーム助成金です。住宅の改修・修繕工事に最大30万円を助成します。`, tags: [c.name, '住宅リフォーム', '山口県'],
    ...
    { cat: 'medical', slug: `${c.prefix}health-checkup-subsidy`, title: `${c.name} 人間ドック受診費助成`, amount: '最大3万円', amountNum: 3, elig: `${c.name}国民健康保険加入者で40歳以上の方`, period: '毎年4月〜翌年2月', descr: `${c.name}が実施する人間ドック受診費助成です。国保加入者の人間ドック費用を最大3万円助成します。`, tags: [c.name, '人間ドック', '山口県'],
    ...
    { cat: 'education', slug: `${c.prefix}scholarship-repayment`, title: `${c.name} 奨学金返還支援制度`, amount: '最大150万円（年30万円×5年）', amountNum: 150, elig: `${c.name}に居住し市内事業所に就職した45歳未満の方`, period: '毎年4月〜5月', descr: `${c.name}が実施する奨学金返還支援制度です。市内就職者の奨学金返還を年最大30万円、5年間支援します。`, tags: [c.name, '奨学金返還', '山口県'],
      ...
      s3: `<p>年間返還額の2/3以内で<strong>年最大30万円</strong>。5年間で最大150万円の支援。</p><p><span class="marker">市内事業所への継続勤務</span>が条件です。退職すると支援停止。</p><div class="highlight-box">山口県の奨学金返還支援制度と併用できる場合があります。詳細は${c.name}にお問い合わせください。</div>` },
    { cat: 'employment', slug: `${c.prefix}startup-support`, title: `${c.name} 創業支援補助金`, amount: '最大50万円', amountNum: 50, elig: `${c.name}内で新たに創業する個人または法人`, period: '毎年4月〜11月', descr: `${c.name}が実施する創業支援補助金です。市内での新規創業にかかる経費を最大50万円補助します。`, tags: [c.name, '創業支援', '山口県'],
    ...
    { cat: 'nursing', slug: `${c.prefix}elderly-taxi`, title: `${c.name} 高齢者タクシー利用助成`, amount: '年間最大2.4万円', amountNum: 2.4, elig: `${c.name}に住所を有する75歳以上で運転免許を持たない方`, period: '通年', descr: `${c.name}が実施する高齢者タクシー利用助成です。75歳以上の交通弱者にタクシー券を年間最大2.4万円分交付します。`, tags: [c.name, '高齢者タクシー', '山口県'],
    ...
    { cat: 'living', slug: `${c.prefix}water-saving`, title: `${c.name} 雨水タンク設置補助金`, amount: '最大3万円', amountNum: 3, elig: `${c.name}内に住宅を所有する方`, period: '毎年4月〜翌年1月', descr: `${c.name}が実施する雨水タンク設置補助金です。雨水の有効利用と節水を目的に設置費用を最大3万円補助します。`, tags: [c.name, '雨水タンク', '山口県'],
    ...
    { cat: 'disaster', slug: `${c.prefix}block-wall-removal`, title: `${c.name} ブロック塀等撤去補助金`, amount: '最大15万円', amountNum: 15, elig: `${c.name}内の通学路等に面する危険なブロック塀の所有者`, period: '毎年4月〜12月', descr: `${c.name}が実施するブロック塀撤去補助金です。通学路等に面する危険なブロック塀の撤去費用を最大15万円補助します。`, tags: [c.name, 'ブロック塀撤去', '山口県'],
    ...
    { cat: 'childcare', slug: `${c.prefix}school-lunch-subsidy`, title: `${c.name} 学校給食費補助制度`, amount: '最大年間5.5万円', amountNum: 5.5, elig: `${c.name}立小中学校に通う第3子以降の児童生徒の保護者`, period: '通年（自動適用）', descr: `${c.name}が実施する学校給食費補助制度です。第3子以降の給食費を全額補助し、多子世帯の負担を軽減します。`, tags: [c.name, '給食費補助', '山口県'],
  ...
  return cats.map(g => ({
    ...
    officialUrl: '', publishedAt: '2026-03-05',
  }));
}

export const cityGrantsBatch86: Grant[] = cities.flatMap(c => genGrants(c));
