...
const CATEGORY_PURPOSE_MAP: Record<LegacyGrantCategory, Purpose> = {
  ...
  care: 'welfare',
  'cost-of-living': 'livingSupport',
  culture: 'regionalRevitalization',
  digital: 'digitalTransformation',
  disability: 'welfare',
  energy: 'energySaving',
  finance: 'businessGrowth',
  financing: 'businessGrowth',
  healthcare: 'medical',
  health: 'medical',
  elderly: 'welfare',
  life: 'livingSupport',
  legal: 'livingSupport',
  migration: 'regionalRevitalization',
  relocation: 'regionalRevitalization',
  safety: 'disaster',
  security: 'disaster',
  senior: 'welfare',
  technology: 'digitalTransformation',
  transport: 'livingSupport',
  transportation: 'livingSupport',
  travel: 'regionalRevitalization',
  utility: 'livingSupport',
  welfare: 'welfare',
  other: 'other',
};
