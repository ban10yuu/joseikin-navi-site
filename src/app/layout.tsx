...
export const metadata: Metadata = {
  ...
  description:
    '国・都道府県・市区町村・NPO/民間団体の助成金・補助金・給付金を100件以上網羅。子育て・住宅・医療・教育・就職・介護・生活支援・災害など全カテゴリを掲載。世帯年収・地域・職業から受給可能な助成金を無料診断。申請方法・必要書類・受給額まで徹底解説。',
  keywords: [
  ...
  openGraph: {
    ...
    description: '助成金・補助金・給付金を100件以上網羅。あなたに合った支援制度を無料診断。',
