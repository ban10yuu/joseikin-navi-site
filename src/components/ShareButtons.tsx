...
export default function ShareButtons({ title }: ShareButtonsProps) {
  ...
  return (
    <div className="flex items-center gap-2 my-6">
      <span className="text-xs text-gray-500 font-medium mr-1">共有:</span>
      <button
      ...
      <button
        ...
        className="flex items-center justify-center w-9 h-9 rounded-full bg-[#1877f2] text-white hover:bg-[#166fe5] transition-colors"
      ...
      <button
        ...
        className="flex items-center justify-center w-9 h-9 rounded-full bg-[#06c755] text-white hover:bg-[#05b34c] transition-colors"
        aria-label="LINEでシェア"
      >
        <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
