...
コミット`4d54e07e`を`main`へ反映し、Vercelのデプロイ成功後に`https://shienseido-navi.jp/`を確認しました。トップ初期表示は個人・家族向け3案件、切替後の事業者・団体向け4案件です。受付終了の創業支援詳細は関連広告3件、不妊治療詳細は専用広告2件を確認し、不妊治療詳細に会計・レンタルサーバー広告がないことも確認しました。トップと重点詳細3URLは本番でHTTP 200です。
